...
117. **Anmeldeformular ohne CSRF-Token.**
...
118. **E-Mail-Wechsel im Profil ohne Passwortnachweis.**
...
119. **`apk/` und `demo/` liegen ungesperrt im Webroot.**
...
120. **DOCTYPE-Sperre im GPX-Import umgehbar.**
...
121. **`wiederherstellen.php` gibt unangemeldet Auskunft.**
...
122. **Klartext-Freitextfelder ohne Hinweis.**
...
123. **Klartext-Reste auf dem Server.**
...
124. **Verlorene Uhr kann Phasen alter Einsätze ersetzen.**
...
125. **Kleinigkeiten an Kopfzeilen und Maskierung.**
...
126. **Rundenzahl und Passwortregeln.**
...
127. **Photon und Kachelserver bekommen den Einsatzort im Klartext.**
...
128. **Weg C: die Zusage auf das eingrenzen, was sie hält.**
...
129. **Adminpakete sind unversiegelt und gehen über FTP hinaus.**
...
130. **Push auf `main` ist Deploy — Zugang zum Repositorium ist Zugang zum Schlüssel.**
...
132. **Android: HTTP-Ausnahme gilt auch im Release-Build.**
...
133. **Android: Verzicht auf Certificate Pinning ist nicht festgehalten.**
...
134. **Android: Data-Layer-Empfang ohne Absender- und Plausibilitätsprüfung.**
...
135. **Android: Gradle-Wrapper ohne Prüfsumme.**
...
136. **Fragen an das Bedrohungsmodell P6 aus dem Krypto-Review.**
