# Rahmenplan — Archiv (Fassungen 1 bis 15)

**Protokoll, nicht Steuerung.** Dieses Dokument hält den Rahmenplan so, wie
er bis Fassung 15 (02.09.2026) gewachsen ist — **wörtlich und
eingefroren**. Es wird nicht fortgeschrieben. Die Steuerung des Programms
(Reihenfolge, Status, offene Entscheidungen) steht seit Fassung 16 in
`docs/Rahmenplan.md`; dort ist alles Erledigte auf eine Kurzübersicht
verdichtet, und die 50 Programmentscheidungen stehen als Register. Wer die
Begründungen, Messwerte und den Werdegang braucht, liest hier.

**Warum wörtlich:** Die Konzept- und Prüfdokumente zitieren diesen Text —
Abschnittsnummern, Fassungsnummern, Sätze. Ein gekürztes Archiv hätte diese
Verweise ins Leere laufen lassen; ein umformuliertes hätte Geschichte
verändert. Deshalb steht ab der Trennlinie unten die Fassung 15 Zeichen für
Zeichen so, wie sie auf `main` lag (Commit 9b268fc), einschließlich ihrer
eigenen Überschrift und ihrer Fassungsvermerke.

## Wo die alten Abschnitte jetzt weiterleben

Verweise wie „Rahmenplan, Abschnitt 5" oder „Rahmenplan Fassung 13" aus
älteren Dokumenten meinen den Text **unten in diesem Archiv**. Was davon
noch gilt, steht im neuen Rahmenplan an folgender Stelle:

| alt (Fassung 1–15) | neu (`docs/Rahmenplan.md`, Fassung 16) |
|---|---|
| Kopf mit Fassungsvermerken 1–15 | Abschnitt 10 „Änderungsverlauf" (eine Zeile je Fassung) |
| 1 Zweck und Geltung | 1 Ziel und Nicht-Ziele |
| 2 Dokumentstruktur und Konventionen (K1–K9) | 2.1 Konventionen K1–K9 (K5 nennt jetzt Abschnitt 3 und 8 statt 6) |
| 3 Programmentscheidungen R1–R50, Volltext | 7 Register (Kern, Status); Volltext bleibt hier |
| 4 Phasen — Planungstexte und Umsetzungsblöcke | 8 Erledigt (Kurzübersicht) für P0 bis S3; 3 Fahrplan für S4, S5, P5, P6 |
| 4 P4 | aufgelöst (R53); die Punkte stehen in 5 Backlog-Zuordnung |
| 4 P7 | entfallen (R46); nur noch hier |
| 5 Reihenfolge und Abhängigkeiten | 3 Fahrplan und 4 Parallelität und Sperren |
| 6 Statusübersicht | 3 (laufend) und 8 (abgeschlossen) |
| 7 Benötigte Zuarbeiten | 6 Offene Abnahmen und Zuarbeiten |
| 8 Pflege dieses Dokuments | 9 Pflege dieses Dokuments |

**Drei Lesehinweise zu Stellen, die unten überholt sind:**

- Das **R42-Kleinstpaket** (R42 und R44) heißt seit Fassung 16 **S6**; die
  Umstellung **„Sicherung" → „Backup"** (R50) heißt **S7** (R52). Unten
  stehen beide noch als „Kleinstpaket vor S2" bzw. „R50 nach S3"; die
  Statusübersicht unten führt das Kleinstpaket als „in Arbeit" — das war
  ein Irrtum, es war am 02.09.2026 nicht begonnen.
- Die **Backlog-Nummern 46 bis 49 der Uhr-Reihe** (Gerätestatistik,
  Logo-Wahl, Bildmarke, Logofarben) heißen seit Fassung 15 **59 bis 62**
  (Kopf von `docs/Backlog.md`). Ältere Fassungsvermerke und R-Einträge
  unten nennen sie teils noch mit den alten Nummern.
...
Kopie aus `docs/Rahmenplan.md`, Abschnitt 8, Stand Fassung 16 — damit dieses
Archiv für sich lesbar ist. Maßgeblich ist die Fassung im Rahmenplan.
...
**Ab hier: Fassung 15 vom 02.09.2026, unverändert (Commit 9b268fc).**
...
Fassung 15 (02.09.2026): **Stand der zweiten Rückmeldungsrunde und Fälligkeit
von R50.** Die Runde ist **ausgeliefert** — Web 12.2.1, in `main`; Fassung 14
sprach noch von „vier Commits auf einem eigenen Zweig, noch nicht
ausgeliefert", das ist überholt. Ihre **Bedienprüfung ist nachgeholt** (siehe
S3-Zeile in Abschnitt 6), und mit ihr eine Lehre, die über den Einzelfall
hinausgeht: Die Prüfung galt drei Commits lang als unmöglich, weil „ohne MySQL
nicht aufrufbar" **angenommen statt nachgesehen** wurde. Das Projekt fährt
lokal seit P1 gegen MariaDB 10.11 — `schema.sql` nennt sie in Zeile 1, vier
Prüfdokumente sind gegen sie gemessen, und
`tools/referenzdatensatz/einspielen/lokal_starten.sh` setzt Datenbank,
PHP-Server und TLS in einem Aufruf auf. **Wer eine Prüfung für unmöglich hält,
sehe zuerst in `tools/` nach.** — **R50 ist mit dem S3-Deploy fällig
geworden**: Die Bedingung „nach S3" ist erfüllt, und die Neuzählung zeigt, was
das Schieben kostet — die Trefferzahlen sind seit dem Beschluss um zwei Drittel
gewachsen (Einzelheiten in R50). Offen bleiben dort nur noch die drei
Entscheidungen aus Abschnitt 4 des Vorlagendokuments.
...
| S3 | **fertig** (`docs/Konzept-S3-Oberflaechen-Nacharbeit.md`; E-S3-01 bis E-S3-16, F-S3-01 bis F-S3-03 entschieden 01.09.2026) | **umgesetzt** (Web 12.2.2 bis 12.4.2, 01.–02.09.2026) — *noch nicht ausgeliefert* | Zwölf Pakete AP1–AP12, keine Migration. **Der Kern:** Die Abstandsskala wurde eingehalten (269 Deklarationen, **null** Rohwerte) — es fehlte die Anwendungsregel. Sie steht in `docs/Design.md` Kapitel 6; von 74 Zwischenraum-Deklarationen waren 61 schon richtig, 13 Regeln sind eingestellt. `.karte` und `.feld` trugen beide 16 px: Trennung war so groß wie Bindung. **Vier Funktionsänderungen** (Höhe nur bei Luft, Autosuche im Ortsfeld, Filterausblendung aus dem Feldkatalog, Demo-Konto gesperrt). **Der Markerversatz ist behoben und gemessen:** 51,7 px vorher, 0,0 px nachher über sechs Zoomstufen. **Zwei Punkte der Liste waren bereits erledigt** (Zeilentrenner über volle Breite, weiches Trennzeichen in „Sekundärtransport“) — nachgemessen statt angenommen. **Fünf Funde über die Liste hinaus** (F-S3-A bis F-S3-E), darunter zwei aus der Rückmeldung vom 01.09.2026: `tag_spuren.php` lief ohne Seitengerüst, und `ui_meldung_markup()` ergab bei einem unbekannten Ton einen ungestalteten Kasten. Backlog Nr. 56 erledigt, Nr. 57 und 58 neu. Uhr-Kacheln neu gerastert, **Auslieferung mit S5** (E-S3-04). **Vorab erledigt, außerhalb von S3: die zweite Rückmeldungsrunde** (Web 12.2.1, ausgeliefert). Drei Punkte: der native Knopf des Dateifelds klebte am oberen Rand — gemessen 0 px Luft darüber gegen 19 px darunter, behoben am Baustein `input[type=file].feld-eingabe` und nicht an der Seite; Sicherung und Datenexport nannten die erzeugte Datei nicht, obwohl der Download ohne Rückfrage durchläuft — beide nennen jetzt den Dateinamen aus EINER Variablen; und der Ton `warn` trug im melde()-Nachbau der Einstellungsseite das Hinweiszeichen statt der Warnung, entgegen `Design.md` 9.5. Diese Punkte standen **nicht** in `ToDo_Layout.pdf` (19 Punkte am Stand 9.14.1, sie sind neuer) und sind mit **S3/AP1** ins Konzept nachgetragen — damit ist Backlog Nr. 56 in beiden Teilen erledigt. **Die Bedienprüfung dazu ist am 01.09. nachgeholt worden**, nachdem sie drei Commits lang als unmöglich galt: beide Dateifelder, eine Sicherung im Demo-Konto (der genannte Dateiname stimmt mit dem tatsächlichen Download überein), der Export über alle drei Downloadwege, der `warn`-Fall mit einem absichtlich unlesbaren Blob **samt Gegenprobe gegen die alte Fassung** (R27: ein Prüfmittel, von dem niemand weiß, ob es scheitern kann, ist keines), Bilderlauf 304 Bilder mit 0/0/0 und Kontraste 21 Paare, 0 verfehlt |
...
| R50 | beschlossen (Fassung 14; Vorlage `docs/Umstellung-Backup.md` im Repo, Grenzen und Arbeitsliste stehen) | **fällig** (Fassung 15: Bedingung „nach S3" erfüllt) | Terminologie-Umstellung **nach S3**, vor S4 nicht zwingend. Kein Konzept, kein Prüfdokument. Drei Entscheidungen offen (Verb „sichern", Symbolname, Dateiname `admin_sicherungen.php`) — je mit Empfehlung in R50. **Am 02.09.2026 neu gezählt** (Web 12.4.2): 451 Treffer „Sicherung" in `server/` statt 272, 138 sichtbare Fundstellen statt 74 — die Menge ist seit dem Beschluss um zwei Drittel gewachsen und wächst mit S5 und S4 weiter |
