...
| `server/rueckweg_lib.php`, `server/status_lib.php`, `server/vendor/phpseclib3/**`, `tools/proben/rueckweg/**` | klein | `rueckwegprobe` | F-P5c-106 (Rueckweg pruefte gegen einen Wert aus der Datenbank), Konzept RW E-RW-03, -11, -12 |
