...
| Formatierer im Browser | `assets/format.js` (`EdFormat`) | `EdFormat.zahl()` und `EdFormat.groesse()` — dieselben Regeln wie PHP, über 2 014 Byte-Werte Zeichen für Zeichen geprüft. Ab Web 20.32.0 mit zwei Funktionen (genau die mit einem Verbraucher); AP8 baut sie aus (Z34). |
