...
(20.15.3, 20.16.5, 20.17.0, 20.18.0, 20.19.0, 20.20.0, 20.21.0, 20.21.1 —
...
kam mit AP1 in 20.16.5; Nr. 217 (Profilseite aus dem Seitengerüst
...
| R9 | Registrierung in drei Betriebsarten plus Sicherheitspaket | gilt, P5 (konkretisiert in R37). **Vorgabe und Ort seit 10b entschieden** (E-P5b-01): *offen* · *offen mit Freischaltung* · *nur auf Einladung*, Vorgabe **nur auf Einladung** — die sicherste Grundstellung für eine Selbsthosterin, die diese Seite nie aufschlägt, und nicht die, die nadoku fahren wird. Die Einstellung steht seit **Web 20.16.5** (10b AP1) in Betrieb → Servereinstellungen, Karte „Konten" (E-P5b-14), **hat aber noch keinen Verbraucher**: Die Registrierungsseite (E-P5b-13) kommt mit 10b AP3. Die Öffnung in Wellen (R41) fährt über genau diese drei Werte |
