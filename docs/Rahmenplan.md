...
(Web 15.6.0 und Korrekturstufe 15.6.1; Backlog 68, 102, 106 erledigt), **AP2
ebenso** (Web 15.7.0; Backlog 70, 101, 107, 137, 147 erledigt — mit einer
Migration, die nach dem Merge `update.php` verlangt) und **AP3** (Web 15.8.0;
...
Versionsstufen 15.6.0 bis 15.7.0 verschieben sich dann.
...
**AP1 — Vorschlagsliste und Klickprobe · erledigt, Web 15.6.0 und 15.6.1.** Eine Liste
...
**Korrekturstufe 15.6.1** (07.09.2026, vom Auftraggeber am Bild gemeldet):
...
**AP2 — Geocoder und Kartendialog · erledigt, Web 15.7.0.** Die Anschrift
...
**AP3 — Karte und Zeichen · erledigt, Web 15.8.0.** Vier Dinge an derselben
