...
20.2.1**, **Uhr 3.1.0**, **Android 0.15.0**. **Zum Merge steht der R42-Nachlauf** (Fassung 66, nur `docs/`, keine Versionsstufe, Zweig `claude/r42-umsetzen-rahmenplan-mfvv4c`).
...
(194 Handbuch, 195 Sicherungs-Rückweg).
