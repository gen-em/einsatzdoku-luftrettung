...
**Fassung 52 (14.09.2026)** — dieses Dokument steuert das Programm:
...
| 182 | Kopfzeile der Tagesgruppe steht außerhalb des Sichtfensters | **Mockup-Runde** (9c), sonst später | Fehlerfund 2 aus AP1 (Web 19.4.0), ausdrücklich **nicht** mitbehoben: Eine Lösung wäre eine neue Darstellung und braucht eine Freigabe. Der Gruppenkopf sitzt in einem `<td colspan>` derselben Tabelle und ist damit so breit wie sie — gemessen **2677 px** gegen 342 bis 1354 px Sichtfenster; die Plakette „abweichende Crew" ist in **keiner** der vier gemessenen Breiten ohne waagerechtes Scrollen sichtbar, und der `flex-wrap` greift nie. Kein Rückschritt (der alte Fließtext stand ebenso außerhalb), aber die Plakette will Aufmerksamkeit und bekommt keine. Drei Wege im Backlog; **(b)** braucht eine gemessene Breite, CSS allein reicht nicht. **Mockup M-MR-05 seit 14.09.2026**, Freigabefrage F-MR-14: (a) Kopf bei 400 px nicht sichtbar · (b) sichtbar, 231 px hoch, Spalten fluchten · (c) sichtbar, aber **Spalten fluchten nicht** (1 von 14 weicht bei drei Gruppen ab) und der Spaltenkopf wiederholt sich je Gruppe |
