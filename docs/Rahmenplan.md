...
| 168 | **Zentrale Stammdaten vollständig zurückbauen** (R39) | **10c AP8** (tritt nicht auf; die Migration zählt vorher, E-P5c-48) | S9 hat nur die Tür geschlossen (Weg c, kein Schema). Was bleibt, steht mit Fundstelle in `docs/konzepte/Bestandsaufnahme-R39-Zentrale-Stammdaten.md` — **208 Befunde**, davon 23 am Schema. Vorbedingung des `ALTER TABLE`: **0 Zeilen mit `user_id IS NULL`** in allen sechs Tabellen |
...
| 169 | Ein Diensttag mit „Anderem Rettungsmittel" kann keine Besatzung festhalten | **10c AP8** — Weg (b) entschieden (E-P5c-47) | **Vertagt 12.09.2026 auf P5** — dort wird über die Rettungsmittel ohnehin entschieden. Bis dahin gilt (c) „so lassen und im Text sagen"; Hinweis und Handbuch sagen es seit Web 18.1.1 zutreffend, kein dritter Zustand. Drei Wege stehen im Backlog |
