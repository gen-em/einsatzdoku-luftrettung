...
**Fassung 122 (25.09.2026)** — dieses Dokument steuert das Programm:
...
25.09.2026, Pull Request offen) → **SD** → **17** → **18** → 12 → 12a → 13 → 14; **PK-06 bis PK-08**
...
`claude/p5c-mockups-konzept-4yeomf`, **Pull Request offen**; Merge und Tag
