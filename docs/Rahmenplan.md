...
Backlog-Durchsicht vom 12.09.2026, angelegt 13.09.2026).
...
| 47 | Natives `confirm()` fernhalten | Backlog-Runde | Prüfmittel; **zwei** berechtigte Ausnahmen (`confirm.js`, `forms.js`), nicht eine — gemessen 13.09.2026 |
