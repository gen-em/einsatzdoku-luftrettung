...
**Fassung 102 (21.09.2026)** — dieses Dokument steuert das Programm:
...
**Die zehn Arbeitspakete** — die Zahlen unten standen für `main` vom
16.09.2026 und gelten **nicht mehr**; nachgemessen am 20.09.2026 an
`862ca7f`, und **maßgeblich ist Abschnitt 1 des Konzepts**
(`docs/konzepte/Konzept-Zentralisierung.md`). Aus den sechs Paketen sind
zehn Pakete geworden, und ihre Reihenfolge ist nicht die der Pakete:
...
**Voraussetzung:** Kette II bis M1; **Schritt 16 gemergt — erfüllt**
(PR #61/#62). **Konzept:** liegt vor —
`docs/konzepte/Konzept-Zentralisierung.md` (Fable, 20.09.2026, E-ZE-01 bis
-24, F-ZE-1 bis -6, AP1–AP10, **kein Fable-Schritt**). **Umsetzung:** Opus,
ohne Mockup. **Status:** Konzept **freigegeben am 20.09.2026**, Umsetzung
offen. **Warum
