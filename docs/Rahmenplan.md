...
**Fassung 80 (17.09.2026)** — dieses Dokument steuert das Programm:
...
**Stand am 17.09.2026, gemessen an `origin/main` (`676780d`):** **Web
20.16.4**, **Uhr 3.1.0**, **Android 0.15.0**. **Schritt 10a (P5a) ist
gemergt** (PR #50, `14f99ac`, 16.09.2026 — zwölf Arbeitspakete, Uhr und
Android unberührt); darauf folgten auf `main` noch **Web 20.16.0 bis
20.16.4** (Nachlese des P5a-Abschlusses, Prüfung der Werkzeugaufrufe,
Bilderlauf gegen Staging). Zuvor war PR #49 (`ee6d0b2`) gemergt worden, der
die Auslieferungskette aus AP1 vorgezogen hat — seither geht ein Push auf
`main` auf **Staging** und nicht mehr auf Produktiv. Davor: **Schritt 9d
(Demo-Ausbau)** gemergt (PR #48, `7f334cb`, 15.09.2026 — Web 20.3.0, keine
Migration).

**Schritt 10b (P5b) ist fertig gebaut und liegt zum Merge bereit:**
Zweig `claude/magical-dirac-we2y1z`, **Web 20.15.3 bis 20.24.0**, **alle
zehn** Arbeitspakete. Wer die Zahlen oben für den Stand des Programms hält,
unterzählt um **dreizehn** Auslieferungen (20.15.3, 20.16.5, 20.17.0,
20.18.0, 20.19.0, 20.20.0, 20.21.0, 20.21.1, 20.22.0, 20.22.1, 20.22.2,
20.23.0, 20.24.0 — nachgezählt an `server/version.php`) — sie messen `main`,
und das ist Absicht (Regel aus Fassung 42). Einzelheiten in Fahrplanzeile
10b und in Abschnitt 8.
...
> **Zwei Nummernkollisionen hat dieser Merge auflösen müssen**, und beide
...
| 10b | **P5b — Konto und Registrierung** (R82) | Registrierung mit drei Betriebsarten und Sicherheitspaket; Konto-Lebenszyklus (Bibliothek, Kontostatus bis `ingest.php`, Double-Opt-In, Selbstlöschung mit Karenz, E-Mail-Wechsel, Einwilligungen mit Fassungskennung); Onboarding mit Notfallblatt; Geräteschlüssel auf SHA-256; Mengengrenze je Konto; Aufbewahrung je Konto (Nr. 48); Demo-Konto je Betriebsart (R25) | Schritt 10a **erfüllt** (am 16.09.2026 auf `main` gemergt, PR #50, `14f99ac`); **Schritt 15** war als zweite Voraussetzung der Umsetzung gesetzt und **ist offen** — die Umsetzung läuft seit dem 16.09.2026 trotzdem. Von Schritt 15 hat AP2 allein den **Token-Teil von Paket 1** (Nr. 202) mit erledigt; die übrigen Pakete stehen, die Abweichung von der Reihenfolge 10a → 15 → 10b bleibt also bestehen und ist in der Statusspalte begründet. Das Konzept durfte ohnehin parallel entstehen | **liegt vor und ist freigegeben** (Fable, 16.09.2026; Freigabe des Auftraggebers am selben Tag, **ohne Änderungen**): `docs/konzepte/Konzept-P5b-Konto-und-Registrierung.md`, **E-P5b-01 bis -24**, **AP1–AP10**, zwei Fable-Schritte (M-P5b-01 Dokumentseite, M-P5b-02 Registrierung/Erststart/Rückfrage/Notfallblatt). **Legt den Protokoll-Schreibweg als erstes Paket fest** (V1 entschieden 16.09.2026: Betriebsereignisse, keine Zugriffe). Prüfdokument daneben (`Pruefdokument-P5b-Konto-und-Registrierung.md`); Mockups in `docs/konzepte/konzept-p5b/mockups/` — **fünf Darstellungen** (M-P5b-01, -02a bis -02d), vier davon zusätzlich bei 376 px: **9 HTML, 9 PNG** und `LIESMICH.md` | Fable (Konzept), Umsetzung Opus; **die beiden Mockup-Schritte ebenfalls Fable.** Hier stand bis Fassung 78 „mit Opus statt Fable" — das galt für zwei Entwürfe, die dieser Zweig am 16.09.2026 auf Weisung selbst gebaut hat. Der Auftraggeber hat am 17.09.2026 die Fable-Fassung aus der Konzeptsitzung nachgereicht; die Opus-Entwürfe sind abgelöst und entfernt | **ERLEDIGT — alle zehn Arbeitspakete gebaut** (Web **20.15.3 bis 20.24.0**, Zweig `claude/magical-dirac-we2y1z`, 16.–17.09.2026). Einzelheiten in **Abschnitt 8**. **AP1** Protokoll-Schreibweg mit der Karte „Konten" und der Zählkarte (20.16.5, `b9046ed`; **Nr. 224** nebenbei behoben) · **AP2** Lebenszyklus-Bibliothek (20.17.0, `442dbcb`) — damit ist der **Token-Teil von Nr. 202 Paket 1** erledigt, und zwar hier und nicht in Schritt 15, weil die Selbstregistrierung aus AP3 sonst die **fünfte** Fassung derselben Tokenanlage geworden wäre · **AP7** Demo-Anmeldung abschaltbar (20.18.0, `ad93c9e`) · **AP4** Einwilligungen (20.19.0) und **AP5** Selbstlöschung mit Karenz samt Adresswechsel (20.20.0) zusammen in einem Commit (`edc3040`) · **AP6** Mengengrenze und Aufbewahrung je Konto (20.21.0, `533850d`; **Nr. 48** erledigt, von **Nr. 37** nur der Speichergrenzen-Teil) · **AP3** Selbstregistrierung (20.22.0, `93f0d6f`), berichtigt in 20.22.1 und 20.22.2 (**Nr. 231**) · **AP8** Handbuch und „Was ist NAdoku" als Seiten (20.23.0, `d3832e4`) · **AP9** Onboarding und die beiden Rückfragen (20.24.0, `978b345`). Dazu **20.21.1** (`de82dea`) mit drei Funden außerhalb der Pakete (**Nr. 225, 226, 227**); den ersten hat **kein Prüfmittel gemeldet** — die Profilseite lag zehn Tage lang außerhalb ihres Gerüsts, während der Bilderlauf für sie drei Nullen meldete, gefunden wurde sie beim **Ansehen** eines Bildes. Die Gegenprobe zählt seither je Seite die Karten außerhalb von `main.inhalt`. **AP10** ist der Merge von `main` (dort war seit dem P5a-Abschluss Web 20.16.0 bis 20.16.4 dazugekommen) mit **drei Nummernkollisionen**: Web 20.16.0 → 20.16.5, Backlog 215–225 → 223–233, Fassung 77 → 78 und 79. Auf dem Zweig liegen **sechs Migrationen** (`2026_09_16_protokoll_ereignisse`, `…_konto_lebenszyklus`, `…_einwilligungen`, `…_adresswechsel_bestaetigt`, `…_konto_grenzen`, `2026_09_17_erststart_rueckfragen`) — **`update.php` ist nach dem Merge fällig**. **Zuarbeit bleibt:** anwaltliche Prüfung der drei Entwürfe unter `docs/rechtstexte/` (E-P5b-24, -25) vor dem Einspielen in `rechtstexte`; AP4 baut so lange mit Platzhaltern |
...
16.09.2026, E-P5b-01 bis -25, AP1–AP10; nach dieser Freigabe gelöscht),
