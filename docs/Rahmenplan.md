...
**Fassung 113 (24.09.2026)** — dieses Dokument steuert das Programm:
...
| **Einschubkonzept RW erstellen lassen** — der Rückweg beim Zweitfaktor über den Wiederherstellungsschlüssel, fälschungssicher über ein Schlüsselpaar (Q-P5c-38, E-P5c-104). Eigene Sitzung, abgezweigt von `claude/p5c-mockups-konzept-4yeomf`, nur neue Dateien unter `docs/konzepte/`; Auftrag in `docs/konzepte/Vorbereitung-RW-Zweitfaktor-Rueckweg.md` | 10c (AP5b) | **vor AP11** — bis dahin gilt: Codes und Verwaltung |
| **Nach dem Merge des 10c-PR: `update.php` aufrufen** — Migrationen aus AP4, AP5, AP7 und AP8; die Wartung bleibt bis dahin an. **Bis 10c ausgeliefert ist, legt niemand ein Konto mit der Rolle admin an** (E-P5c-31, Nr. 286) | 10c | nach dem Merge |
...
| **112** | **24.09.2026** | Abschnitt 6: Die Zuarbeit „`pat_key_check IS NULL` zählen" ist erledigt (Staging 0 von 4, Produktiv nach dem Passwortwechsel der BetreiberIn 0 von 2). Neu die Zuarbeit **Einschubkonzept RW**: Der Rückweg beim Zweitfaktor über den Wiederherstellungsschlüssel, wie E-P5c-42 ihn vorsah, prüfte gegen einen Wert, den jeder Datenbankabzug enthält (F-P5c-106); die Betreiberin hat die fälschungssichere Fassung gewählt (Q-P5c-38), sie entsteht in einer eigenen Sitzung, und P5c/AP5 baut ohne sie (E-P5c-104). |
