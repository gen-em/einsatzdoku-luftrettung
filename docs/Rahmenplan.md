...
Android unberührt). **`update.php` IST fällig**: AP10 bringt die Migration
`2026_09_16_sicherungsziel_aufbewahrung` mit. Zuvor war PR #49 (`ee6d0b2`)
gemergt worden, der die Auslieferungskette aus AP1 vorgezogen hat — seither
geht ein Push auf `main` auf **Staging** und nicht mehr auf Produktiv.
Davor: **Schritt 9d (Demo-Ausbau)** gemergt (PR #48, `7f334cb`, 15.09.2026 —
Web 20.3.0, keine Migration). Fassung 67
