...
| 9a | **Sofortpaket Sicherheit** (R74) | Web: Nr. 117–128 (Rundenzahl 600 000, Login-CSRF, E-Mail-Nachweis, Ordner, GPX, `wiederherstellen.php`, Freitext-Hinweis, Bauordner, Ersetzfenster der Uhr, Maskierung, Photon-Schalter, Weg C, Integritätswache aus Nr. 130); Android: Nr. 132–135 und der Räumteil von 114 | Web sofort; Android nach Schritt 6 auf `main` | keins; `docs/konzepte/Vorbereitung-Sicherheitspaket.md` ist die Spezifikation (Muster R42, Prüfdokument mit Zahlen) | Opus | offen — alle Entscheidungen liegen vor (R74) |
| 9b | **S10 — Sicherheit** (R74) | Server-Anteil am Datenschlüssel mit Schlüsselblatt, Kennung und Rotation (SP-3); Adminpakete versiegeln, `ftp` abschaffen (Nr. 129) | Schritt 9a; **vor P5** (Hauptstufe, Umstellung aller Hüllen) | neu, nach K1 aus der Vorbereitung | Fable (Konzept), Opus | offen |
...
SP-13, SP-14) und die Integritätswache (SP-6, Nr. 130). **Entschieden am
...
Protokoll `ftp` abschaffen (Nr. 129). **Rang:** Web Haupt. **Konzept**
...
| 124 | Verlorene Uhr kann Phasen ersetzen (K-14) | Sofortpaket Sicherheit | Zeitfenster **72 h** ab Einsatzbeginn (F-SP-8) |
...
| 127 | Photon und Kachelserver (K-6) | Sofortpaket Sicherheit / S9 | Hinweis, Datenschutztext, Schalter mit Vorgabe „an" (F-SP-4); Selbstbetrieb mit Nr. 101 |
...
| 130 | Push auf `main` ist Deploy (K-16) | Zuarbeit / S10 | Branch-Schutz und 2FA sofort; Deploy-Tor mit Staging (R40 (2)); Integritätswache im Sofortpaket (F-SP-9) |
...
| ~~**Entscheidung F-SP-4** — Umfang des Photon-Schalters~~ (Nr. 127) | Schritt 9a | **entschieden 06.09.2026: (a)** — Hinweis, Datenschutztext, Schalter je Installation mit Vorgabe „an" |
| ~~**Entscheidung F-SP-8** — Zahl des Ersetzfensters der Uhr~~ (Nr. 124) | Schritt 9a | **entschieden 06.09.2026: 72 h** ab Einsatzbeginn |
| ~~**Entscheidung F-SP-9** — Integritätswache~~ (Nr. 130) | Schritt 9a | **entschieden 06.09.2026: (a)** — sofort, im Sofortpaket |
