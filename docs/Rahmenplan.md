...
| **Prüfliste TB — P-TB-06 und P-TB-07** (`docs/konzepte/Pruefdokument-TB-Tor-nach-Baum.md`). **P-TB-06:** beim nächsten echten Tag `web-v<WEB_VERSION>` Schritt 7 des Produktionslaufs lesen — er muss einen PR-Lauf mit passendem Baum und grünem Job `Stufe 1` nennen und darf nicht „Kein grüner Stufe-1-Lauf" melden. **Ein Test-Tag belegt das nicht:** `web-v20.37.1-test` (Lauf 35844281706) endete an „Tag gegen WEB_VERSION halten", einen Schritt vor dem Tor. **P-TB-07:** beim nächsten Fall zweier offener PRs „Update branch" nach dem ersten Merge sehen | Konzept TB | beim nächsten Web-Tag bzw. nächsten Fall |
