...
**Fassung 117 (24.09.2026)** — dieses Dokument steuert das Programm:
...
| **`betrieb.health_token` in `config.php` beider Anlagen** eintragen — der Health-Endpunkt liest ihn; ohne ihn bleibt 10c AP6 ohne Gegenstand. **`mail.postfach` entfällt** (E-P5c-51, 23.09.2026: AP10 gestrichen) | Betreiberin | **vor 10c AP6** (Einschub 20.09.2026, berichtigt mit Fassung 108) |
