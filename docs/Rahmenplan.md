...
wartet auf die Freigabe des Auftraggebers. **Schritt 9a läuft parallel** auf eigenem Zweig ohne Nr. 137
...
Versionsstufe 15.6.0 verschiebt sich dann.
...
**AP2 bis AP8 — offen.** AP2 beginnt nach dem Wort des Auftraggebers (K7).
