...
**Fassung 86 (20.09.2026)** — dieses Dokument steuert das Programm:
...
| 16 | **Sitzungsablage** (Stufe 2, R81) | Die Anwendung legt ihre Sitzungsdateien selbst ab (`.sitzungen/`, `0700`), Rückfall mit Anzeige, vierter Schreibort und Prüfpunkt „Ablage auflistbar?“ in `plattform_pruefen()`, Aufräumjob, **achter Schutzlistenpfad** (bei Kette II angemeldet, wird dort in AP4 oder AP5 eingetragen). Backlog **Nr. 241** | keine; **parallel zu Kette II** auf eigenem Zweig von `main`, Merge nach `main` nur auf Ansage | **liegt vor:** `docs/konzepte/Konzept-Sitzungsablage.md` (Fable, 20.09.2026, E-SA-01 bis -09, ein Paket; E-SA-02 am selben Tag neu gefasst — neun Sitzungsstarts statt drei) | Opus, Nebennummer | **Konzept freigegeben 20.09.2026** (korrigierte Fassung), **Umsetzung läuft auf eigenem Zweig** |
...
| 208 | Jobregister von Hand geführt | **Schritt 17** | Einschub 20.09.2026; **entfällt, wenn Schritt 16 es nachzieht** |
...
| 241 | Sitzungsablage — PHP-Sitzungen im geteilten Hosterverzeichnis | **Schritt 16** | Einschub 20.09.2026; Konzept liegt vor, freigegeben |
