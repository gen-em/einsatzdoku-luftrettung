...
**Fassung 55 (14.09.2026)** — dieses Dokument steuert das Programm:
...
| 183 | Der Pruefstand kennt nur eine Engine | **Teils erledigt**, Rest Backlog-Runde | **Seit dem 14.09.2026 liegen alle drei Engines im Pruefstand** — Chromium 141, Firefox 142, WebKit 26 ueber Playwright; der Startvorgang beschafft sie. Der Auftraggeber hat die beiden Downloadadressen freigegeben. **Offen bleibt das Mittel**, das sie benutzt: Bilderlauf, Klickprobe und Stilvergleich fahren weiterhin nur Chromium. Nr. 182 und Nr. 42 sind dreifach gemessen, aber von Hand |
