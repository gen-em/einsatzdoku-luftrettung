...
(Web 15.6.0, Backlog 68, 102, 106 erledigt), AP2 wartet auf die Freigabe des
Auftraggebers. **Schritt 9a läuft parallel** auf eigenem Zweig ohne Nr. 137
...
**AP1 — Vorschlagsliste und Klickprobe · erledigt, Web 15.6.0.** Eine Liste
...
erklärt), Kontraste **21/0**. Vier Funde, alle behoben — drei davon im
Prüfmittel selbst. **Drei Fragen an den Auftraggeber** stehen im
Prüfdokument, Abschnitt 4 (Zuordnung der Diensttags-Besatzung AP1 gegen
AP6; „`<datalist>` in der Streichliste"; achtzehn oder zwanzig
Backlog-Punkte im Abschluss).
