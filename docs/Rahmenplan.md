...
und **Android 0.13.0**. **Web 15.5.2** — die Korrekturstufe mit Nr. 148 und
149 — ist am 06.09.2026 als **PR #36** gemergt und damit ausgeliefert. Der
Nachtrag aus dem adversarialen Durchgang (Zahlen, Verweise, drei Schärfungen
an den Prüfmitteln) liegt auf `claude/backlog-148-149-web-md24ve` und ist
noch nicht auf `main`; er ändert am Verhalten der Anwendung nichts — der
einzige Anteil unter `server/` ist ein Kommentar. Seit Fassung 25 sind gemergt: **Paket E** des
...
geprüft und ausgeliefert** (Web 15.5.2, PR #36 am 06.09.2026). Offen sind die
zwei Punkte der Prüfliste in
`docs/konzepte/Pruefdokument-Korrektur-148-149.md` — sie sind **jetzt
fällig** — und der Nachtrag aus dem adversarialen Durchgang. Danach
**Schritt 9a**
...
| 9 | **Backlog-Runde** | Einzelpunkte nach Abschnitt 5 | ab Schritt 1, parallel | keins | Opus | offen — die **Korrekturstufe mit Nr. 148 und 149** ist **gemergt und ausgeliefert** (Web 15.5.2, PR #36, 06.09.2026); offen sind die zwei Punkte der Prüfliste und der Nachtrag aus dem adversarialen Durchgang |
...
„Diensttage zusammenführen" in der R57-Warnung führte ins Leere (Nr. 148) —
kein Prüfmittel klickt Knöpfe. **Behoben mit Web 15.5.2** in der
Korrekturstufe (Schritt 9), samt `tools/linkprobe/`, das die Lücke schließt.
...
**Gemergt am 06.09.2026 als PR #36**, damit ausgeliefert. **Offen bleiben**
die zwei Punkte der Prüfliste in
`docs/konzepte/Pruefdokument-Korrektur-148-149.md` — jetzt fällig — und der
Nachtrag aus dem adversarialen Durchgang (Zahlen, Verweise, drei Schärfungen
an den Prüfmitteln; unter `server/` nur ein Kommentar).
...
| 150 | Cron-Befehl für `jobs.php` mit dem Repositoriumspfad dokumentiert | Backlog-Runde | vier Stellen (Kopfkommentar `server/jobs.php`, `Technik.md` 4.97a und 7, Changelog-Eintrag Web 10.1.0) — ohne Zeilennummern, die verrutschen; der Deploy legt den Inhalt von `server/` nach `httpdocs/` — abgetippt ergibt das „Could not open input file". Die Karte „Auslöser" ist **nicht** betroffen (baut über `__DIR__`). Zwei Fragen offen: ob der Changelog angefasst wird, und welche Schreibweise künftig gilt |
...
| R57 | Überlappende aktive Diensttage: Hinweis im Browser (F-S4-D, Weg c) | **umgesetzt** (Web 13.3.0, Handbuch 4.5b); der 404-Fehler des Warnungsknopfes ist mit **Web 15.5.2 behoben** (Nr. 148) |
...
Knopf der R57-Warnung, gefunden am 06.09.2026) — **erledigt mit Web 15.5.2**
in der Korrekturstufe.
