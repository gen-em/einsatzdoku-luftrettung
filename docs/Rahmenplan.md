...
Migration, die nach dem Merge `update.php` verlangt). AP3 wartet auf die
...
**AP3 bis AP8 — offen.** AP3 beginnt nach dem Wort des Auftraggebers (K7).
