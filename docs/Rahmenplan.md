...
| 41 | Fünf Klassen ohne Regel | **Mockup-Runde** (9c) | **Entschieden 12.09.2026:** `imp-warn` und `imp-daygroup` bekommen eine Regel (zwei neue Darstellungen → Mockup), `rea-kopf`, `rea-beginn` und `phasen-name` werden mit Begründung gestrichen; `rmneu` war seit S9/AP1 beantwortet — fünf, nicht sechs |
