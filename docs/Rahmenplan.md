...
**Fassung 35 (07.09.2026)** — Neustrukturierung (Fassung 16). Dieses Dokument steuert
...
**Stand 07.09.2026 abends:** Der **Web-Teil von Schritt 9a ist gebaut und
geprüft** — Web 15.6.0, elf Punkte, elf Commits, Zweig
`claude/sofortpaket-sicherheit-1t70p1` gepusht. Offen ist der **Android-Teil**
(Nr. 142–145 und der Räumteil von 114) und danach der Merge auf `main`; wer
von 9a und S9 zweiter mergt, zieht die Buchführung nach (K7). Das Prüfdokument
liegt als `docs/konzepte/Pruefdokument-Sofortpaket-Sicherheit.md`.
