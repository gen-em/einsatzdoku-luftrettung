...
| 141 | Zweitfaktor für alle Konten (K-5) | **10c AP5** | erweitert R38; QR-Code, zehn Codes, „Gerät merken" mit Nr. 242 in Schritt 18 (E-P5c-41) |
...
| **Secret `STAGING_TOTP`** in der GitHub-Umgebung `staging` — das Zweitfaktor-Geheimnis des Prüfkontos, mit dem Stufe 2 sich anmeldet (E-P5c-43) | 10c AP5 | **vor dem Merge des 10c-PR** — sonst wird Stufe 2 rot und kein Tag kommt durch |
