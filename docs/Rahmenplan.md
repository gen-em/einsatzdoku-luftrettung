...
**Fassung 120 (25.09.2026)** — dieses Dokument steuert das Programm:
...
| 244 | Einstellungen-Übersicht **und vor allem das linke Menü** (`ui_leiste_einstellungen()`) | **10c, AP9** | Einschub 20.09.2026, berichtigt 20.09.2026 (M-P5c-01, E-P5c-29): Gemeint war vor allem die **Leiste**. Entschieden: Leiste mit Bereichsüberschriften **Option 1 „Linie"**, Übersicht mit **Bereichskarten**. **Der Fable-Schritt ist erledigt** — kein weiteres Mockup |
...
| 246 | Schlüsselblatt und Notfallblatt: Druckseite | **10c, AP9** | Einschub 20.09.2026; ändert E-P5b-09. Berichtigt 20.09.2026 (E-P5c-08/-30): oben **Bildmarke + Kurzname der Installation** (`instanz_kurz()`) statt eines festen „NAdoku" — das wäre auf einer umbenannten Installation falsch; **Webversion in der Fußzeile**. Freigegeben am Bild **M-P5c-01f** |
...
| 253 | Datum-Zeit-Trenner vereinheitlichen | **10c AP2 und AP9** | Schritt 15 (F-ZE-3); entschieden: das **Komma** (E-P5c-37); gemeint war ` · `, kein Gedankenstrich. Nachgetragen mit Fassung 108 — die Zeile fehlte (F-P5c-50) |
...
| 269 | `assets/schluesselblatt.js` — bei Netzausfall eine stille Sackgasse | **10c AP9** | Schritt 15; Beifang (E-P5c-46) |
