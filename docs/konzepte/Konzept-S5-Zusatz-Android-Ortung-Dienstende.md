...
> | Erledigt | Freigabe und alle sechs Fragen (E-S5Z-15 bis -21); Prüfstand aufgebaut, Ausgangszahlen gemessen; **E1 (Android 0.8.0)** |
> | Wo es hakt | **Die Diagnose 1.3 kann die Umsetzung nicht fahren** — sie braucht das S24 und den Produktivserver. Sie liegt beim Auftraggeber und ist Voraussetzung für den *Beleg* in E2, nicht für den *Bau* (E2 behebt alle drei Ketten unabhängig davon). Dazu: kein Emulator im Container (Vorbereitung 8.3), also ist Paket E gerätegebundener als Abschnitt 9.3 annimmt |
...
| **E-S5Z-25** | **Der Uhr-Spiegel steht am Rand, nicht über den Knöpfen** (B4.3). Abschnitt 6 sah die Zeile „unter der Zustandszeile, vor den Knöpfen" vor. Das widerspricht E-S4-51 („Bedienelemente in die Mitte, wo der Kreis breit ist, Statusanzeigen an den Rand") und dem gemessenen Vorbild: `dienst_schwebt` steht in `UhrActivity.kt` **zuletzt**, weil die Zeile davor beide Knöpfe nach unten schob und 1,66 % des Inhalts aus dem Glas liefen. Die Ortungszeile geht deshalb in die `Verbindungszeile` am Fuss — dorthin, wo `dienst_schwebt` schon steht und aus demselben Grund | B4.3; `UhrActivity.kt` 297–302 |
...
| Diagnose 1.3 | **offen — nicht durch die Umsetzung leistbar** | Sie braucht das S24 und den Produktivserver; beides steht dieser Instanz nicht zur Verfügung. Sie liegt beim Auftraggeber (die vier Schritte stehen in 1.3). **Wichtig:** Sie ist Voraussetzung für den *Beleg* in E2, nicht für den *Bau* — E2 behebt alle drei Ketten unabhängig vom Ergebnis | — |
| E1 | **erledigt** 03.09.2026, Android **0.8.0** | vier Fundstellen, alle unten | E-S5Z-22 (rot statt orange), E-S5Z-23 (Handler-Token), E-S5Z-27 (Wortlaut „GPS empfängt") |
| E2 | offen | — | — |
| E3 | offen | — | — |
...
**Prüffälle: 220 → 256** (+36). `OrtungswaechterTest` 21, `OrtungszuhoererTest`
