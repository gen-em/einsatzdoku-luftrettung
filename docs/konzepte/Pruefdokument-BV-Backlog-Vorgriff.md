...
| P-BV-06 | **Nach dem Merge von P5c:** die zurückgestellten Reste nachziehen lassen — den Textbaustein in Handbuch **11.5a** (Nr. 194; seit P5c/AP9 dort, die Notizen hat P5c ergänzt, der Abfahrtort fehlt), Handbuch Abschnitt 3 (Nr. 194) und den Kopfkommentar in `server/jobs.php` (Nr. 150, mit der nächsten Web-Stufe). **Wann, fragt Q-BV-04.** | Danach wandern Nr. 194 und 150 nach *Erledigt*. | Einer der beiden Punkte steht Wochen nach dem Merge noch offen. |
