...
> | Abschluss | **Mit P5c abgeschlossen, freigegeben am 25.09.2026** (Konzept P5c, AP11). Dieses Konzept wird mit dem Abschluss gelöscht; die Tabelle „Was ein Abzug enthält“ (5.2) und die Grenzen (6) stehen seither in `docs/Technik.md` 4.99q. Die Gegenlesung von AP11 fand hier zwei Soll-Punkte offen, beide als nicht gemessen benannt (Kreislauf `edbak` mit Paar, Stufe 2), und einen Fehler, den die Rückwegprobe festgeschrieben hatte (F-P5c-166: Lage „spalten“ über SQLite). Das Prüfdokument bleibt, bis P-RW-01 bis -05 abgehakt sind. |
