...
> | Offen | der **Merge auf `main`** nach Freigabe; danach **`update.php`** (die Migrationen aus AP2 und AP4). **Das Konzept wird erst nach der Freigabe gelöscht** (K9); das Prüfdokument bleibt, bis seine Prüfliste abgehakt ist |
>
