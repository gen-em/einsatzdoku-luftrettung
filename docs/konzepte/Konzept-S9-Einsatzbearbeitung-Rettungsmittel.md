...
> | Umsetzung | **AP1 bis AP8 erledigt** (AP4a und AP5b eingeschlossen) — **gebaut und geprüft, offen ist nur der Merge auf `main`** (07.–10.09.2026, Web 15.7.0 / 15.7.1 / 15.8.0 / 15.9.0 / 16.0.0 / 16.1.0 / 16.1.1 / 16.2.0 / 16.2.1 / 16.2.2 / 16.3.0 / 17.0.0 / 17.1.0 / 17.1.1 / 18.0.0 / 18.1.0 / 18.1.1 / 19.0.0 / 19.0.1 / 19.0.2 / 19.0.3 / **19.1.0**, Zweig `claude/go-bwucrx`) — siehe „Stand der Umsetzung" unten. Acht Arbeitspakete (Abschnitt 3) plus zwei Nachträge, parallel zu 9a auf eigenem Zweig, Buchführung nach K7 |
