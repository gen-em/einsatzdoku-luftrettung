...
> | **AP6** Tageszuordnung | **erledigt** 09.09.2026 | Web **18.1.0**, keine Migration | Klickprobe **3 neue Wege, 3 von 3**: Rollenzahlen je Rettungsmittel **5/3/0/3/0/0** über sechs Rettungsmittel gefahren (vier verschiedene Zahlen), Diensttag danach unverändert; „Anderes Rettungsmittel“ → Felder auf, **0 Rollenfelder** mit eigenem Satz, Veranstaltung → Luft gesperrt und Boden gesetzt; gespeichert und neu geladen → Auswahl „adhoc“, Name, Typ `sonstiges`, Betriebsart `ground`, **Standortkennung aus dem Treffer**, 0 Rollenfelder, Name in der Tagesliste. Referenzbestand danach unverändert (**0** Diensttage mit `vehicle_id IS NULL` und Namen, 21 Rettungsmittel, 61 Tage) | siehe Prüfdokument, Abschnitt AP6 |
