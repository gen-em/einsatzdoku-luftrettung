...
> | Umsetzung | **AP1 bis AP8 erledigt** (AP4a und AP5b eingeschlossen) — **gebaut, geprüft und am 10.09.2026 gemergt** (PR #38 und #39) (07.–10.09.2026, Web 15.7.0 / 15.7.1 / 15.8.0 / 15.9.0 / 16.0.0 / 16.1.0 / 16.1.1 / 16.2.0 / 16.2.1 / 16.2.2 / 16.3.0 / 17.0.0 / 17.1.0 / 17.1.1 / 18.0.0 / 18.1.0 / 18.1.1 / 19.0.0 / 19.0.1 / 19.0.2 / 19.0.3 / 19.1.0 / **19.1.1**, Zweig `claude/go-bwucrx`) — siehe „Stand der Umsetzung" unten. Acht Arbeitspakete (Abschnitt 3) plus zwei Nachträge, parallel zu 9a auf eigenem Zweig, Buchführung nach K7 |
> | AP5 in sechs Teilen | **1** Menü und Standortliste (erledigt, 16.2.0/16.2.1) · **2** die Standortseite (erledigt, 16.2.2) · **3** die neuen Bausteine — Sprungliste, Kartenfilter, „Zum Anfang“, `Design.md` 9 (erledigt, 16.3.0) · **4** die drei Dialoge **und die Verwaltungsseite** (erledigt, **17.0.0**) · **5** Standort löschen, Variante b (erledigt, **17.1.0**) · **6** Buchführung und Prüflauf (erledigt, **17.1.1**). **AP5 ist damit vollständig.** **Die Verwaltung (`admin_stammdaten.php`) war bewusst in Teil 4 gerückt** und nicht in Teil 2: Sie benutzte `sd_form()` an acht Stellen, und Teil 4 ersetzt genau das durch Dialoge — wer sie früher umgebaut hätte, hätte sie zweimal gebaut |
...
> | **AP5** Standortseiten — **Teil 4** (die Dialoge und die Verwaltung) | **erledigt** 09.09.2026 | Web **17.0.0**, keine Migration | Klickprobe **34 von 34** Wegen erfüllt, davon **10 in AP5** und **6 davon neu**; Gegenprobe: die 24 vorhandenen laufen weiter, **0 Rückstände** im Bestand. Die neuen Zahlen: **5 Dialoge im Markup, davon sichtbar 0**, nach dem Öffnen sichtbar **genau einer** (F-S9-U-27); Anlegen im Dialog → Adresse **`#td-143`**, Zeile gefunden, Fläche **rgb(255, 235, 214)**, **0 Meldungen am Seitenkopf**; Fehlerweg → Dialog **offen**, Meldung **im** Dialog („Diese Zielklinik gibt es an diesem Standort schon."), **0** Meldungen am Seitenkopf, Feld trägt noch den eingegebenen Namen; Typwechsel → Standard+Luft **5 Rollen, Fähigkeiten an, keine Standortauswahl**, Veranstaltung **Luft gesperrt, Boden gesetzt, 0 Rollen, Fähigkeiten aus, Standortauswahl an**; „Bearbeiten" füllt **7 von 7** Schlüsseln aus dem Öffner (Kennung, Name, Kurzname, Typ, Betriebsart, 5 Rollen, 2 Fähigkeiten) **ohne Navigation** (Adresse unverändert); Verwaltung → Besatzung anlegen **`#crew-259`, Fläche rgb(255, 235, 214), 0 Fehlermeldungen** (Backlog Nr. 163, seit Web 9.10.0 unmöglich). Drei AP4-Wege sind auf den Dialog umgestellt und setzen Betriebsart und Standort **am Browser vorbei** — sonst prüften sie ab jetzt nur noch die Anzeige und nicht mehr die Prüfschicht. Stilvergleich gegen 16.3.0: Kaskade **741 → 743 Regeln, 0 entfallen, 10 neu, 0 anderer Endwert, 0 Reihenfolgeumkehrungen**; berechnete Stile **45 500 Elementmessungen, 936 Abweichungen**, sämtlich an `dialog`, `.dialog`, `.dialog-kopf`, `.dialog-inhalt`, `.dialog-fuss` und dem `<form>` darin, Pseudoprobe dieselben 936. Wortliste **0 Treffer außerhalb der Ausnahmen** bei 96 Regeln, 96 gegriffen, 0 ungenutzt, 35 Dateien; Vollständigkeit **316 → 317**, der Unterschied vollständig erklärt (+1 Menüpfeil „→" in einem Kommentar von `version.php`, dieselbe Art wie die sechs aus AP2); Kontraste **22 Paare, 0 verfehlt**; Linkprobe **130 Verweise, 0 unbekannte Abweichungen**, 1 bekannte mit Nummer; Bilderlauf **6 von 7 berührten Seiten, 48 Einzelbilder + 6 Kontaktbögen, 0 Überlauf / 0 Konsolenfehler / 0 falsche Knopfhöhen**. **Die siebte Seite konnte nicht fotografiert werden** — der Referenzbestand hat keinen systemweiten Standort, `__ADMIN_STANDORT__` bleibt unauflösbar; die Klickprobe deckt sie ab, indem sie den Fall selbst herstellt. **Nachtrag 09.09.2026:** Backlog Nr. 166 schlug vor, dem Referenzbestand einen systemweiten Standort hinzuzufügen — **zurückgezogen**, weil **R39** (30.08.2026) die zentralen Stammdaten abschafft und in P5 zurückbaut. Weder dieses Konzept noch das Prüfdokument nannten R39; siehe Prüfdokument, Frage 10 |
> | **AP5** Standortseiten — **Teil 5** (Standort löschen, Variante b) | **erledigt** 09.09.2026 | Web **17.1.0**, keine Migration | Klickprobe **35 von 35** Wegen erfüllt, davon **1 neu**. Der Weg stellt den Fall her und räumt ihn ab: Standort mit **zwei** Rettungsmitteln (Standard und Bergwacht) und **einer** Zielklinik → Rückfrage **„2 eigene Stammdatensätze … werden mitgelöscht. 1 Rettungsmittel ohne Standortpflicht — KP Bergwacht Probe — bleibt bestehen …"**; nach dem Löschen Adresse **`#veh-208`**, Zeile mit Fläche **rgb(255, 235, 214)**, Karte „Ohne Standort" **offen**, **3** Einträge darin (2 aus dem Referenzbestand + 1 überlebtes), Standort **weg**. Bestand danach wieder **0 Probeeinträge**. Wortliste **0/0/0** bei 96 Regeln; Vollständigkeit **317 = 317**; Kontraste **22 Paare, 0 verfehlt**; Linkprobe **130 Verweise, 0 unbekannte Abweichungen**. **Kein Stilvergleich und kein Bilderlauf** — dieses Paket fasst `style.css` nicht an und ändert kein Markup, das ein Bild zeigte; die Rückfrage ist ein `data-confirm`-Text, den `confirm.js` erst beim Klick zeichnet. **Ein Fund beim Bauen** (von der Klickprobe): Der erste Entwurf rechnete die deutsche Adjektivendung aus der Zeichenkette und schrieb „Ein eigen**r** Stammdatensatz" |
> | **AP5** Standortseiten — **Teil 6** (Buchführung und Prüflauf) | **erledigt** 09.09.2026 | Web **17.1.1**, keine Migration | **Der volle Lauf über zwei Breiten UND beide Bedienhöhen:** Klickprobe **70 von 70** als Zeigergerät (390/1280 px) und **70 von 70** als Fingergerät — 35 Wege je Breite, **0 verfehlt**; Bestand danach **21 Rettungsmittel, 8 Standorte, 61 Diensttage, 346 Einsätze** und **0** Probeeinträge (`name LIKE 'KP %'` in vier Tabellen). Bilderlauf **6 von 7** berührten Seiten, **48 Einzelbilder + 6 Kontaktbögen je Lauf**, **0 Überlauf / 0 Konsolenfehler / 0 falsche Knopfhöhen** in **beiden** Bedienhöhen (44/36 px als Zeiger, 44 px als Finger). Wortliste **0 Treffer außerhalb der Ausnahmen, 0 ungenutzte Ausnahmen, 0 durchgerutschte Fallen** bei 96 Regeln, 96 gegriffen; Vollständigkeit **316 → 318**, beide Unterschiede benannt (ein Menüpfeil „→" und ein „⋯" in Kommentaren von `version.php`, dieselbe Art wie die sechs aus AP2); Kontraste **22 Paare, 0 verfehlt**; Linkprobe **130 Verweise, 0 unbekannte Abweichungen**, 1 bekannte mit Nummer. **Drei Funde, alle behoben:** der Leerzustand des Kartenfilters sagte einen Satz, den 17.0.0 falsch gemacht hatte; die Klickprobe hatte **zwei** Wege, die nur bei 1280 px gültig waren (Aktionsblatt unter 720 px, Richtungspfeile erst ab 280 px Spurlänge — jetzt gemessen: **190 px bei 390, 358 px bei 1280**); der Bilderlauf nannte für acht fehlende Aufnahmen den **falschen Grund**. Dazu eine Absicherung beim Gegenlesen: Das `UPDATE` aus Teil 5 lief vor der Eigentumsprüfung — gegengeprobt mit einer erfundenen Kennung, **Meldung statt Datenänderung, 2 Einträge vorher und 2 nachher** |
> | **AP5b** Die Tür schließen (Nachtrag zu AP5) | **erledigt** 09.09.2026 | Web **18.0.0**, keine Migration | `admin_stammdaten.php` **ersatzlos gestrichen** (1205 Zeilen), dazu die Karte „Vordefinierte Standorte“ und der Schreibweg `ub_toggle` in `einstellungen.php` (4327 → 4265 Zeilen). Entschieden am 09.09.2026: Weg (c) der Frage 10, und die Seite ganz statt entkernt — es gibt eine Installation, dort ist kein zentraler Standort mehr. Vorbedingung lokal gemessen: **sieben Zählungen, sieben Nullen** (`user_id IS NULL` in sechs Tabellen, dazu `user_bases`). Mitgegangen: `stammdaten_dup_personal_count()` (6 Aufrufer, alle in der gelöschten Datei), der zweite Parameter von `sd_seite()`, die Option `bearbeiten_href`, der fünfte Einbauort der Klickprobe (Soll **4 von 4**), zwei Seiten des Bilderlaufs (**46 → 44**, 368 → 352 Bilder) und der Platzhalter `__ADMIN_STANDORT__`. Der Schemarückbau bleibt P5 (**Backlog Nr. 168**) | Klickprobe **70/70 Zeiger und 70/70 Finger**, 0 Rückstände (21 Rettungsmittel, 8 Standorte, 61 Diensttage, 346 Einsätze); Bilderlauf je Bedienhöhe **352 Bilder + 44 Kontaktbögen, 0/0/0** und **0 ausgefallene Aufnahmen** (vorher 8 — F-S9-U-33 erledigt); Wortliste **0** außerhalb der Ausnahmen bei 96 Regeln, 96 gegriffen, Bereich (a) 99 → 98 Dateien; Vollständigkeit **318 → 316**; Kontraste **22 Paare, 0 verfehlt**; Linkprobe **116 Verweise, 0 unbekannte Abweichungen** (vorher 130); kein Stilvergleich, `style.css` unberührt |
> | **AP6** Tageszuordnung | **erledigt** 09.09.2026 | Web **18.1.0**, Korrekturstufe **18.1.1**, keine Migration | Klickprobe **3 neue Wege, 3 von 3**: Rollenzahlen je Rettungsmittel **5/3/0/3/0/0** über sechs Rettungsmittel gefahren (vier verschiedene Zahlen), Diensttag danach unverändert; „Anderes Rettungsmittel“ → Felder auf, **0 Rollenfelder** mit eigenem Satz, Veranstaltung → Luft gesperrt und Boden gesetzt; gespeichert und neu geladen → Auswahl „adhoc“, Name, Typ `sonstiges`, Betriebsart `ground`, **Standortkennung aus dem Treffer**, 0 Rollenfelder, Name in der Tagesliste. Referenzbestand danach unverändert (**0** Diensttage mit `vehicle_id IS NULL` und Namen, 21 Rettungsmittel, 61 Tage). Voller Lauf: Klickprobe **76/76 als Zeiger- und 76/76 als Fingergerät**; Bilderlauf **360 Einzelbilder + 45 Kontaktbögen je Bedienhöhe, 0/0/0, 0 ausgefallen** (neue Seite `12-tagesuebersicht-adhoc` für den aufgeklappten Zustand); Wiederherstellungsprobe **94 Erwartungen, 0 nicht erfüllt**; Linkprobe **116 Verweise, 0 unbekannte Abweichungen**; Wortliste **0** außerhalb der Ausnahmen; Vollständigkeit **316 → 322**, jeder Unterschied benannt; Kontraste **22 Paare, 0 verfehlt**; kein Stilvergleich, `style.css` unberührt. **Nachtrag 18.1.1 (Frage 11, Weg a und Punkt 3b):** ein **fünfter** Weg `ap6-einsatzformular-ohne-rollen-am-adhoc-tag` — gemessen **3 Rollen** im Einsatzformular am Tag mit Rettungsmittel (driver, trainee, other), **0** am Tag mit Tagesrettungsmittel, **2 Namen** weiter in der Leseansicht; Gegenprobe gegen die Fassung ohne die Behebung **2 statt 0** (genau die beiden benannten Rollen), also **39 von 40** gegen **40 von 40**. Dabei freigelegt: An einem solchen Tag ist Besatzung überhaupt nicht erfassbar (**Backlog Nr. 169**); Hinweis und Handbuch behaupteten das Gegenteil und sind berichtigt | siehe Prüfdokument, Abschnitt AP6 |
> | **AP7** Verschlüsselung und Kennzeichnung | **erledigt** 10.09.2026 | Web **19.0.0** (Katalog und Formular), **19.0.1** (Anzeige und Suche), **19.0.2** (Außenwege, Nutzlast 10 → 11), **19.0.3** (Anhebelauf), **19.1.0** (Kennzeichnung) — **keine Migration**, `update.php` muss nicht laufen | In fünf Schritten gefahren, jeder für sich gemessen. **Der Grund stand vorher nirgends:** `api/suchindex.php` lieferte jede Notiz im Klartext für den *gesamten* aktiven Bestand, ohne dass jemand entsperrt haben musste (alte Fassung 31 Schlüssel je Einsatz mit `notes`, neue 30 ohne), und die Zusage E6 „Administration sieht keinen Klartext" stimmte nicht, weil `notes` in der Spaltenliste des Adminpakets stand. **Suche:** gesperrt 0 von 83, entsperrt 1 von 83, Klartextwort gesperrt weiter 31 Treffer. **Anhebelauf:** 12 Einsätze, GET 12 · POST angehoben 12 / übersprungen 0 · GET leer; `manual = 1` bei 86 vorher wie nachher, `edited = 1` bei 79 vorher wie nachher (die Uhr-Falle umgangen). **Kennzeichnung:** 8 Schlösser, 9 Kleinzeilen, 0 Felder mit beidem. **Kreisläufe:** CSV 9120 Einzelvergleiche / 0 unerklärt / 1070 erwartet; Sicherung 287 842 / 0 / 159 — die Notiz steht dort in **beiden** Hälften, Spalte leer und `pat.notes` gefüllt, gleicher Wortlaut. **Referenzbestand:** `notes` in den Quelldaten von `felder` nach `geschuetzt` umgezogen (85 Einsätze), erzeugte Ausgabe **byte-gleich**, Generator 283 989 Einzelprüfungen / keine Befunde, Quelldatenprüfung 5961 / keine Befunde / 0 offene Matrixzeilen. **Ein Fund, den nur der Kreislauf gemeldet hat:** `import.js` führt die pat-Ziele in einem abschließenden `switch`; der fehlende `case` kostete **114 Notizen**, ohne Fehler und ohne Meldung | siehe Prüfdokument |
> | **AP8** Abschluss | **erledigt** 10.09.2026 | nur `docs/` und `tools/` — **kein Versionssprung** | Neun Backlog-Punkte nach *Erledigt* (44, 69, 108, 109, 111, 112, 113, 132, 152); das Konzept sagte „zwanzig", elf hatten AP1 bis AP7 unterwegs schon verschoben. Rahmenplan: Fahrplanzeile, Erledigt-Zeile in Abschnitt 8, Abschnitt 5 bereinigt (dabei eine **Dopplung von Nr. 69** entfernt), zwei Zeilen in Abschnitt 6, Fassung 38 mit Änderungsverlauf. **Stilvergleich gegen `main`, zum ersten Mal über die ganze Phase:** Kaskade 693 → 743 Regeln, 30 entfallen, 186 neu, 8 mit anderem Endwert, 0 Reihenfolgeumkehrungen; berechnete Stile **45 240 Elementmessungen, 2696 Abweichungen** — jede zugeordnet (Dialoge aus AP5 Teil 4, Leisten-Einrückung aus AP4a, Dokumenthöhe als Folge). Wartungsprobe 51/0, Wiederherstellungsprobe 94/0 | siehe Prüfdokument 3c |
> | **Nachtrag zu AP7** Das Schloss an zwei Stellen | **erledigt** 10.09.2026 | Web **19.1.1** — keine Migration | Zwei Meldungen aus der Bedienung, beide vom Bildschirm und **von keinem Prüfmittel**: In der Leseansicht trugen **7 von 8** Zeilen des entschlüsselten Blocks das Schloss, die **Einsatznummer** nicht; im Formular trug die Karte „Notizen“ nur die Kartenzahl, weil AP7 das dort freistehende Zeichen entfernt hatte. Behoben: `dtGeschuetzt()` an der achten Zeile, und ein neuer Schlüssel `geschuetzt` an `ui_karte_start()`, der das Schloss an den **Kartentitel** hängt (im `<h2>`, nicht daneben — `.karte-kopf` hat `gap`). Gemessen im Browser: Leseansicht „PatientIn“ **2 von 2** mit Schloss (vorher 1 von 2), Formular **1 von 9** Kartentiteln (vorher 0 von 9), 8 Feldbeschriftungen unverändert, **10** Schlösser auf der Formularseite. Wortliste **0** außerhalb der Ausnahmen über alle fünf Bereiche; Vollständigkeit **330 = 330**; kein Stilvergleich, `style.css` ist byte-gleich. **Dabei gefunden:** Die Symboltabelle in `docs/Design.md` war **seit längerem stale** (`hinweis` 24 statt 30, `schloss` 9 statt 13, `standort` 22 statt 23 — nachgerechnet gegen den Stand *vor* dieser Änderung); alle vier erzeugten Tabellen sind neu eingesetzt | siehe Prüfdokument 3d |
> | Offen | **nichts am Code.** S9 ist seit dem **10.09.2026 auf `main`** (PR #38, `0143df3`; der Nachtrag Web 19.1.1 als PR #39, `015b26f`) und ausgeliefert. Fällig sind **`update.php`** (die Migrationen aus AP2 und AP4) und die **32-Punkte-Prüfliste** des Prüfdokuments. **Das Konzept wird erst nach der Freigabe des Abschlusses gelöscht** (K9); das Prüfdokument bleibt, bis seine Prüfliste abgehakt ist |
>
...
> **Umgesetzt in AP7 (10.09.2026), mit drei Abweichungen vom Text hier.**
>
> 1. **Kein gespeicherter Merker für die Anhebung.** Das Konzept sagt „einmal
>    je Konto" — das ist die Wirkung, nicht der Mechanismus: Sobald kein
>    Einsatz mehr Klartext trägt, liefert `api/pat_anheben.php` eine leere
>    Liste. Ein Merker kostete eine Spalte samt Migration und wäre falsch,
>    sobald wieder Klartext hereinkommt (Sicherung mit Nutzlast 10,
>    CSV-Import einer alten Datei, Zurücksetzen des Demo-Kontos).
> 2. **Die Anhebung hängt an allen drei Entsperrwegen**, nicht nur am
>    Vormerkfach nach der Anmeldung wie `kdf_upgrade`: Jene braucht die
>    Passwortableitungen, diese den Inhaltsschlüssel — und den gibt es auch
>    Stunden später über den Dialog.
> 3. **Die Dateiliste des Arbeitspakets war unvollständig.** Sechs betroffene
>    Stellen fehlten und sind belegt: `server/api/import_commit.php` (der
>    serverseitige Schreibweg des Imports), `server/assets/import.js`
>    (`EINFACHE_ZIELE` **und** die abschließende `switch`-Liste der pat-Ziele
>    — dort kostete der fehlende `case` 114 Notizen), `server/suche.php`
>    (`baueHeuhaufen`), `server/einsatz.php` (die Anzeige),
>    `server/trash_lib.php` (vierter `SELECT *`) und `server/komplett_lib.php`
>    (die Komplettsicherung zieht ihre Spalten aus `information_schema`).
>    Dazu zwei Stellen, an denen `pat_blob IS NOT NULL` als Stellvertreter für
>    „hier hängt etwas Schützenswertes" dient: `adminbackup_lib.php` (Weg des
>    Adminpakets) und `api/schneiden.php` (Rückgängig eines Schnitts). Beide
>    ändern nach AP7 ihr Verhalten für einen Einsatz mit bloßer Notiz — der
>    Auftraggeber hat am 09.09.2026 entschieden, das anzunehmen und die Texte
>    nachzuziehen.
...
> **Umgesetzt in AP7 (10.09.2026), mit einer Abweichung.** Das Schloss steht
> **rechts** vom Wort, nicht links: Der vorhandene Baustein `.symbol-schutz`
> setzt es über `margin-left` dahinter, und genauso steht es seit Web 15 in der
> Leseansicht. Links hieße eine neue CSS-Regel und damit eine neue Darstellung
> — Mockup und Freigabe (CLAUDE.md 5), für einen Unterschied, den niemand
> verlangt hat. Formular und Leseansicht zeigen jetzt dasselbe Zeichen an
> derselben Stelle. `docs/Design.md` neu erzeugt: **unverändert**.
...
> **Nachtrag 09.09.2026 — Frage 11 entschieden (Weg a, Web 18.1.1).**
> „`day_crew` bleibt leer" gilt für den **Rollensatz**, nicht für vorhandene
> **Namen**: `dt_rollensatz_einfrieren()` löscht beim Wechsel nur leere
> Rollen, damit ein versehentlicher Wechsel keine Eingabe kostet. Ein Tag,
> der von einem Rettungsmittel mit Rollen umgestellt wurde, behält seine
> benannten Zeilen — und die **Leseansicht zeigt sie weiter**. So bleibt es:
> Sie berichtet, was gespeichert ist; die Leute waren im Dienst.
>
> **Zusatz aus derselben Entscheidung (Punkt 3b):** Das
> **Einsatzformular** liest denselben Rollensatz (`role_gate`) und bot
> deshalb an einem umgestellten Tag die alten Rollen an, an einem frisch
> angelegten keine — zwei Tage derselben Art, verschieden. Es fragt jetzt
> `dt_ist_tagesrettungsmittel()` und übergibt einen leeren Satz. Gemessen:
> **3 Rollen mit Rettungsmittel, 2 statt 0 danach** — die beiden benannten.
>
> **Was die Entscheidung freilegt:** An einem solchen Tag lässt sich
> Besatzung **überhaupt nicht** erfassen — beide Formulare fragen denselben
> Satz. Der Hinweis im Tagesformular und das Handbuch verwiesen auf die
> abweichende Besatzung am Einsatz und lagen damit falsch; beide sind
> berichtigt. Ob ein Tagesrettungsmittel Rollen anbieten **soll**, ist eine
> Gestaltungsfrage und steht als **Backlog Nr. 169** offen — nicht in S9
> entschieden, weil sie den Adhoc-Dialog um sieben Felder wachsen ließe
> (Weg a dort) oder E26 verletzte (Weg b: geraten wird nicht).
...
einmal in PHP, im Bootstrap); Klickprobe: Dialog aus allen Einbauorten geöffnet (**5 von
...
| P-05 | Dialog aus allen Einbauorten | Klickprobe | 5/5, seit Web 18.0.0 **4/4** (S9/AP5b: der fünfte Einbauort war die gestrichene Verwaltungsseite) |
...
- F-S9-U-33 — **Der Bilderlauf nannte für acht fehlende Aufnahmen den falschen
  ...
  Wahrheit ein Platzhalter nicht auflösbar war. Zwei verschiedene Befunde
  liefen in eine Liste und bekamen den Text des zweiten. Jede ausgefallene
  Aufnahme trägt jetzt ihren Grund, und die Zusammenfassung zählt nach Grund.
- F-S9-U-32 — **Zwei Wege der Klickprobe galten nur bei 1280 px.** Der Lauf
  über zwei Breiten war der erste. „Bearbeiten" steht unter 720 px im
  Aktionsblatt und nicht in der Zeile; und die Richtungspfeile auf der Spur
  gibt es bei 390 px gar nicht, weil `geo.js` sie erst ab 280 px Spurlänge
  zeichnet. Der Pfeilweg misst diese Länge jetzt selbst — **190 px bei 390,
  358 px bei 1280**.
- F-S9-U-31 — **Der Leerzustand des Kartenfilters sagte einen Satz, den
  AP5-4 falsch gemacht hatte** („Leere den Filter, um etwas anzulegen") —
  „Anlegen" steht seither im Kartenkopf und ist auch bei null Treffern da.
