...
> | Umsetzung | **AP1 bis AP4a erledigt**, **AP5 in Arbeit** (07.–09.09.2026, Web 15.7.0 / 15.7.1 / 15.8.0 / 15.9.0 / 16.0.0 / 16.1.0 / 16.1.1 / 16.2.0 / 16.2.1 / 16.2.2 / 16.3.0 / 17.0.0 / **17.1.0**, Zweig `claude/go-bwucrx`) — siehe „Stand der Umsetzung" unten. Acht Arbeitspakete (Abschnitt 3), parallel zu 9a auf eigenem Zweig, Buchführung nach K7 |
> | AP5 in sechs Teilen | **1** Menü und Standortliste (erledigt, 16.2.0/16.2.1) · **2** die Standortseite (erledigt, 16.2.2) · **3** die neuen Bausteine — Sprungliste, Kartenfilter, „Zum Anfang“, `Design.md` 9 (erledigt, 16.3.0) · **4** die drei Dialoge **und die Verwaltungsseite** (erledigt, **17.0.0**) · **5** Standort löschen, Variante b (erledigt, **17.1.0**) · **6** Buchführung und Prüflauf. **Die Verwaltung (`admin_stammdaten.php`) war bewusst in Teil 4 gerückt** und nicht in Teil 2: Sie benutzte `sd_form()` an acht Stellen, und Teil 4 ersetzt genau das durch Dialoge — wer sie früher umgebaut hätte, hätte sie zweimal gebaut |
