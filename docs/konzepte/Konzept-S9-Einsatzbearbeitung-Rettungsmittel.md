...
> | Umsetzung | **AP1 bis AP6 erledigt** (AP5b eingeschlossen), **AP7 als Nächstes** (07.–09.09.2026, Web 15.7.0 / 15.7.1 / 15.8.0 / 15.9.0 / 16.0.0 / 16.1.0 / 16.1.1 / 16.2.0 / 16.2.1 / 16.2.2 / 16.3.0 / 17.0.0 / 17.1.0 / 17.1.1 / 18.0.0 / 18.1.0 / **18.1.1**, Zweig `claude/go-bwucrx`) — siehe „Stand der Umsetzung" unten. Acht Arbeitspakete (Abschnitt 3), parallel zu 9a auf eigenem Zweig, Buchführung nach K7 |
