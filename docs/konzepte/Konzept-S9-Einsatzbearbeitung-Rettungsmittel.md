...
| M-S9-11 | Das Datum in der schmalen Leiste: Ist gegen drei Wege — Akkordeon 4 px · dazu Abstände 4 px · Datum ohne Jahr —, je bei 1024 px, dazu „Weg 3, Jahreszeile weggerollt"; Messtabelle über dreizehn Datumsangaben | Nr. 69, Prüfliste Punkt 26 | **liegt vor** (`konzept-s9/mockups/M-S9-11-datum-schmal.html`, dazu `-handy`; 08.09.2026, mit Einverständnis des Auftraggebers von Opus gebaut statt von Fable), **Freigabe offen.** Die Rahmen sind Aufnahmen der laufenden Anwendung, keine Nachbauten. Gemessen bei 1024 und 1199 px: Ist **3 von 12 „BW Hoch" ganz, 9 mit Ellipse** · Weg 1 **12 von 12** · Weg 2 **12 von 12**, also kein einziger mehr als Weg 1 bei zusätzlicher Gestaltungsänderung · Weg 3 **12 von 12 und der 16-Zeichen-Name dazu**. Empfehlung: Weg 1 jetzt, Weg 3 als eigene Frage |

**Zehn der elf sind freigegeben** — die ersten sieben am 06./07.09.2026,
M-S9-08 bis -10 am 08.09.2026, einzeln wie die anderen; **M-S9-11 liegt seit
dem 08.09.2026 zur Freigabe vor**. Die HTML-Dateien sind die
