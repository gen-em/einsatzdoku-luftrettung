...
| D (Hälfte 2) | offen — **Rest ist ein Abschnitt**: `docs/Handbuch.md` 12/12.1. Paket C hat 2.2, `docs/Geraete-Eingabe.md` und `Technik.md` 5 selbst geschrieben, als es die Wortlaute festlegte — das war nicht der Plan (E-S5-58 sah sie bei D), aber es ist die bessere Reihenfolge: Wer den Text erfindet, schreibt ihn auf. Offen bleiben die sieben K3-Zeilen und die eine K4-Zeile | — | — |
