...
> | Paket in Arbeit | **keines — A, B, C, D und der Zusatz W sind gebaut.** Offen ist nur noch der Abschluss: Freigabe, Erledigt-Zeile im Rahmenplan (R62), ein Push auf `main` (K7). E (Android-Zusatz) läuft in eigener Instanz auf `main` und ist von S5 unabhängig |
