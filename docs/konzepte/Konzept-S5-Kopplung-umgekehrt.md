...
> | Paket in Arbeit | **W (Wartungsmodus, Zusatzkonzept)** als nächstes auf `claude/s7-umsetzung-vorbereiten-s8kax0` — vier Fragen liegen dem Auftraggeber vor. Danach **D Hälfte 2**, die auf C wartet (E-S5-58). C (Uhr) und E (Android-Zusatz) laufen in eigenen Instanzen auf eigenen Zweigen |
...
> | Wo es hakt | Entschieden sind F-S5-01 bis -05, -07 bis -09, -11 und die nachgetragene F-S5-12 (E-S5-32 bis -59). **Offen:** F-S5-06 und F-S5-10 (C — von der Uhr-Instanz vorgelegt und beantwortet, sie trägt sie im Block 60–79 ein) und die vier Fragen des Zusatzkonzepts **Wartungsmodus** (F-S5W-01 bis -04), die dem Auftraggeber vorliegen. **Preisänderung durch E-S5-42:** die eine Bestandsuhr bleibt nach dem Deploy **nicht** gekoppelt (Abschnitt 8.1). **Der Server-Rundlauf der Android-Instanz ist seit Paket A stillgelegt** — er legte Codes in `pair_codes`; das Rezept für einen Prüfstand vor S5 steht seit D Hälfte 1 in `android/LIESMICH.md`. **Der Zweig geht nicht vor C auf `main`:** Bis dahin beschreibt `docs/Handbuch.md` 12 den alten Weg (E-S5-58) |
...
| D (Hälfte 2) | offen — **wartet auf Paket C** (E-S5-58): `docs/Handbuch.md` 12/12.1/2.2, `docs/Geraete-Eingabe.md`, `docs/Technik.md` 5 (Uhr-Module), `CLAUDE.md` 6 und `docs/Backlog.md` liegen bei der Uhr-Instanz (Paket C) | — | — |
