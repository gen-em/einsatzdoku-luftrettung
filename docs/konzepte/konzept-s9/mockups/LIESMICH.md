...
| `M-S9-11-datum-schmal.html` / `.png` | Das Datum in der schmalen Leiste (Prüfliste Punkt 26): Ist gegen drei Wege — Akkordeon 4 px · dazu Abstände 4 px · Datum ohne Jahr —, dazu ein Rahmen „Weg 3, Jahreszeile weggerollt". **Die Rahmen sind Aufnahmen der laufenden Anwendung**, keine Nachbauten; nur für Weg 3 ist der Datumstext im Browser umgeschrieben, weil CSS das nicht kann. Messtabelle über dreizehn Datumsangaben | 08.09.2026, **freigegeben: Weg 2** (gebaut mit Web 16.1.1); **Weg 3 verworfen** |
