...
> | Nächstes | **PR #81 ist gemergt** (`b329ac3`), P-PK-32 belegt. Offen: der Nachtrag-PR mit E-PK-47 bis -49, Z12 (Schemaprobe ins Ruleset), dann das **Korrekturpaket für die neun roten Proben** (E-PK-45) und danach P5c AP1. Danach **das Korrekturpaket für die neun roten Proben der Nebenstufe** (E-PK-45, Backlog Nr. 292) auf eigenem Zweig, **dann P5c AP1**. PK-06 folgt. |
...
neun roten Proben (E-PK-45, Nr. 292), danach die erste echte Nebenstufe
...
| **F-PK-40** | PK-05 (Messung) | **Die Nebenstufe misst 36 Proben in 1 266 s, und 9 sind rot** — auf frischer Anlage, Web 20.37.3. Drei Verdrahtungsfehler des Prüfstands (`versandprobe`, `spaltenregister-wegprobe`, `freigabeprobe`), eine veraltete Referenz (`kreislauf-csv` nach der Hausform), fünf ungeklärte (`wiederherstellung` = F-PK-18, `gpxprobe`, `wartungsprobe`, `mailprobe`, `browserprobe-csp`). Bis PK-05 lief keine davon in einer Stufe, die ein Tor las. | E-PK-45: Korrekturpaket vor P5c, Backlog Nr. 292. Ziel 15 min verfehlt — die Dauer gehört in dasselbe Paket. |
