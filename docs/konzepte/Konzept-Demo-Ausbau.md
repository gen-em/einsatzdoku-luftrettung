...
| | |
|---|---|
| **In Arbeit** | AP3 — Einspielen, Referenz und Fixture |
| **Erledigt** | **AP0** (Web 20.3.0) · **AP1** · **AP2** · **H-DA-1** (selbst geholt) |
| **Offen** | — |
| **Haltepunkte** | **H-DA-1 entfällt** (OSRM ist erreichbar, E-DA-22) · **H-DA-2 gefahren** (E-DA-23) · H-DA-3 offen (in AP3) |
