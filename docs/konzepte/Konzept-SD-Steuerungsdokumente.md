...
> | Offen | nichts an Fragen. **Die Freigabe des Abschlusses** (Prüfdokument 3.7); danach schreibt die Instanz Erledigt-Zeile und Verlaufszeile und löscht dieses Konzept (E-SD-45). P-SD-15 ist grün (Lauf 311); P-SD-16 läuft im zweiten Versuch — der erste fand F-SD-13 (behoben, E-SD-47). Befunde F-SD-01 bis F-SD-12 in 2.5: F-SD-05 klärt sich nur an der Anlage; F-SD-06 und F-SD-08 sind Sache von Schritt 17; F-SD-07 ist mit SD-04 erledigt. |
