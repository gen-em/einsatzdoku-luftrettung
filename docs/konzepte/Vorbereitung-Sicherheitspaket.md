...
| 1 | **Sofortpaket Web:** SP-1, SP-2, SP-8, SP-12 (a) Hinweis und Schalter, SP-13, SP-6 Integritätswache — Rahmenplan Schritt 9a, Backlog 127–138 und 140 | Kleinauslieferung, Muster R42, Prüfdokument | Web Neben |
| 2 | **Sofortpaket Android:** SP-14 — Rahmenplan Schritt 9a, Backlog 142–145 und 114 | Kleinauslieferung | Android Neben |
...
|---|---|---|
| F-SP-1 | Sofortpaket Web und Android (Schritt 1 und 2) | **Ja, als Ganzes.** Jeder Punkt ein Commit, einzeln rücknehmbar. Rahmenplan Schritt 9a, Backlog 127–138 und 142–145 |
...
| F-SP-3 | Zweitfaktor | **Wie vorgeschlagen:** für alle Konten angeboten, für Admins Pflicht (SP-11, Backlog 141, P5 als Erweiterung von R38) |
...
| F-SP-4 | Photon | **(a)** — Hinweis am Feld, Nennung im Datenschutztext, Schalter je Installation mit Vorgabe „an" (Backlog 137). Selbstbetrieb bleibt bei S9 PS-1 |
| F-SP-8 | Ersetzfenster der Uhr | **72 h ab Einsatzbeginn** (Backlog 134); Konstante in `db.php`, genannt in `JSON-Vertrag.md` und Handbuch 12 |
| F-SP-9 | Integritätswache | **(a)** — sofort, im Zweig des Sofortpakets (Backlog 140); keine eigene Mailadresse |
