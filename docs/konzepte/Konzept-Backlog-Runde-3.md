...
| | |
|---|---|
| **In Arbeit** | **AP8** — Nr. 173, tote Regeln aus den Ausnahmen der Kreisläufe |
| **Erledigt** | **Block A** (AP1–AP5) und **Block B vollständig** (AP6 Nr. 47, AP7 Nr. 58) |
| **Offen** | AP8, AP9 (Block C), AP10. **Haltepunkt H-BR3-2** liegt bei AP9 |
