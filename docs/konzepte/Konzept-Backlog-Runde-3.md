...
| | |
|---|---|
| **In Arbeit** | **AP6** — Nr. 47, Prüfgruppe „Zusagen": native Dialoge |
| **Erledigt** | **Block A vollständig** — AP1 (Nr. 91), AP2 (Nr. 94), AP3 (Nr. 117), AP4 (Nr. 67 Unterpunkt), AP5 (Nr. 41, drei Streichungen) |
| **Offen** | AP6 bis AP10 (Block B und C) |
