...
| | |
|---|---|
| **In Arbeit** | **AP7** — Nr. 58, zweite Prüfung der Gruppe: Seite ohne Gerüst. **Haltepunkt H-BR3-1** liegt hier |
| **Erledigt** | **Block A vollständig** (AP1–AP5) · **AP6** (Nr. 47, Prüfgruppe „5 Zusagen" mit der ersten Prüfung) |
| **Offen** | AP7 bis AP10 |
