...
| AP5 | Abschluss | **erledigt** (14.09.2026) | **Zwei Zahlen mussten dabei berichtigt werden, beide älter als diese Runde.** (1) Die Wartungsprobe hat **55** Erwartungen, nicht 53 — `docs/Technik.md` nannte die alte Zahl. (2) Der Rahmenplan-Kopf nannte die Backlog-Runde 3 noch als „zum Merge stehend“; gemessen an `origin/main` (`8f1712c`) ist sie gemergt, und der Stand dort ist Web 19.3.1. **Die Reste stehen in Abschnitt 6 des Rahmenplans**: die Prüfliste mit sieben Punkten, davon zwei, die nur ein echtes iPhone zeigt. |
