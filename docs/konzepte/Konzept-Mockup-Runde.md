...
> | | |
> |---|---|
> | In Arbeit | **AP3** (Nr. 45, dritte Kartengröße) — als Nächstes. Backlog-Runde 3 ist am 13.09.2026 gemergt (PR #43, `8f1712c`, Web 19.3.1) und in den Arbeitszweig geholt; sie hat drei der fünf `[offen]`-Klassen gestrichen und bringt mit `zusagen.md` die Mechanik, die AP2 braucht (E-MR-24) |
> | Erledigt | **AP2** (Nr. 42, Web 19.4.2, 14.09.2026) — beide Chips und der Satz der Meldung tragen Symbole; das Treffziel wächst von 17 × 15 px auf 28 × 28 px, in **drei Engines** gemessen (Chromium 141, Firefox 142, WebKit 26 — seit 14.09.2026 im Prüfstand, Nr. 183). · **AP1** (Nr. 41, Web 19.4.0, 13.09.2026) — `imp-daygroup` hat eine Regel, `imp-warn` ist gestrichen. Gemessen `[offen]` **2 → 0**, „ohne Gegenstück" **52 → 50**, Befunde **330 → 326**. **Dazu Nr. 182** (Web 19.4.1, 14.09.2026, F-MR-14 = Weg B): die Kopfzeile nimmt über eine Container-Abfrage die sichtbare Breite an, **ohne JavaScript**; gemessen bei 7 Breiten, alle vier Teile im Sichtfenster, 0 Überlauf, keine Konsolenfehler |
...
> | Stufe | **Web 19.4.2** — 19.4.0 Nebenstufe (AP1), 19.4.1 Korrektur (Nr. 182), 19.4.2 AP2. Uhr und Android unberührt |
