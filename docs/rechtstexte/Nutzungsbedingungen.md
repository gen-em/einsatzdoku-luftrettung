...
3.1 Je Person ein Konto. Die Angaben bei der Registrierung (Adresse, Name)
müssen zutreffen; die Adresse muss dich erreichen, weil der Dienst
...
3.3 Zugangsdaten sind geheim zu halten. Wer sich mit deinen Zugangsdaten
anmeldet, handelt aus Sicht des Dienstes als du. Bei Verdacht auf Missbrauch
änderst du das Passwort und trennst gekoppelte Geräte (Einstellungen →
Konto).
...
solange du dein Passwort kennst.

3.5 Der Dienst kann Geräte (Uhr, Handy) mit deinem Konto koppeln. Was ein
gekoppeltes Gerät sendet, wird deinem Konto zugerechnet.
...
Standorte, Rettungsmittel, Besatzungsnamen, Notizen zum Diensttag), steht in
der Datenschutzerklärung. Sie ist Teil dieser Bedingungen, soweit sie den
...
der dafür vorgesehenen Schnittstellen der Apps, das Einbringen von
Schadcode, die Nutzung fremder Konten oder Geräteschlüssel, und die Störung
des Dienstes.
...
nötig sind (Bestätigungen, Sicherheits- und Mengenhinweise, Ankündigungen
nach Abschnitt 7). Werbung gibt es nicht.
...
7.1 Der Dienst wird nach besten Kräften betrieben. Es gibt **keine Zusage**
...
9.1 Du kannst dein Konto jederzeit selbst löschen (Einstellungen → Konto).
Das Konto wird sofort gesperrt und nach einer **Frist von 30 Tagen**
...
10.2 Lehnst du eine neue Fassung ab, kannst du deine Daten exportieren und
dein Konto löschen (Abschnitt 9.1); eine weitere Nutzung ist nicht möglich.

## 11. Freie Software

11.1 NAdoku ist freie Software unter der GNU Affero General Public License
v3. Der Quelltext ist unter [Adresse des Repositoriums] verfügbar. Du kannst
...
12.1 Es gilt deutsches Recht. Gegenüber Verbraucherinnen und Verbrauchern
