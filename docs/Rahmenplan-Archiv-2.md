# Rahmenplan — Archiv 2 (Fassungen 16 bis 124)

**Protokoll, nicht Steuerung.** Wörtlich und eingefroren: `docs/Rahmenplan.md`
in Fassung 124 (26.09.2026, Commit `26101e1`; `origin/main` stand beim
Schnitt auf `d34908b`), ab der Trennlinie Zeichen für Zeichen. Nicht
fortgeschrieben. Verweise „Fassung 16" bis „Fassung 124" und „Rahmenplan
Abschnitt N" aus Dokumenten vor dem 26.09.2026 meinen den Text unten.
Fassungen 1–15: `Rahmenplan-Archiv.md`. Der Schnitt ist Konzept SD
(E-SD-01, SD-01); die Steuerung läuft ab Fassung 125 in `docs/Rahmenplan.md`
weiter, der Verlauf in `docs/Rahmenplan-Verlauf.md`.

## Wo die alten Abschnitte jetzt weiterleben

| alt (Fassung 16–124) | neu (ab Fassung 125) |
|---|---|
...
| 6a Staging einrichten (Schritte, Werte, Kästen) | 6a nur die Zehn-Schritte-Tabelle und die Werte (E-KH-21 bindet die Nummern); die Kästen nur hier |
| 6b Zweigschutz für `main` | 6b ein Verweis auf `Pruefablauf.md` 2.3; die Maske nur hier |
| 7 Register R1–R85 mit Volltext R51 ff. | 7 Kurzregister; Volltext R51–R85 nur hier |
| 8 Erledigt, 31 Blöcke | 8 Tabelle; Prüfzahlen im Prüfdokument, Volltext nur hier |
| 10 Änderungsverlauf 16–124 | `Rahmenplan-Verlauf.md` ab 125; 16–124 nur hier |

---
# Rahmenplan — Programm „Gen-EM NAdoku" bis v1.0

**Fassung 124 (26.09.2026)** — dieses Dokument steuert das Programm:
...
> **KETTE II IST GEMERGT — dieser Absatz ist erledigt** (PR #65, `fb614d1`,
> 21.09.2026). Rahmenplan und Backlog stehen wieder auf `main`; wer von dort
> arbeitet, liest sie von dort.
>
> **Was noch auf dem Zweig liegt:** AP7 (Hotfix-Weg) und diese Fassung —
> sie kommen mit dem Abschluss der Phase nach `main`. **Fassungen und
> Backlog-Nummern vergibt bis dahin weiter nur die Kette-II-Instanz**; die
> Konzeptinstanz liefert Änderungslisten.
>
> **Er stand bis Fassung 101 auf „Solange Kette II nicht gemergt ist"** —
> einen halben Tag nach dem Merge. **Das ist derselbe Fehler wie im Absatz
> darunter, und er ist derselben Stelle passiert**: Ein Satz über den
> Zustand eines Merges veraltet in dem Augenblick, in dem der Merge
> geschieht, und niemand kommt zurück, um ihn zu lesen. Wer einen solchen
> Satz schreibt, trägt ihn in die Aufgabenliste des Pakets ein, das den
> Merge macht — sonst bleibt er stehen.
...
nennen. **Die Reihenfolge der offenen Schritte ist:** **10c** (abgeschlossen am
25.09.2026, gemergt 26.09.2026, PR #89) → **SD** → **17** → **18** → 12 → 12a → 13 → 14; **PK-06 bis PK-08**
laufen daneben (Konzept PK). Davor erledigt und gemergt: **Kette II bis M1**
(M1 am 21.09.2026), **16**, **15**, **TB**, **PK-05** und das Korrekturpaket
**RP**; Schritt 11 ist erledigt, 10a und 10b sind gemergt. *(Berichtigt mit
Fassung 108, P5c/AP1, F-P5c-50: Hier stand bis dahin „Kette II (läuft) → 16 →
15 → 10c → …" — ohne PK und TB, die dazwischengekommen sind. Die Fassung 2
des P5c-Konzepts wollte „… → 15 → TB → PK-05 → 10c …" eintragen; bis zum
Einspielen waren TB und PK-05 schon gemergt.)*
...
> **ÜBERHOLT — M1 ist am 21.09.2026 erreicht:** Tag `web-v20.26.3` auf
> `a1c6494`, Lauf 35654132667 (Versuch 2), Produktiv meldet 20.26.3 (Konzept
> PK, Statusblock). Der Absatz unten bleibt als Werdegang stehen; berichtigt
> mit Fassung 108 (F-P5c-50).
>
> **UND GENAU DAS HAKT JETZT — Stand 21.09.2026.** M1 ist blockiert, und
> zwar **nicht an einem Arbeitspaket**: Stufe 2 kommt am Botschutz von
> lima-city nicht durch (F-KH-U-10 des Prüfdokuments), das Tor der grünen
> Läufe lässt deshalb keinen Tag durch, und ohne Tag kein Produktivlauf.
> **Weil Schritt 15 „nach Kette II (bis M1)" als Voraussetzung trägt,
> blockiert diese Hoster-Frage die ganze Reihe dahinter.**
>
> **Zwei Wege, und beide gehören der Betreiberin:** den Botschutz für die
> Läufer aussetzen lassen (oder für `login.php`) — oder die Voraussetzung
> von Schritt 15 bewusst auf „Kette II bis AP8" abschwächen und M1
> nachziehen. **Im Werkzeug umgangen wird der Botschutz nicht:** Dann
> prüfte Stufe 2 gegen eine Anlage, die sich anders verhält als die, die
> Nutzerinnen sehen — eine grüne Zahl ohne Aussage.
>
> **Was in der Zwischenzeit ohne M1 geht:** AP8a (die Buchführung dieser
> Fassung) ist gefahren; AP7 ist gebaut und zur Hälfte abgenommen. Was
> ohne M1 **nicht** geht: M2, AP8b und die Erledigt-Zeile.
...
| 9 | **Backlog-Runde** | Einzelpunkte nach Abschnitt 5 | ab Schritt 1, parallel | keins | Opus | offen — die **Korrekturstufe mit Nr. 148 und 149** ist gebaut, geprüft und **am 06.09.2026 auf `main` gemergt** (Web 15.5.2, PR #36). Ihre **zweiteilige Prüfliste** in `docs/konzepte/Pruefdokument-Korrektur-148-149.md` war seit dem Merge **fällig** — abgearbeitet, Prüfdokument gelöscht 24.09.2026 (Historie `5e501ae`). **Zwei Runden sind seither gebaut und gemergt** (berichtigt mit Fassung 47 — hier stand „offen ist allein die zweiteilige Prüfliste" und „die übrigen Einzelpunkte sind unangetastet", beides überholt): **Runde 1** am 12.09.2026 (PR #40, Web 19.1.2, sieben Punkte — 38, 93, 97, 151, 153, 156, 167; Abschnitt 8) und **Runde 2** am selben Tag (PR #41, Web 19.2.0 und 19.3.0, fünf Punkte — 118, 119, 120, 125, 126; Prüfdokument `Pruefdokument-Backlog-Runde-2.md` mit **sieben** Punkten — abgearbeitet, gelöscht 24.09.2026). **Runde 3 ist konzipiert** (13.09.2026, `docs/konzepte/Konzept-Backlog-Runde-3.md`, Prüfdokument-Vorlage daneben): Block A Nr. 91, 94, 117, 67-Unterpunkt, 41-Streichungen · Block B Nr. 47, 58 (Prüfgruppe „Zusagen" in `tools/vollstaendigkeit/`) · Block C Nr. 173, 174 (Referenzdateien neu) — keine Fable-Schritte, Umsetzung Opus |
...
| 9d | **Demo-Ausbau** | Referenzbestand und Demo-Konto um die S9-Typen im Betrieb erweitern: fünf Diensttage (Bergwachtnotarzt ×2, VEF Talwang, zwei Veranstaltungen), 16 Einsätze + 2 Schnitte, Standorte mit Koordinaten, Tage ohne Standort, Fußwege; dazu die Regeländerung **Fähigkeiten bei Typ Bergwacht in beiden Betriebsarten** (AP0, `server/`, keine Migration) | **Schritt 9b gemergt** — erfüllt am 14.09.2026; parallel zum P5-Konzept | `docs/konzepte/Konzept-Demo-Ausbau.md` (Fable, 15.09.2026; E-DA-01 bis E-DA-32) | Opus, kein Fable-Schritt | **Gebaut und geprüft** (Zweig `claude/umsetzung-ohne-pausen-2vfppr`): **AP0 bis AP4 erledigt** 14./15.09.2026, **Web 20.3.0**. Der Haltepunkt **H-DA-1 ist entfallen** — `router.project-osrm.org` war erreichbar, die Umsetzung hat die Strecken selbst geholt und eingecheckt (E-DA-22); **H-DA-3 nicht ausgelöst** (beide Kreisläufe 0 unerklärt). Zahlen in Abschnitt 8. **Am 15.09.2026 auf `main` gemergt** (PR #48, `7f334cb`; berichtigt mit Fassung 68 — hier stand „Offen: Merge"). **Abgeschlossen 24.09.2026:** Freigabe erteilt, Prüfliste abgearbeitet, Konzept und Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`); der Demo-Reset steht in Abschnitt 6 |
| 10a | **P5a — Kette und Fundament** (R82) | `deploy.yml` nach R67 (Staging automatisch, Prüftor Stufen 1–2, Produktion mit Freigabe- und Backup-Tor); Plattformprüfung in `install.php` und Status (R81); Torwächter mit Wartungsmodus (R40.4, Nr. 54); Kopfzeilen aus PHP nach SP-5 (Nr. 8); Mail-Warteschlange; Mengenbremse `ingest.php` (R19, Nr. 17 — Grundsatzfrage zuerst); IP-Grenzwerte und vertrauenswürdige Proxys; 503-Weg an der Verbindungsgrenze; Job für Nr. 80; Aufbewahrung auf dem Sicherungsziel (Nr. 49); Nr. 37, 67, 195 | Schritte 2, 5, 7 und 9b **erfüllt**; Hosting-Entscheidung **gefallen 15.09.2026 (R81)**; Staging-Ziel **festgelegt 15.09.2026** (Einrichtung offen) | **nach der Freigabe gelöscht** (Fable, 15.09.2026, E-P5a-01 bis -58 — 37 davon in der Umsetzung dazugekommen, AP1–AP12 plus AP4a; Historie `bcbb04f`). **Das Prüfdokument** (`Pruefdokument-P5a-Kette-und-Fundament.md`, 33 Punkte) ist abgearbeitet und am 24.09.2026 gelöscht (Historie `5e501ae`). Vorbereitung `Vorbereitung-P5-Plattformprofil.md` (PP-1 bis PP-9, E-PP-01 bis -09) | Fable (Konzept), Umsetzung Opus (K2) | **ERLEDIGT UND GEMERGT — PR #50 am 16.09.2026** (`14f99ac`) (Web 20.4.0 bis **20.15.2**, zwölf Pakete plus den Nachtrag AP4a und zwei Nachträge aus der Durchsicht). Einzelheiten in **Abschnitt 8**. Der **Tag steht noch aus** — er ist die Auslieferung auf Produktiv und wird gesondert gesetzt. F-P5a-1 ist E-P5a-22 (Tag-Muster `web-vX.Y.Z`). **Zuarbeiten offen** (Abschnitt 6a): GitHub-Umgebung `produktion`, Zweigschutz `main`, Staging-Installation samt Prüfkonto — ohne sie ist die Kette gebaut, aber nicht gelaufen |
| Kette II | **Härtung der Auslieferungskette** | Zeiger-Zweig und Integritätswache (AP2), Tor/Zielprobe/Probelauf (AP3), F3 beheben (AP4), gemeinsame Schrittfolge (AP5), Abbruchverhalten und Härtung (AP6), Hotfix-Weg (AP7), Abschluss (AP8); Meilensteine **M1** (erster grüner Produktivlauf) und **M2** (Probe-Hotfix) | — | **liegt vor:** `docs/konzepte/Konzept-Kette-Haertung.md` (freigegeben 20.09.2026, E-KH-01 bis **-30**) | Opus | **GEMERGT NACH `main` — PR #65, `fb614d1`, 21.09.2026** (AP1 bis AP6; AP7 liegt auf dem Arbeitszweig). **Keine Versionsstufe:** Kette II fasst `server/` nicht an (E-KH-23). **Gebaut: AP1 bis AP7. Abgenommen: AP2 bis AP6, AP7 zur Hälfte.** AP4: F3 gefunden und behoben — der Abbruch passiert beim `RETR` auf die nicht vorhandene Zustandsdatei, gemeldet wird er erst beim `MKD` drei Schritte später (F-KH-U-25); Beleg 688 Dateien ohne `ECONNRESET`, **E-KH-09 erfüllt**. AP5: Staging 4 → **17** Schritte, Schutzliste **einmal** statt zweimal, `auslieferung.yml` 1 205 → 657 Zeilen; abgenommen mit den Läufen 35566000648 (Pflichtfreigabe) und 35570398032 (Staging, 17 Schritte in 49 s). AP6: keine Vorgabewerte mehr, Überspringen ist rot, Wartungsschalter nach hinten, Schlussschritt; abgenommen mit zwei provozierten Fehlschlägen, die `Wartung: an` und `Wartung: aus` aus derselben Lage meldeten (F-KH-U-39). AP7: Hotfix-Weg über `hotfix/*` mit Abstammungsprüfung gegen den Zeiger (`tools/kette/freigabe.py`, **32 Lagen**); die vom Konzept verlangte Gegenprobe ist belegt, **ohne auszuliefern**. **OFFEN UND BLOCKIERT: M1** — Stufe 2 kommt am Botschutz von lima-city nicht durch (F-KH-U-10), und das Tor der grünen Läufe lässt deshalb keinen Tag durch. **Das ist eine Hoster-Frage, kein Arbeitspaket**; im Werkzeug umgangen wird der Botschutz nicht — dann prüfte Stufe 2 gegen eine Anlage, die sich anders verhält als die, die Nutzerinnen sehen. Danach **M2** (Probe-Hotfix) und **AP8b** (Abschluss, Erledigt-Zeile). **Zuarbeiten der Betreiberin offen:** Prüfpunkte 26 bis 28 des Prüfdokuments — der Rückfallstand bei einer echten Auslieferung, der Hotfix über den ganzen Weg, und die **Aufbewahrung der Komplett-Stände auf Staging** (gemessen: Vorgabe **2**, zu wenig für den Hotfix-Weg — Backlog Nr. 261) |
...
| 10c | **P5c — Rollen, Sicherheit, Betriebslage** (R82) | Support-Rolle; **Zweitfaktor: Pflicht für Admin, BetreiberIn und Support, Angebot für alle übrigen** (Nr. 141, E-P5c-15, F-P5c-1); Protokoll-Oberfläche mit Reitern, versiegeltem Archiv, Download und Rechten — **Ort: Verwaltung → Protokoll** (V1–V9 entschieden, F-P5c-7); Ankündigungsbanner **und Umgebungsbanner** (Nr. 243, AP1); Fehlerprotokoll (`error_log()` → Reiter System, **75 Aufrufe** — Übergabezahl aus Schritt 15, E-ZE-05; dazu Nr. 248); Health-Endpunkt; Betriebslage mit Geräteverteilung nach R64-Herkunft (R38, R42, Nr. 80 Rest, 191, 192 — **Nr. 122 NICHT**, sie geht nach Schritt 17, E-P5c-23); R39-Rest (Nr. 168, 169); **Aufräumen der Einstellungen** (Nr. 244, 245, 246, 121 — **die Mockup-Runde M-P5c-01 ist gefahren**, kein Fable-Schritt mehr; **Nr. 198 gehört nicht mehr dazu**, sie wird nicht umgesetzt, E-P5c-27); ~~Bounce-Postfach (Nr. 200)~~ — **entfällt** (E-P5c-51, AP10 gestrichen) | **Schritte 16 und 15; PK-05; Freigabe M-P5c-02 — alle erfüllt** (15 gemergt PR #74, PK-05 PR #81/#82, M-P5c-02 freigegeben 23.09.2026; dazu das Korrekturpaket RP, PR #83, E-PK-45); die Andockstellen stehen seit dem Abschluss von Schritt 15 **im eigenen Konzept**, Abschnitt „Andockstellen aus Schritt 15“ (gegen den gebauten Stand nachgezogen), und **AP3 baut kein Zählmittel** (E-ZE-03 — es besteht seit Schritt 15 AP1) | **abgeschlossen und gelöscht** (25.09.2026, K9) — Konzept P5c (Fassung 2, E-P5c-01 bis -134, Q-P5c-01 bis -55, F-P5c-01 bis -169) und das Einschubkonzept RW, dazu beide Vorbereitungen und die Mockup-Ordner `konzept-p5c/` und `konzept-rw/` (Q-P5c-54); **letzter Stand `ae829e6`**. Die Prüfdokumente P5c und RW bleiben, bis ihre Prüflisten abgehakt sind. Zusammenfassung in Abschnitt 8 | Fable (Konzept), Opus (Umsetzung) | **erledigt 25.09.2026** — Web **20.38.0 bis 21.1.2** auf `claude/p5c-mockups-konzept-4yeomf`: AP1–AP9, AP5b (Konzept RW, RW-01 bis -04) und AP11; AP10 entfallen. **Mit Migrationen** (AP4, AP5, AP5b, AP7, AP8 — nach dem Merge `update.php`, Abschnitt 6). **Gemergt: PR #89, `29cf394`, 26.09.2026**; der Tag durch die Betreiberin |
...
| 15 | **Zentralisierung — eine Stelle je Sache** (R83) | Verstreuter Code im Web-Teil (`server/`, ohne `assets/vendor/`) nach dem Vorbild von `mission_fields.php` an je eine Stelle: **zehn Arbeitspakete**. Paket 1 aus Nr. 202 (Marke/Mail/Link/Token) ist **durch** — AP1 fährt nur noch die Gegenprobe; Paket 6 bleibt **Beifang** (kein Arbeitspaket, nur mit Arbeit an der Datei); **dazu Nr. 57** (die Tagesübersicht baut ihre Einsatztabelle zweimal) und der **Konfigurationsleser**. **Ohne** den Log-Helfer (77 Aufrufe in 32 Dateien — der geht nach 10c AP3) und **ohne** Umbau gelaufener Migrationen (E-ZE-04, die eine Ausnahme von „alles wird angegangen"). Backlog **Nr. 202** (Sammelnummer), **Nr. 57**, neu **250–253** | **nach Kette II (bis M1)**; **Schritt 16 gemergt — erfüllt** (PR #61/#62). Misst beim Konzept **10a UND 10b gemeinsam** nach — 10b ist vor 15 gebaut worden | **erledigt** — das Konzept ist mit dem Abschluss gelöscht (K9), die Git-Historie behält es; das Prüfdokument `docs/konzepte/Pruefdokument-Zentralisierung.md` ist abgearbeitet und am 24.09.2026 gelöscht (Historie `5e501ae`). Zusammenfassung in Abschnitt 8 | Fable (Konzept), Opus (Umsetzung, kein Mockup) | **erledigt 22.09.2026** — Web 20.27.0 bis 20.37.0, zehn Arbeitspakete, elf Versionsstufen, **keine Migration**. **Gemergt am 23.09.2026** (PR #74, `6e94e0a`; berichtigt mit Fassung 108 — hier stand „Merge nach `main` offen") |
| 16 | **Sitzungsablage** (Stufe 2, R81) | Die Anwendung legt ihre Sitzungsdateien selbst ab (`.sitzungen/`, `0700`), Rückfall mit Anzeige, vierter Schreibort und Prüfpunkt „Ablage auflistbar?“ in `plattform_pruefen()`, Aufräumjob, **achter Schutzlistenpfad** (bei Kette II angemeldet, wird dort in AP4 oder AP5 eingetragen). Backlog **Nr. 241** | keine; **parallel zu Kette II** auf eigenem Zweig von `main`, Merge nach `main` nur auf Ansage | **liegt vor:** `docs/konzepte/Konzept-Sitzungsablage.md` (Fable, 20.09.2026, E-SA-01 bis -09, ein Paket; E-SA-02 am selben Tag neu gefasst — neun Sitzungsstarts statt drei) | Opus, Nebennummer | **ERLEDIGT UND GEMERGT — PR #61 und #62, `1822d38`, 20.09.2026** (Web **20.26.0**). `server/sitzung_lib.php` legt `.sitzungen/` mit `0700` an, gerufen aus `db.php` und `install.php`; Rückfall auf den Hosterpfad **mit Anzeige**; vierter Schreibort und dreiwertiger Prüfpunkt „Sitzungsablage" in `plattform_pruefen()`; Aufräumteil „Sitzungsdateien" (nur `sess_*`). **Der achte Schutzlistenpfad ist mit Kette II/AP3 eingetragen.** PR #62 hat fünf Sätze berichtigt, die den Löschabgleich des Transports zu stark beschrieben hatten. **Prüfung erfolgt; Konzept und Prüfdokument am 24.09.2026 gelöscht** (Erledigt-Zeile in Abschnitt 8, Historie `5e501ae`) |
...
| — | **SD — Steuerungsdokumente schneiden** | Rahmenplan und Backlog schneiden: zweites wörtliches Archiv, Verlauf-Datei, Kopfzeilen im Backlog, Erledigt-Datei, Längendecken als Stufe-1-Schritt | Merge von 10c; kein anderer Zweig an Rahmenplan/Backlog | `docs/konzepte/Konzept-SD-Steuerungsdokumente.md` | Opus | Konzept vorgelegt 24.09.2026; SD-00 mit dieser Fassung erledigt |
...
Abschnitt 6; das Prüfdokument
`docs/konzepte/Pruefdokument-S7-Backup-Begriff.md` ist abgearbeitet und am
24.09.2026 gelöscht (Historie `5e501ae`). Das Konzept ist nach
...
Abschnitt 8; was noch am Auftraggeber lag, stand in Abschnitt 6 und im
Prüfdokument `docs/konzepte/Pruefdokument-S5-Kopplung-umgekehrt.md`
(zwölf Punkte; abgearbeitet, gelöscht am 24.09.2026, Historie `5e501ae`).
...
**Die drei Konzepte** (`Konzept-S5-Kopplung-umgekehrt.md`,
`…-Zusatz-Wartungsmodus.md`, `…-Zusatz-Android-Ortung-Dienstende.md`) **sind
am 24.09.2026 gelöscht** — die Freigabe des Abschlusses ist mit Fassung 110
erteilt, Historie `5e501ae`. Bis dahin stand hier „stehen noch".
...
Sammlung mit ihren neunzehn Entscheidungen lag in
`docs/konzepte/Vorbereitung-S9-Problemsammlung.md` (gelöscht 24.09.2026,
Historie `5e501ae`). **Inhalt** (Konzept
...
`docs/konzepte/vorbereitung-s9/` (Ordner gelöscht 24.09.2026, Historie
`5e501ae`); Befund: Schilder teils zu groß, vor
...
**Gemergt am 06.09.2026** (PR #36). **Offen blieben** die zwei Punkte der
Prüfliste in `docs/konzepte/Pruefdokument-Korrektur-148-149.md` —
abgearbeitet, Dokument gelöscht am 24.09.2026 (Historie `5e501ae`).
...
· Rückbau der zentralen Stammdaten (R39, **Backlog Nr. 168**) — die Bestandsaufnahme dazu (208 Befunde) ist mit 10c AP8 gelöscht, Historie in Git; S9 hat die Tür mit Web 18.0.0 bereits geschlossen · Servicemodell (R33) ·
...
| Kommt in P5 | Seite |
|---|---|
| Support-Adresse (R31), Rechtstexte (R32), Betriebsart der Registrierung und Einwilligungen mit Fassung (R37), Ankündigungsbanner (R38) | Verwaltung → **Installation** — *die Rechtstexte seit Web 21.1.0 als eigene Seite Verwaltung → Rechtstexte (E-P5c-28), die Ankündigung unter Betrieb → Servereinstellungen (E-P5c-69). Berichtigt mit Fassung 122* |
...
| Admin-TOTP (R38) | Einstellungen → **Profil**, Karte „Sicherheit" (nur Admin und BetreiberIn) — *gebaut als Karte „Zweitfaktor", Pflicht für Support, Admin und BetreiberIn, Angebot für alle (E-P5c-15). Berichtigt mit Fassung 122* |
| Audit-Protokoll, Fehlerprotokoll-Sicht, Health-Endpunkt (R38) | Betrieb → **Status** (Health, Fehlerprotokoll); Audit als eigene Seite oder Unterseite von Status — *gebaut anders (10c): das Protokoll unter **Verwaltung → Protokoll** (E-P5c-02), das Fehlerprotokoll dort als Reiter System (AP3), der Health-Endpunkt **ohne Seite**, der Token steht in `config.php` (E-P5c-17, -52). Berichtigt mit Fassung 122* |
...
**Die zehn Arbeitspakete** — **alle gebaut, Stand 22.09.2026**; was dabei herauskam, steht in Abschnitt 8. Der Befund unten ist **Protokoll**: Die Zahlen standen für `main` vom 16.09.2026, wurden am 20.09.2026 an `862ca7f` nachgemessen und sind mit dem Bauen überholt — die gemessenen Vorher/Nachher-Werte je Zeile führt `tools/zaehlung/register.php`, und das Konzept, das sie sammelte, ist mit dem Abschluss gelöscht (K9). Aus den sechs Paketen sind zehn geworden, und ihre Reihenfolge ist nicht die der Pakete:

**AP1** Zählmittel, Register, Gegenprobe Paket 1 · **AP2** Konfiguration und
Sitzung · **AP3** API-Eingang und Flash · **AP4** Datenzugriff klein ·
**AP5** Transaktion und Kindtabellen · **AP6** Spaltenregister `missions` ·
**AP7** Zeit und Zahl in PHP · **AP8** JavaScript · **AP9** Nr. 57: eine
Einsatztabelle · **AP10** Abschluss und Übergabe an 10c.

**Warum diese Folge:** AP1 zuerst — ohne Zählmittel keine Abnahme in Zahlen.
AP2 vor allem anderen in `server/`, weil Schritt 16 und 10c daran andocken.
AP4 vor AP5 und AP6 (`einsatz_lib.php` entsteht dort), AP8 vor AP9
(`assets/format.js`), AP6 vor AP9 (Spalten für `api/range.php` und
`api/suchindex.php`). AP10 zuletzt.

**Paket 1 ist durch** (Gegenprobe in AP1), **Paket 6 bleibt Beifang** — kein
Arbeitspaket, nur zusammen mit Arbeit an der jeweiligen Datei. **Der
Log-Helfer gehört nicht hierher**, sondern nach 10c AP3 (77 Aufrufe in 32
Dateien).

**Eine Ausnahme von „alles wird angegangen", und sie ist begründet
(E-ZE-04):** Die **57 Schemaabfragen in gelaufenen Migrationen** werden
**nicht** umgebaut. Eine gelaufene Migration umzuschreiben hieße, eine Anlage
anders zu behandeln als die, auf der sie schon lief. Das Migrationsregister
in P8 (R66) löst es an der Wurzel; bis dahin steht im Zählmittel eine
**Decke von 57**, die nicht wachsen darf. Backlog **Nr. 252**. Das ist ein
Satz in diesem Block und **keine Programmentscheidung** — R83 bleibt
unverändert, ein neues R gibt es nicht.

**Der alte Befund von 16.09.2026** steht darunter unverändert, weil die
Sachen dieselben geblieben sind; nur die Zahlen und der Zuschnitt sind es
nicht.

**Die sechs Pakete des Befunds vom 16.09.2026:**
...
**Voraussetzung:** Kette II bis M1; **Schritt 16 gemergt — erfüllt** (PR #61/#62). **Konzept:** Fable, 20.09.2026, E-ZE-01 bis **-35**, F-ZE-1 bis -6, AP1–AP10, kein Fable-Schritt — **mit dem Abschluss gelöscht** (K9); das Prüfdokument `docs/konzepte/Pruefdokument-Zentralisierung.md` ist abgearbeitet und am 24.09.2026 gelöscht (Historie `5e501ae`). **Umsetzung:** Opus, ohne Mockup. **Status: erledigt 22.09.2026** — Web 20.27.0 bis 20.37.0, elf Versionsstufen, keine Migration; **gemergt 23.09.2026** (PR #74, `6e94e0a`). **Warum
...
90, 96, 99, 100. Das Protokoll lag in
`docs/konzepte/Backlog-Durchsicht-2026-09-12.md` (gelöscht 24.09.2026, Historie `5e501ae`).
...
| 57 | Tagesübersicht baut ihre Tabelle zweimal | **erledigt** mit Schritt 15 AP9b (Web 20.37.0, 22.09.2026) | **Gebaut:** `index.php` bezieht Kopf, Zeilen, Kacheln, Sortierung und Sortierblatt aus `assets/missiontable.js`; Spaltenlisten **4 → 1**, Sortierblatt-Erzeuger **3 → 1**, `tr.innerHTML` **1 → 0**. Die **Nebenbedingung `cap_gate` war keine** — sie erreichte die Tabelle nie, alle 69 Diensttage trugen die Windenspalte; daraus ist eine eigene, freigegebene Funktionsänderung geworden (E-ZE-31, Web 20.35.0). Der Rest steht in Abschnitt 8. |
| 80 | Auswertung der Gerätestatistik (Rest von 59) | **P5a** (Nachlöse-Job, E-PP-06) / **10c AP7** (Herkunft und Dashboard; die Vorbedingung gilt für die Summenzählung nicht, die User-Agent-Hälfte ist gestrichen — E-P5c-45) | Gerätemodelle und Nutzung sind **gebaut** (S8 AP4, Betrieb → Statistik). **Die Herkunft je Einsatz ist gebaut** (10c AP7, Web 20.47.0; die Vorbedingung gilt für die Summenzählung nicht, E-P5c-45). Offen bleibt nur, was der Eintrag selbst als Rest nennt; eine Momentaufnahme ist nicht bestellt. *Berichtigt mit Fassung 122 — hier stand „Offen: Herkunft je Einsatz … mit der Datenschutzerklärung als Vorbedingung".* |
...
| 198 | Die Zeitraumübersicht zählt Winde und Bergwacht nur luftgebunden | **WIRD NICHT UMGESETZT** (E-P5c-27, 20.09.2026) — vorher 10c AP9 | Aufgenommen 14.09.2026 in 9d/AP0 (F-DA-4). Seit R80 darf ein bodengebundenes Rettungsmittel vom Typ Bergwacht Fähigkeiten führen; `api/range.php` beantwortet `faehigkeiten` aber weiter über `d.kind = 'air'`, und die beiden Windenkacheln stehen nur im Luft-Kachelsatz. Ein Bergwacht-Diensttag am Boden zeigt seine Windenfelder im Formular und fehlt in der Auswertung. **Warum nicht gleich mit:** zwei Kacheln mehr im Bodensatz wären zehn Kacheln in vier Spalten — eine Gestaltungsentscheidung, die eine Freigabe mit Mockup braucht. Der Kommentar an der Abfrage sagt seither, dass die Zeile eine Lücke ist und keine Herleitung. **WIRD NICHT UMGESETZT — entschieden 20.09.2026 (E-P5c-27, in M-P5c-01).** Der Punkt ist damit geschlossen, wandert aber nicht nach *Erledigt*, weil nichts erledigt wurde. **Folge:** Die Winden-Cycles bodengebundener Bergwacht-Diensttage erscheinen in **keiner** Ansicht der Zeitraumübersicht; erfasst werden sie weiter, ausgewertet nicht. |
...
| 200 | Bounce-Postfach per IMAP (PP-7 Empfohlen) | **nicht umsetzen** (E-P5c-51, 23.09.2026; AP10 entfällt) — bleibt im Backlog unter *Offen* mit Vermerk | Aufgenommen 15.09.2026 (Konzept P5a, E-P5a-14): Die Warteschlange zählt Versuche und führt Unzustellbares; was die Gegenstelle später zurückschickt, sieht sie nicht — Umverteilt 20.09.2026 (E-P5c-21, F-P5c-3) — die Unzustellbar-Liste bekommt dort ihre Reiter. |
...
| 249 | TOTP-Reset der einzigen BetreiberIn | **Schritt 18** (der Rest) | Einschub 20.09.2026; Wiederanlauf-Fall fürs S10-Runbook. **Teilweise gelöst mit Konzept RW** (P5c/AP5b, Web 20.45.0): Wer sein Notfallblatt hat, setzt den Zweitfaktor selbst zurück. Offen bleibt der Fall ohne Blatt |
| 258 | Drei `api/`-Dateien antworten am `json_out()` vorbei | **Schritt 17** | Schritt 15; **nicht 10c** (E-P5c-46). Nachgetragen mit Fassung 108 — die Zeile fehlte (F-P5c-50) |
| 260 | Zwei `server/`-Kommentare sagen „beider FTPS-Schritte" — seit Kette II/AP5 ist es einer | **Kette II** (das Paket, das `server/` das nächste Mal anfasst) | Einschub 21.09.2026. **Bewusst nicht im selben Paket erledigt:** Die Sätze beschreiben die **ausgelieferte** Kette, und auf Produktiv stehen die zwei Schritte noch |
| 261 | Staging bewahrt zwei Komplett-Stände auf — der Hotfix-Weg braucht mehr | **Zuarbeit der Betreiberin** (Prüfpunkt 28), vor M2 | Einschub 21.09.2026 (Kette II/AP7). **Kein Code:** eine Entscheidung über Speicherplatz auf einer konkreten Anlage, nicht über das Verhalten der Kette. Gemessen: Vorgabe **2**, Vorschlag **5** |
| 262 | Atomare Auslieferung — umschalten statt überschreiben | **P8 oder Hosterwechsel** | Einschub 21.09.2026 (Kette II, Abschnitt 8); niedrig. Hängt daran, ob der Hoster Symlinks über FTPS hergibt |
| 263 | Die Integritätswache sieht nur öffentlich Abrufbares, keinen PHP-Quelltext | **offen — eigener Durchgang** | Einschub 21.09.2026 (Kette II, Abschnitt 8); niedrig. **Grenze benannt, Abhilfe offen** — sie hieße, dem Server eine Schnittstelle auf die eigenen Quelldateien zu geben, und das ist ein neuer Angriffsweg für ein halb gelöstes Problem |
...
| 287 | Karten „Was hier gilt" außerhalb von Verwaltung und Betrieb (`import.php`, `einsatz_form.php`, `wiederherstellen.php`) | **Schritt 17** | Konzept P5c Fassung 2 (E-P5c-49) |
...
| 297 | Der Bilderlauf lässt Breiten, die Admin-Rolle und Rollbehälter aus | **Backlog-Runde** (Umbau); die Messungen von 10c tragen die Nummer als Anlass | Konzept P5c (F-P5c-41); seit AP4 auch die Sicht des Supports. Nachgetragen mit Fassung 122 |
| 299 | Die Kontoseite löscht ein Konto an `konto_loeschen()` vorbei | **Backlog-Runde** | Konzept P5c (AP4, F-P5c-99). Nachgetragen mit Fassung 122 |
| 300 | Die Hauptstufe des Prüfstands fährt die Plattformmatrix nur zur Hälfte | **Prüfkette (PK-06 ff.)**; bis dahin je Paket von Hand | Konzept P5c (AP4, F-P5c-103). Nachgetragen mit Fassung 122 |
| 301 | `Sandbox-Setup.md` 1 sagt, Firefox und WebKit starten im Container nicht — sie starten | **Backlog-Runde** | Konzept RW (F-RW-02), mit RW-04 angelegt. Nachgetragen mit Fassung 122 |
...
| 321 | Der Stilvergleich meldet unveränderte Stile als ungeplant, sobald eine andere Seite Elemente dazubekommt | **Backlog-Runde** (Prüfmittel) | P5c/AP7 (F-P5c-126). Nachgetragen mit Fassung 122 |
| 322 | Welche Probe der Demo-Reset trifft, entscheidet die Reihenfolge der Muster | **Backlog-Runde** (Prüfmittel) | P5c/AP7 (F-P5c-127). Nachgetragen mit Fassung 122 |
| 323 | Referenzbestand und Demo-Fixture tragen noch Nutzlast 11 | **Backlog-Runde** (Vorschlag; im Eintrag steht keine Zuordnung) | P5c/AP8 (F-P5c-133); kein Fehler, kostet zwei Übergangsregeln im Kreislauf. Nachgetragen mit Fassung 122 |
| 324 | Der eigene Bestand kommt einmal über ein Einmal-Skript in die 1.0 | **P8** (Schnitt) | P5c/AP8 (E-P5c-127). Nachgetragen mit Fassung 122 |
| 327 | Die Rollenmatrix führt die Handlungen der BetreiberIn-Seiten nicht einzeln | **Schritt 17** (Backlog-Runde) | P5c/AP11 (F-P5c-169). Neu mit Fassung 122 |
| 329 | Der Prüfstand fährt die Quelltextprüfungen mit eingerichteter Anlage, Stufe 1 ohne | **Backlog-Runde** | P5c/AP11 (F-P5c-171). Neu mit Fassung 122 |
...
| ~~**Freigabe des Abschlusses der Mockup-Runde 9c** — danach löscht K9 das Konzept (`Konzept-Mockup-Runde.md`); das Prüfdokument bleibt, bis seine Prüfliste abgehakt ist~~ | Schritt 9c | **erteilt 24.09.2026** — Konzept gelöscht, Prüfliste abgearbeitet, Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`); der Mockup-Ordner `konzept-mockup-runde/` ebenfalls, `Design.md` nennt ihn nicht |
...
| ~~**Prüfliste Demo-Ausbau 9d** (`docs/konzepte/Pruefdokument-Demo-Ausbau.md`) und die **Freigabe des Abschlusses** — danach löscht K9 das Konzept (`Konzept-Demo-Ausbau.md`), das Prüfdokument bleibt bis zum Abhaken~~ | Schritt 9d | **erteilt 24.09.2026** — Konzept gelöscht, Prüfliste abgearbeitet, Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`) |
| ~~**Freigabe des S9-Abschlusses** — danach löscht K9 das Konzept (`Konzept-S9-Einsatzbearbeitung-Rettungsmittel.md`); das Prüfdokument bleibt, bis seine Prüfliste abgehakt ist. **Ebenfalls zu löschen:** `docs/konzepte/Bestandsaufnahme-R39-Zentrale-Stammdaten.md` erst nach P5, sie wird dort gebraucht~~ | Schritt 8 | **erteilt 24.09.2026** — Konzept gelöscht, Prüfliste abgearbeitet, Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`); die Bestandsaufnahme R39 ist mit dem Rückbau gelöscht (10c AP8, Historie in Git) |
| ~~**Prüfliste S5 (12 Punkte)**, darunter: die Bestandsuhr **einmal neu koppeln** (E-S5-42, vorher den Sync leerlaufen lassen), beide Kopplungsmails im Postfach sichten, Antwortgleichheit auf Produktiv nachmessen, die Geräteseite **ohne JavaScript**, drei Punkte nur am Gerät (Verbindungsabriss, Tastensperre, Oberfläche auf zwei Geräteklassen), **ein Update mit Wartungsmodus** und **eine Kopplung mit dem Handbuch in der Hand** (P2-Punkt 4.1)~~ | S5-Abnahme | **abgearbeitet — Stand 24.09.2026**; Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`) |
| ~~**Freigabe des S5-Abschlusses** — danach löscht R62 die beiden Konzepte (`Konzept-S5-Kopplung-umgekehrt.md`, `…-Zusatz-Wartungsmodus.md`); das Prüfdokument bleibt bis zur abgehakten Prüfliste~~ | Schritt 5 | **erteilt 24.09.2026** — alle drei S5-Konzepte und beide Prüfdokumente (Kopplung, Paket E) gelöscht (Fassung 110, Historie `5e501ae`) |
...
| ~~Prüfliste S4 (1, 2, 3, 5) am echten Diensttag~~ | Schritt 1 | **abgearbeitet — Stand 24.09.2026**; Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`) |
...
| ~~**Prüfliste des S8-Prüfdokuments abarbeiten** — Bedienwege, die keine Maschine fahren kann: die Migration auf dem Produktivserver (Rollen vorher/nachher), der Kopieren-Knopf in einem **zweiten Browser**, Mengen und Laufzeiten an echten Daten (Status, Statistik, Speichermessung), der Fall „Freigabe läuft, Zielkonto gelöscht"~~ | Schritt 7 (S8) | **abgearbeitet — Stand 24.09.2026**; Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`) |
...
| SPF/DKIM/DMARC der Versanddomain; die **Absenderadresse (`smtp.from`) als echtes Postfach**, das die Betreiberin liest — die Anwendung liest Rückläufer nicht (Nr. 200 nicht umgesetzt, E-P5c-51) | P5 | vor der P5-Abnahme |
...
| ~~F3–F6 zu PS-3~~ | S9, Nr. 103 | **beantwortet 06.09.2026** — zwei Screenshots in `docs/konzepte/vorbereitung-s9/` (Ordner gelöscht 24.09.2026, Historie `5e501ae`), alle Lagen (vor allem Desktop und Handy), keine Uhrzeiten in der Anzeige, kein zweites Merkmal, aber Trennlinie zwischen den Farben; PS-3 meint die Kartenschilder (Schritt 8) |
| Wellenplan der Öffnung | Betriebsübergang | vor der Öffnung |
| ~~**Prüfliste S7** (`docs/konzepte/Pruefdokument-S7-Backup-Begriff.md`), sechs offene Punkte. Der wichtigste ist **Nummer 4: ein Komplett-Backup aus der Zeit VOR diesem Deploy einspielen** — die Kopfzeile des Dumps ist zugleich Erkennungsmarke, und ob die Vorsorge am echten Bestand trägt, lässt sich nur dort sehen. Dazu die beiden Warnmails (SMTP), die Bedienzustände der Dialoge, der Wiederanlaufweg in einer leeren Datenbank und ein Backup-Umlauf in dasselbe Konto~~ | Schritt 4 (S7) | **abgearbeitet — Stand 24.09.2026**; Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`) |
...
| **`betrieb.health_token` in `config.php` beider Anlagen** eintragen und das eigene Monitoring auf `/api/health.php?token=…` richten (Runbook `Technik.md` 7, „Health-Endpunkt einrichten"); danach die Prüfpunkte **P-P5c-29 bis -31** (`Pruefdokument-P5c-Rollen-Sicherheit-Betriebslage.md`). Ohne Eintrag antwortet der Endpunkt jedem mit 403. **`mail.postfach` entfällt** (E-P5c-51, 23.09.2026: AP10 gestrichen) | Betreiberin, 10c AP6 | **wirksam nach dem Merge (Staging) und nach dem Tag (Produktiv)**; eintragen lässt er sich jederzeit (Einschub 20.09.2026, berichtigt mit Fassung 108 und 118) |
| ~~**Prüfliste P5b — die Punkte aus `docs/konzepte/Pruefdokument-P5b-Konto-und-Registrierung.md`**, darunter **P9.4 und P9.5** als die beiden wichtigsten: einen neuen Wiederherstellungsschlüssel erzeugen und danach **an einem Prüfkonto** über „Passwort vergessen" belegen, dass der **neue** Schlüssel die Daten öffnet und der **alte** nicht mehr. Dazu die Registrierung in allen drei Betriebsarten, das Einwilligungstor, die Selbstlöschung mit Karenz und die Betreiber-Rückfrage zum Schlüsselblatt. **Abschnitt 0 des Prüfdokuments** sagt zuerst, was auf dem Prüfstand *nicht* herzustellen war — vor allem: die Fristen der Rückfragen sind nie abgelaufen, sondern gestellt worden (Nr. 232)~~ | Schritt 10b | **abgearbeitet — Stand 24.09.2026**; Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`) |
| ~~**Freigabe des P5b-Abschlusses** — danach ist das Konzept gelöscht (K9); das **Prüfdokument bleibt**, bis seine Prüfliste abgehakt ist~~ | Schritt 10b | **erteilt 24.09.2026** — Konzept gelöscht, Prüfliste abgearbeitet, Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`) |
| ~~**Prüfliste TB — P-TB-07** (`docs/konzepte/Pruefdokument-TB-Tor-nach-Baum.md`): beim nächsten Fall zweier offener PRs „Update branch" nach dem ersten Merge sehen. **P-TB-06 erfüllt 23.09.2026** mit Web 20.37.2 (Lauf 35852217360): Schritt 7 erkennt den PR-Lauf gleichen Baums an, den Verweis-Lauf auf `main` nicht; ausgeliefert, Zeiger auf `1139ce7`~~ | Konzept TB | **abgearbeitet — Stand 24.09.2026**; Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`) |
...
| ~~**Prüfliste Korrektur 288/289 — vier Punkte** (`docs/konzepte/Pruefdokument-Korrektur-288-289.md`): nach dem Merge von **Web 20.37.3** die Anmeldeseite von Staging am Handy und am Rechner ansehen — die vier Verweise stehen **unter** der Karte, die Karte ist so breit wie sonst; die übrigen Seiten der Anmeldehülle unverändert. Die Neueinrichtung selbst ist örtlich belegt (`hochfahren.sh --neu` RC 0); auf einer echten Anlage wird sie erst beim nächsten Hosterwechsel gebraucht~~ | Nr. 288, 289 | **abgearbeitet — Stand 24.09.2026**; Prüfdokument gelöscht (Fassung 110, Historie `5e501ae`) |
| **Staging kennzeichnen: `app.umgebung` in die `config.php` von Staging** — `'app' => [ … 'umgebung' => ['name' => 'Staging', 'farbe' => 'rot'] ]` (Runbook `Technik.md` 7, „Eine Testanlage kennzeichnen"). **Nie auf Produktiv.** Danach Betrieb → Status, Zeile „Umgebung": blau „Staging". **Z7 (`mail.betreff_praefix`) ist die Voraussetzung der Warnung** „Präfix ohne Etikett" — steht der Präfix schon, zeigt Staging bis zu diesem Eintrag orange | 10c AP1 (E-P5c-05) | **nach dem Merge des 10c-PR** (vorher kennt Staging den Schlüssel nicht; er schadet aber auch nicht) |
| **Secret `STAGING_TOTP`** in der GitHub-Umgebung `staging` — das Zweitfaktor-Geheimnis des Prüfkontos, mit dem Stufe 2 sich anmeldet (E-P5c-43, -105). **In dieser Reihenfolge:** (1) Merge des 10c-PR; der erste Stufe-2-Lauf ist rot und sagt „STAGING_TOTP fehlt" — das ist die Ansage, kein Fehler. (2) Auf Staging Betrieb → Updates → `update.php`, danach die Wartung ausschalten. (3) Mit dem Prüfkonto (`STAGING_KONTO`) auf Staging anmelden; es landet im Einrichtungstor. Das **Geheimnis in Vierergruppen** abschreiben (ohne Leerzeichen ist es dasselbe), den QR-Code zusätzlich mit einer App scannen, mit deren Code einschalten, das Codeblatt verwahren. (4) Das Geheimnis als Secret `STAGING_TOTP` neben `STAGING_KONTO` und `STAGING_PASS` eintragen. (5) Den Stufe-2-Lauf neu starten — grün heißt: Der Kreislauf ist über den Code-Schritt gekommen | 10c AP5 | **nach dem Merge des 10c-PR**, vor dem ersten Tag — ohne es kommt kein Tag durch |
| **Prüfliste P5c/AP5** (`docs/konzepte/Pruefdokument-P5c-Rollen-Sicherheit-Betriebslage.md`, P-P5c-20 ff.): Einrichtung mit einer **echten Authenticator-App** (Scan und Abtippen), das Codeblatt aus Chromium **und** Firefox gedruckt (eine Seite), Anmeldung mit einem Wiederherstellungscode, Zurücksetzen durch eine zweite BetreiberIn, Station D grün mit `STAGING_TOTP` | 10c AP5 | nach Merge und `update.php` auf Staging |
| ~~**Zahl der Konten mit `pat_key_check IS NULL`** auf beiden Anlagen melden — sie bestimmt, wie viele Konten den Zweitfaktor nicht über den Wiederherstellungsschlüssel zurücksetzen können (E-P5c-42)~~ | 10c AP5 | **erledigt 24.09.2026** — Staging 0 von 4, Produktiv 1 von 2 (die BetreiberIn; nach ihrem Passwortwechsel am selben Tag 0 von 2). Dabei gefunden: Der Prüfwert beweist die Kenntnis des Schlüssels nicht (F-P5c-106) — der Rückweg kommt mit dem Einschubkonzept RW (Zeile darunter) |
| ~~**Einschubkonzept RW erstellen lassen** — der Rückweg beim Zweitfaktor über den Wiederherstellungsschlüssel, fälschungssicher über ein Schlüsselpaar (Q-P5c-38, E-P5c-104). Eigene Sitzung, abgezweigt von `claude/p5c-mockups-konzept-4yeomf`, nur neue Dateien unter `docs/konzepte/`; Auftrag in `docs/konzepte/Vorbereitung-RW-Zweitfaktor-Rueckweg.md`~~ | 10c (AP5b) | **erledigt 24.09.2026** — `Konzept-RW-Zweitfaktor-Rueckweg.md`, Zweig `claude/nice-lovelace-snlo8m`; AP5b gebaut aus RW-01 bis RW-04 (Web 20.43.0 bis 20.45.0) |
| ~~**Nach dem Merge des 10c-PR: die Demo-Fixture neu erzeugen** — das Demo-Konto sollte ein festes Paar aus der Fixture bekommen (Konzept RW, E-RW-10)~~ | 10c AP5b | **entfällt** — das Demo-Konto bekommt kein Paar (E-RW-15, Q-RW-11) |
| **Prüfpunkte P-RW-01 bis -05** (`docs/konzepte/Pruefdokument-RW-Zweitfaktor-Rueckweg.md`): Statuszeile „Rückweg-Prüfung" auf Produktiv nach dem Tag; die Rückwegprobe im ersten Stufe-2-Lauf; ein echter Rückweg mit eigenem Konto auf Staging, einmal mit falschem Zettel; die Mail im Postfach; das Demo-Konto nach dem Reset ohne Paar | 10c AP5b | nach Merge und Tag |
...
| **Prüfliste P5c/AP1** (`docs/konzepte/Pruefdokument-P5c-Rollen-Sicherheit-Betriebslage.md`, P-P5c-01 bis -04): Staging rot nach dem Merge, Produktiv blau nach dem Tag, eine Rundmail in einem echten Postfach, die Ankündigung auf dem Handy | 10c AP1 | nach Merge und Tag |
| **Prüfliste P5c/AP3 und AP4** (dasselbe Prüfdokument, P-P5c-10 bis -19): der Reiter System mit einem echten Fehler auf Staging, die Fehlerseite, das stille Fehlerprotokoll des Webspace (nur wo zugänglich); ein Support-Konto anlegen, einrichten und anmelden, seine Sicht, der Admin-Weg vor `update.php` | 10c AP3, AP4 | nach Merge und `update.php` |
| **Prüfliste P5c/AP2** (dasselbe Prüfdokument): auf Staging nach dem ersten Jobdurchlauf die Archive seit dem ältesten Eintrag unter Verwaltung → Protokoll → Archiv (hier stand bis Fassung 122 „nach sieben Tagen das erste Archiv"), Plakette „auf dem Ziel" nach dem nächsten Versand, einmal herunterladen und in die `.jsonl` schauen (keine IP-Adresse im Reiter Sicherheit) — **ob der Job ohne Cron in einer Woche drankommt**, zeigt nur die Anlage | 10c AP2 | nach dem Merge, eine Woche danach |
...
| **Prüfliste P5c/AP8** (dasselbe Prüfdokument, P-P5c-35 bis -38): **`update.php` auf Staging mit der zerstörenden Migration** — drei Migrationen, zwei davon mit Vorbedingung; ob Staging eine Zeile ohne Konto oder ein FTP-Ziel trägt, sagt erst der Lauf. Danach ein Diensttag mit „Anderem Rettungsmittel" in Luft und Boden und die Sicherungsziele ohne FTP-Plakette (P-P5c-37, eine Kontosicherung von vor dem Deploy einspielen, ist gestrichen — E-P5c-127). **Auf Produktiv nach dem Tag dasselbe `update.php`** — über 21.0.0 zurück geht es nur mit dem Rückfallstand (`Technik.md` 6.6b) | 10c AP8 | nach Merge und `update.php`, Produktiv nach dem Tag |
| **Prüfliste P5c/AP9** (dasselbe Prüfdokument, P-P5c-39 bis -44): **die eigene Datenschutzerklärung nachziehen** (P-P5c-40) — der Baustein zum Ratenschutz endet jetzt mit „… enthalten diese Angaben nicht.", der Absatz zu den verschlüsselten Daten nennt die Notizen; dazu Rechtstexte mit Vorschau in Firefox und am Handy, beide Blätter aus Firefox auf Papier, der Wartungsmodus nach einem echten Deploy (Komplett-Backup und Backup-Ziele offen) und die Leiste an einem Laptop um 850 px und über 950 px Höhe (F-P5c-164; seit 21.1.3 stehen die Sprungmarken erst ab 950 px) | 10c AP9 | P-P5c-40 sofort (betrifft die laufende Anlage), die übrigen nach Merge bzw. nach dem Tag |
| **Vorhandene Komplett-Backups auf Produktiv öffnen** (P-P5c-45, Nr. 328) — bis Web 21.1.1 ließ sich ein Komplett-Backup nicht öffnen, wenn die Zeitgrenze einer Anfrage mitten in die Versiegelung fiel. Jeden Stand unter Betrieb → Komplett-Backup einmal herunterladen und mit `gzip -t` prüfen; ein betroffener Stand ist kein Rückfallstand und wird nach dem Deploy von 21.1.2 durch ein neues Backup ersetzt | 10c AP11 | **vor dem Merge** — der Rückfallstand von AP8 soll einer sein, der sich öffnen lässt |
| ~~**`tools/stilvergleich/geplant.txt` leeren** — die Liste der geplanten Stilabweichungen gilt gegen den Vergleichsstand vor dem Merge (E-P5c-74). Die erste Instanz nach dem Merge des 10c-PR, die `style.css` berührt, bekommt ihre Zeilen sonst als „geplant, aber nicht gemessen" rot genannt. Keine Zuarbeit der Betreiberin, sondern der nächste Arbeitszweig~~ | 10c AP1 | **erledigt 26.09.2026** mit Web 21.1.3 (F-P5c-164): gegen das neue `main` neu geschrieben, die P5c-Zeilen sind fort; übrig sind die 13 Signaturen der Höhenschwelle (13 geplant, 13 gemessen, 0 ungeplant). **Der Handgriff entfällt künftig** (Nr. 330): `gegen.sh` zählt Zeilen, die wortgleich auf `main` stehen und nicht gemessen werden, nicht mehr mit |
...
| 5 | Push auf `main` — **ab hier synchronisiert die Kette** | — | ☑ **für die Auslieferung — ☐ für Stufe 2, und das ist die halbe Abnahme von Kette II/AP1.** *Stand 21.09.2026.* **Die Kette synchronisiert.** Der Merge von Kette II (Lauf 35570398032) hat `staging / ausliefern` über **alle 17 Schritte grün** gefahren, in **49 s**; drei weitere Staging-Läufe sind seither gefahren, darunter ein Wiederholungslauf mit **0 Dateien in 3,8 s** (die Zustandsdatei wird gefunden). **Stufe 2 dahinter ist rot**, und zwar am **Botschutz von lima-city**: `login.php` weist die Anmeldung des Prüfkontos mit **HTTP 403** ab („Dein Browser wird geprüft"). Das ist **keine Frage der Kette**, sondern des Hosters — er muss für die Läufer ausgesetzt werden (oder für `login.php`). **Im Werkzeug umgangen wird er nicht:** Dann prüfte Stufe 2 gegen eine Anlage, die sich anders verhält als die, die Nutzerinnen sehen. **Gemessen und nützlich zu wissen:** Der Botschutz trifft **nur den Formular-POST**; ein statischer Abruf über dieselbe Adresse kommt durch — deshalb ist die **Zielprobe** auf Staging als Prüfmittel brauchbar, solange er steht. **Ein Push auf `main` ist für einen Lauf nicht nötig** — `workflow_dispatch` fährt dieselben Jobs, und `produktion` kann dabei nicht anspringen |
...
| `FTP_STATE_PFAD` (Ort der Zustandsdatei) | **`../.deploy-state-staging.json` (gesetzt)** | **`../.deploy-state-produktion.json` (gesetzt)** |
...
> **`FTP_STATE_PFAD` STAND BIS FASSUNG 101 AUF „nicht gesetzt → Vorgabe",
> und das ist seit Kette II/AP6 in zweifacher Hinsicht falsch** (berichtigt
> am 21.09.2026). **Erstens gibt es die Vorgabe nicht mehr** (E-KH-07): Alle
> drei Werte — `FTP_ZIELPFAD`, `FTP_STATE_PFAD`, `WACHE_BASIS` — sprangen bis
> dahin auf einen fest eingebauten Wert zurück, und das ließ eine falsch
> eingerichtete Anlage nicht auffallen; heute ist eine leere Variable **rot
> im ersten Schritt**, vor jedem Zugriff auf den Server. **Zweitens ist sie
> inzwischen gesetzt**, in beiden Umgebungen — belegt durch fünf Läufe, die
> durch genau diesen Schritt gekommen sind (Prüfpunkt 24 des Prüfdokuments,
> F-KH-U-38/-39). Vorher musste man die Einrichtung aus dem Verhalten
> erraten; jetzt sagt sie der Lauf.
>
> **Die eingetragenen Werte sind keine Empfehlung, sondern der Ist-Zustand.**
> Solange die Vorgabe galt, hat die Kette genau diese Zeichenketten benutzt,
> und dort liegen die Zustandsdateien. Wer etwas anderes einträgt, sagt der
> Auslieferungsaktion, sie solle ihre Zustandsdatei woanders suchen; sie
> findet keine, hält den Server für leer und **überträgt alle 688 Dateien
> neu**. Kein Schaden, aber Minuten Wartung statt Sekunden — und auf Produktiv
> mitten in einer Auslieferung.
...
| R38 | Support-Rolle, Admin-TOTP, Audit, Dashboard im Minimalumfang | gilt, P5 **(alle Punkte) in 10c**, E-P5c-13 bis -18; der **Zweitfaktor ist mit E-P5c-15 konkretisiert**: Pflicht für Admin, BetreiberIn und Support, Angebot für alle übrigen (Nr. 141, F-P5c-1). **Ergänzt 23.09.2026 (Fassung 2 des Konzepts):** Zweitfaktor nach **E-P5c-41, -42** — QR-Code aus vendorierter Bibliothek, **zehn** Ersatzcodes unabhängig vom Serverschlüssel, „Gerät merken" erst mit Nr. 242 in **Schritt 18**; der **Bus-Faktor in Orange**, nicht Rot (E-P5c-44, -63); Fenster und Zählung des Dashboards nach **E-P5c-18** (mit AP7). **Umgesetzt mit 10c** (Web 20.38.0 bis 21.1.1, 25.09.2026; Erledigt-Zeile in Abschnitt 8). |
| R39 | Zentrale Stammdaten entfallen; Regionen-Modell verworfen | gilt, P5; Regionen als Nr. 71 festgehalten. **Zweistufig seit 09.09.2026:** In der laufenden Anlage sind alle zentralen Standorte gelöscht (Auskunft des Auftraggebers); **S9 hat die Tür geschlossen** (Web 18.0.0, AP5b: `admin_stammdaten.php` ersatzlos gestrichen, Karte „Vordefinierte Standorte“ und `ub_toggle` mit ihr — kein Schema, keine Migration), **P5 baut zurück** (Nr. 168). Bestandsaufnahme mit 208 Befunden — gelöscht mit 10c AP8, Historie in Git. **Rest in 10c AP8** (Nr. 168 und 169, E-P5c-19) — gebaut (Web 21.0.0). **Erledigt mit dem Abschluss von 10c** (25.09.2026): Jeder Stammdatensatz gehört einem Konto, `user_bases` ist fort. |
...
| R42 | Gerätekennung beim Koppeln | Uhr-Seite erledigt (1.9.0); **Speicherung erledigt (Web 12.9.0, S6)** — drei Spalten statt zwei, begründet im Changelog; Auswertung P5 (Backlog 80) **Auswertung gebaut mit 10c AP7** (Web 20.47.0: Geräteverteilung und Herkunft je Einsatz, E-P5c-18, -45). |
...
| R66 | **Update-Weg ab v1.0** (Beschluss 03.09.2026, E-PV-2; beantwortet R60): keine Selbstprüfung auf neue Fassungen, kein Selbst-Update — die Installation ändert ihren Code nie selbst, neuer Code kommt nur über die Auslieferungskette (R40, R67); **Produktion nur auf ausdrückliche Auslösung der Betreiberin, nie automatisch**, damit vorher Backups geprüft werden können; Wartungsseite zeigt nur ausstehende Migrationen mit „Ausstehende ausführen", der Torwächter liest dasselbe Register, ausgeführte Kennungen ab P5 im Audit-Protokoll; Migrationsregister beginnt bei v1.0 neu. Selbsthoster: Release-Archiv, FTP, Migrationen von Hand (Betreiberhandbuch). Fassungsprüfung auf Klick als Nr. 99 nach v1.0. Begründung E-PV-2. **Kette II hat den Gegenentwurf geprüft und verworfen** (E-KH-02): Die Installation holt sich ihren Code NICHT selbst (kein `git pull` auf dem Server) — sie bekäme damit einen Weg, ihren eigenen Code zu ändern, und genau den schließt R66 aus | gilt; Unterseite in S8 (Nr. 77), Audit in P5 — **seit Web 20.39.0 stehen die ausgeführten Kennungen im Protokoll** (Reiter Verwaltung); die Karte „Ausgeführt" auf Betrieb → Updates bleibt daneben, weil nur sie die Fassung je Kennung nennt (Q-P5c-53, 25.09.2026) —, Neubeginn des Registers in P8 |
| R67 | **Auslieferungskette** (Beschluss 03.09.2026, E-PV-3; präzisiert R40 (4)): `main` deployt automatisch auf Staging, das zugleich Prüfumgebung ist (Demo-Konto, Referenzdatensatz, Messstand-Konto); ein Release-Tag startet den Produktiv-Lauf, der in der GitHub-Umgebung „produktion" auf die **Freigabe der Betreiberin** wartet — die Produktiv-Zugangsdaten liegen nur dort; der freigegebene Lauf **stößt zuerst das Komplett-Backup an und bricht ohne Erfolg ab**, dann Deploy, Migrationen von Hand (R66); mit dem Wartungsmodus aus Paket W: Wartung an → Backup → Deploy → Migrationen → Wartung aus; **Rollback** = voriger Tag plus Wiederherstellung; **Prüftor in drei Stufen** (je Push statisch und Android-Build, rot = kein Merge; nach Staging-Deploy Kreisläufe, Bilderlauf, Messstand bei Tags, rot = nicht freigabefähig; Produktion nach Freigabe); Android in der CI unsigniert, Signatur und Play-Upload auf dem Rechner der Betreiberin (E-S4-16 bleibt), Play-API-Upload nach v1.0 (Nr. 100). Pflichtfreigaben setzen ein **öffentliches** Repositorium voraus (R68). Begründung E-PV-3. **Gehärtet mit Konzept Kette II** (E-KH-01 bis -30, 20./21.09.2026): Zielprobe und Probelauf statt Vertrauen, **eine** Schrittfolge für Staging und Produktiv, der Zeiger-Zweig `produktion` als Bezug der Integritätswache, Abbruchverhalten (Wartung bleibt an, der Lauf sagt was gilt), keine Vorgabewerte mehr, und der **Hotfix-Weg** über `hotfix/*` mit Abstammungsprüfung gegen den Zeiger | gilt; gebaut in P5 (R40 (2)), vollständig ab dem neuen Repositorium (R40 (4)). **GEHÄRTET, ABER NOCH NICHT GELAUFEN — Stand 21.09.2026:** AP1 bis AP7 gebaut, AP2 bis AP6 abgenommen, AP7 zur Hälfte. **Einen erfolgreichen Produktivlauf gibt es bis heute nicht** (M1), und den Hotfix-Weg ist noch niemand gegangen (M2). M1 ist am Botschutz des Staging-Hosters blockiert, nicht an der Kette — Stufe 2 kommt dort nicht durch, und das Tor der grünen Läufe lässt deshalb keinen Tag durch. **Wer diese Zeile zitiert, zitiert diesen Satz mit:** „gehärtet" beschreibt, was gebaut und geprüft ist, nicht, was gelaufen ist |
...
| R84 | **Kein Schritt der Auslieferungskette geht ungeprobt auf Produktiv** (Beschluss 20.09.2026, E-KH-17; dauerhafte Regel, präzisiert R67). Jeder Schritt des Produktiv-Jobs existiert im Staging-Job — seit Kette II/AP5 ist es **dieselbe Schrittfolge**, einmal geschrieben und zweimal aufgerufen; plattformabhängige Schritte probt der **Probelauf**. **Wer der Kette einen Schritt hinzufügt, sagt im selben Zug, wodurch er geprobt wird** (`CLAUDE.md` 3). Die Regel hat eine ausdrückliche Kehrseite: Einen Schritt einzubauen, den es **nur für die Prüfung** gibt, ist derselbe Fehler von der anderen Seite — er prüft eine Kette, die es im Ernstfall nicht gibt. Kette II hat aus diesem Grund einen „auf Zuruf scheiternden" Prüfschritt verworfen und stattdessen die **Lage** hergestellt, die gemeldet werden sollte (F-KH-U-37) | gilt |
| R85 | **Die Kette des Tags N spricht beim Ausliefern mit dem Server der Fassung N−1** (Beschluss 20.09.2026, E-KH-19; dauerhafte Regel). Beim Deploy läuft auf dem Server noch die **alte** Fassung — der Dialog `tools/kette/tor.py` ↔ `server/jobs.php` muss also gegen die Vorfassung funktionieren oder eine ausdrückliche Übergangsregel für genau eine Auslieferung mitbringen. **Die Selbstprobe bekommt dafür je eine Lage „alter Server"**: ein Feld, das der Server noch nicht kennt, ergibt `unbekannt` und einen Fehlschlag — **nie eine erfundene Null**. Ein Schlussschritt, der „Wartung: aus" meldet, weil er die Antwort nicht lesen konnte, schickt jemanden schlafen, während die Anlage zusteht. Präzedenzfall E-KH-03; die Lagen stehen in `tor.py` (`zustand_auskunft()`) | gilt |
...
`…-Zusatz-Wartungsmodus.md` und `…-Zusatz-Android-Ortung-Dienstende.md` —
**gelöscht am 24.09.2026** mit der Freigabe des Abschlusses (Fassung 110),
zuletzt unter `5e501ae`. Prüfdokumente
`Pruefdokument-S5-Kopplung-umgekehrt.md` und `Pruefdokument-S5-Paket-E.md`
— Prüflisten abgearbeitet, **ebenfalls gelöscht** (Historie `5e501ae`). Letzter Commit vor dem Merge: `4caf1ff`;
...
`Konzept-R64-Herkunft-Geraet.md` mit Prüfdokumenten — **blieben** nach R62,
weil der Schritt erst mit dem Gerätetest abgeschlossen ist (Abschnitt 3).
**Am 24.09.2026 gelöscht:** Konzept R64 und beide Prüfdokumente (Gerätetest
erfolgt, Freigabe mit Fassung 110, Historie `5e501ae`); Konzept S4 bleibt, weil
Teil C (Play Console, Android 1.0.0) offen ist.
...
`docs/konzepte/Pruefdokument-S7-Backup-Begriff.md` — Prüfliste
abgearbeitet, **gelöscht am 24.09.2026** (Historie `5e501ae`).
...
— Prüfliste abgearbeitet, **gelöscht am 24.09.2026** (Historie `5e501ae`); mit ihm
der Ordner `konzept-s8/ist/` (Ist-Bilder vor AP1), die Mockups bleiben.
...
freigegeben 06./07.09.2026, E-S9-01 bis -19, sieben Mockups) und Prüfdokument
— **beide gelöscht am 24.09.2026** mit der Freigabe des Abschlusses (Fassung
110, Historie `5e501ae`), dazu die Problemsammlung
`Vorbereitung-S9-Problemsammlung.md` mit ihren Screenshots; die Mockups
bleiben unter `konzept-s9/mockups/`, weil `Design.md` sie als Herkunft nennt. **Acht Arbeitspakete plus zwei Nachträge (AP4a, AP5b)**, je ein
...
`docs/konzepte/Pruefdokument-Sofortpaket-Sicherheit.md` (Prüfliste
abgearbeitet, gelöscht am 24.09.2026, Historie `5e501ae`). **Web, elf Punkte in
...
nach K1, je Punkt ein Commit; Zweig `claude/backlog-runde-2`. Prüfdokument
`Pruefdokument-Backlog-Runde-2.md` — abgearbeitet, gelöscht am 24.09.2026
(Historie `5e501ae`).
...
bis F-MR-14 beantwortet — **Konzept, Prüfdokument und Mockup-Ordner
`konzept-mockup-runde/` gelöscht am 24.09.2026** mit der Freigabe des
Abschlusses (Fassung 110, Historie `5e501ae`); Zweig `claude/jolly-planck-vexxpd`, je Paket ein
...
Arbeitspakete in drei Blöcken; Konzept und Prüfdokument gelöscht am
24.09.2026, Historie `5e501ae`) — neun Punkte in einer Stufe sind zu viele, um
...
und die Prüfliste des Prüfdokuments (abgearbeitet; `Pruefdokument-S10-Sicherheit.md` gelöscht am 24.09.2026, Historie `5e501ae`). **Nr. 139 ist erledigt**; Nr. 140 bleibt
...
(Fable, 15.09.2026, E-DA-01 bis E-DA-32; Konzept und Prüfdokument gelöscht
am 24.09.2026 mit der Freigabe des Abschlusses, Historie `5e501ae`); Zweig
...
*Reste:* **Backlog Nr. 198** — **wird nicht umgesetzt** (E-P5c-27, 20.09.2026); der Punkt ist geschlossen, nicht erledigt. Er lautete: die Zeitraumübersicht zählt Winde und Bergwacht
...
### Zentralisierung — eine Stelle je Sache · Web 20.27.0 bis 20.37.0 · 20.–22.09.2026 (Schritt 15, R83)

**Fünf Wege haben jetzt genau einen Eingang, und ein Register zählt es nach.**
Konzept `Konzept-Zentralisierung.md` (Fable, 20.09.2026, E-ZE-01 bis -35,
F-ZE-1 bis -6, AP1–AP10, kein Fable-Schritt, kein Mockup) — **mit dem
Abschluss gelöscht**, die Git-Historie behält es; das Prüfdokument
`Pruefdokument-Zentralisierung.md` — Prüfliste abgearbeitet, **gelöscht am
24.09.2026** (Historie `5e501ae`). Umsetzung Opus in **zehn Arbeitspaketen** auf
`claude/eager-euler-jlfi9i`. **Elf Versionsstufen**, keine davon Haupt,
**keine Migration** — `update.php` ist nach dem Merge **nicht** fällig.

**Was jetzt an einer Stelle steht** (die Tabelle dazu in `CLAUDE.md` 4 und
`docs/Technik.md` 4.98a): Konfiguration über `konfig()` statt `$CFG`
(Z04 **46 → 0**) · Sitzung über `sitzung_starten()` (Z01 **9 → 1**) ·
Schemafragen über `db_hat_tabelle()`/`db_hat_spalte()`/`db_hat_index()`
(Z14 **9 → 5**) · Transaktionen über `db_transaktion()` (Z16 **33 → 9**,
Z17 **30 → 0**) · die Spalten von `missions` über `mf_spalten($zweck)`
(Z18 **12 → 3**) · Zahlen und Zeitpunkte über `format_lib.php` und
`EdFormat` (Z19/Z21/Z27 je **→ 0**, Z26 **67 → 3**) · Anfragen an den
Server über `EdApi` (Z28 **15 → 1**) · Meldungen über `EdHtml.meldung()`
(Z37 **8 → 4**) · Karten über `EdKarte.anlegen()` (Z35 **4 → 0**) · und
**eine** Einsatztabelle statt zweier Erzeuger (Nr. 57; Spaltenlisten
**4 → 1**, Sortierblatt-Erzeuger **3 → 1**, `tr.innerHTML` **1 → 0**).

**Das Register ist der eigentliche Ertrag.** `tools/zaehlung/register.php`
führt je Sache **eine** Zeile mit einer Decke; der Stufe-1-Schritt
„Zentralisierung — hält jede Sache ihre eine Stelle?" schlägt an, sobald
eine Zeile darüber steigt, und ist **einmal absichtlich rot gesehen worden**
(eine Wegwerfdatei mit einer zweiten `L.map(`-Präambel: zwei Zeilen über der
Decke, Rückgabewert 1). **38 Zeilen, 0 über der Decke.** Vier Decken enden
begründet über null (E-ZE-27 bis -30) — „ehrliche Zahl statt runder Null",
so entschieden.

**Drei Funktionsänderungen, alle einzeln freigegeben** (E-ZE-31 bis -35):
Winde und Bergwacht folgen in Tages- und Zeitraumübersicht der
**Betriebsart und der Fähigkeit**, in der Einsatzbearbeitung der Fähigkeit
allein, in der Suche der Fähigkeit über Luft **und** Boden — `cap_gate`
stand seit Web 5.10.0 im Katalog und erreichte die Tabelle nie (alle 69
Diensttage trugen die Windenspalte). Die **Suchfilter** folgen ebenfalls der
Fähigkeit: In einem Bestand mit eingerichteter, aber nie benutzter Winde
fehlte der ganze Block „Bergrettung", und damit war „Winde: nein" nicht zu
suchen. Und die Tagesübersicht bekommt mit dem gemeinsamen Erzeuger den
Kopf „Sekundärtransport" als ein Wort, das Alter rechtsbündig und die Haken
in der Reihenfolge des Moduls.

**Vier Fehler kamen dabei ans Licht, drei davon Jahre alt:** Das
Einsatztabellen-Modul sortierte „Beginn" über die **Zeichenkette** und
stellte bei einem Dienst über Mitternacht 01:10 vor 23:50 · das mobile
Sortierblatt von Suche und Zeitraumübersicht stellte um, **ohne neu zu
zeichnen** (unter 720 px ist es der einzige Weg zu sortieren) · dasselbe
Blatt zeigte `Sekundär&shy;transport` als rohe Entität · und `api.js` stand
einen Nachmittag lang in der falschen Ladeliste, was die KDF-Anhebung auf
zwei Seiten wortlos abgestellt hätte (von einem Gegenleser mit
Zeilennummern widerlegt, bevor es auslieferungsreif war).

**Prüfzahlen des Abschlusses:** Register **38 Zeilen / 0 über der Decke**,
Selbstprobe **34/34** · `php -l` **137/0** · Wortliste **0/0/0** ·
Vollständigkeit **396** · CSP **0** · Kettenaufrufe **47/0/0** ·
Formvergleich der berührten Seiten: nach Abzug der zeitabhängigen Zeilen und
des einen beabsichtigten Kopfwechsels **0 von 56** abweichend · Bilderlauf
**0 Überlauf, 0 Konsolenfehler, 0 falsche Knopfhöhen** · Kreisläufe,
Ingest-, Kopplungs-, Komplett-, Spur-, Job-, Raten- und
Wiederherstellungsprobe je **Zahl für Zahl wie vor dem Schritt**.

**Übergabe an 10c:** Die Andockstellen stehen jetzt in
`Konzept-P5c-Rollen-Sicherheit-Betriebslage.md`, Abschnitt „Andockstellen
aus Schritt 15" — gegen den gebauten Stand nachgezogen. Die Übergabezahl für
den Log-Helfer ist **`error_log(` = 75**, nicht 77 (E-ZE-05: Schritt 15 hat
keinen einzigen umgestellt; die zwei sind mit ihrem Code umgezogen bzw. in
`app_state_*()` zusammengelaufen).
...
### Sitzungsablage — die Anwendung legt ihre Sitzungen selbst ab · Web 20.26.0 · 20.09.2026 (Schritt 16, R81)

**Nachgetragen mit Fassung 110.** Der Schritt war gebaut, geprüft und
gemergt, hatte aber keine Erledigt-Zeile — nur die Fahrplanzeile 16 und
Abschnitt 10 nannten ihn. Konzept `Konzept-Sitzungsablage.md` (Fable,
20.09.2026, E-SA-01 bis -09, ein Paket, kein Fable-Schritt) und Prüfdokument
`Pruefdokument-Sitzungsablage.md` — **beide gelöscht am 24.09.2026** mit der
Freigabe des Abschlusses, zuletzt unter `5e501ae`. Umsetzung Opus auf
`claude/new-session-cbq57h`, gemergt als PR #61 (`1822d38`) und PR #62 (fünf
berichtigte Sätze, die den Löschabgleich des Transports zu stark beschrieben
hatten). **Eine Versionsstufe** (Neben), **keine Migration**.

**Was gebaut ist.** `server/sitzung_lib.php` legt `.sitzungen/` mit `0700`
an, gerufen aus `db.php` und `install.php`; scheitert das, fällt die
Anwendung auf den Hosterpfad zurück **und zeigt es an**. Dazu ein vierter
Schreibort und der dreiwertige Prüfpunkt „Sitzungsablage" in
`plattform_pruefen()`, der Aufräumteil „Sitzungsdateien" (nur `sess_*`) und
der **achte Schutzlistenpfad** der Auslieferung (E-SA-05, E-KH-20 —
eingetragen mit Kette II/AP3). Backlog **Nr. 241** erledigt; **Nr. 242**
(Sitzungsbindung per Cookie-Token) benannt und nach Schritt 18 vertagt.

### RP — die roten Proben der Nebenstufe · nur Werkzeug · 23.09.2026 (Backlog Nr. 292)

**Nachgetragen mit Fassung 110** — das Paket stand nur in Abschnitt 10
(Fassung 107). Konzept `Konzept-RP-Rote-Proben.md` (Opus, 23.09.2026,
E-RP-01 bis -06, RP-01 bis RP-05; Korrekturpaket aus Konzept PK, E-PK-45)
und Prüfdokument `Pruefdokument-RP-Rote-Proben.md` (P-RP-01 bis -11) —
**beide gelöscht am 24.09.2026**, zuletzt unter `5e501ae`. Zweig
`claude/rp-rote-proben`, gemergt als **PR #83** (`f4fe4a0`). **Keine
Versionsstufe** — nur `tools/` und `docs/`.

**Was sich geändert hat.** Neun von 36 Proben der Nebenstufe waren rot,
keine davon ein Fehler der Anwendung: vier nicht verdrahtet (Versand ohne
Gegenstellen, Freigabe am Konto eines Kreislaufs, Wegprobe ohne Konto, GPX
mit falschem Pfad), vier mit veralteten Erwartungen (Spur/Aufzeichnung,
Hausform, P5b-Mails, `frame-ancestors`) samt einer csv-Referenz von vor der
Hausform, eine mit zu wenigen Konten (Wiederherstellung); die Kreisläufe
liefen im Prüfstand nur einmal (`--frisch` fehlte). **Ergebnis:** Nebenstufe
auf frischer Anlage **36 grün, 0 rot, 0 nicht gemessen, 1 239 s**;
`proben.sh alle` **20 von 20**. Das Ziel der Nebenstufe ist damit rund
21 Minuten (E-RP-05). Einzelheiten in Fassung 107.

### TB — das Produktionstor vergleicht Baum statt Commit · nur Werkzeug · 23.09.2026 (Backlog Nr. 285)

**Ein Tag wartet nicht mehr auf eine zweite Messung desselben Inhalts, und
der Merge auf `main` misst ihn nicht noch einmal.** Konzept
`Konzept-TB-Tor-nach-Baum.md` (Fable, 23.09.2026, E-TB-01 bis -12, F-TB-01
bis -12, TB-M1 und TB-01 bis TB-05, kein Fable-Schritt) — **mit dem
Abschluss gelöscht**, die Git-Historie behält es (letzter Stand `a72c7df`);
das Prüfdokument — P-TB-06 und P-TB-07 abgehakt — ist am 24.09.2026
**gelöscht** (Historie `5e501ae`). Umsetzung
Opus auf `claude/serene-goldberg-wnn60k`, gemergt als **PR #77**
(`eefffca`). **Keine Versionsstufe** — nur `tools/`, `.github/` und `docs/`.

**Was sich geändert hat.** `tools/kette/freigabe.py` zählt einen grünen
`pruefung.yml`-Lauf, wenn sein Commit denselben **Baum** hat wie der
Tag-Commit **und** der Job `Stufe 1` darin grün war (Selbstprobe **32 → 52**
Lagen); Schritt 7 des Auslieferungslaufs holt dafür die jüngsten 50 Läufe,
ihre Bäume und bei Treffern die Jobs. Vor `Stufe 1` steht der Job
**`Schon gemessen?`**: auf einem PR immer „messen", beim Push auf `main` ein
Verweis auf den PR-Lauf gleichen Baums. Die Betreiberin hat „Require
branches to be up to date" in „Main Protect" gesetzt (TB-M1) — das macht
den gleichen Baum beweisbar.

**Belegt an echten Läufen:** P-TB-03 (PR-Lauf 35840201595: `messen=ja`,
`Stufe 1` grün) und **P-TB-05** (Lauf 35844072753 auf `main`: „Baum
`c440740` bereits gemessen: Lauf 35842387963", `Stufe 1` übersprungen,
**18 s statt rund 41 min**). Offen: P-TB-06 (der erste Tag ohne Warten) und
P-TB-07 (Abschnitt 6).

**Nebenbei gefunden und behoben:** der Gesundheitscheck der MySQL-Schemaprobe
meldete den temporären Einrichtungsserver als gesund (F-TB-12) — jetzt über
TCP. **Auf demselben Zweig:** der Uhr-Prüfstand holt Gerätedateien und
...
### P5c — Rollen, Sicherheit, Betriebslage · Web 20.38.0 bis 21.1.2 · 23.–25.09.2026 (Schritt 10c, R82, R38)

**Was R38 bestellt hatte, steht — und die Einstellungen sagen weniger und
das Handbuch mehr.** Konzept `Konzept-P5c-Rollen-Sicherheit-Betriebslage.md`
(Fassung 1 Fable 20.09.2026, Fassung 2 23.09.2026; E-P5c-01 bis -134,
Q-P5c-01 bis -55, F-P5c-01 bis -172; AP1–AP9 und AP11, AP10 entfallen) mit
dem Einschubkonzept `Konzept-RW-Zweitfaktor-Rueckweg.md` als AP5b (E-RW-01
bis -18, RW-01 bis -04) — **beide mit dem Abschluss gelöscht**, samt den
Vorbereitungen und den Mockup-Ordnern `konzept-p5c/` und `konzept-rw/`
(Q-P5c-54); **letzter Stand `ae829e6`**. Die Prüfdokumente P5c und RW
**bleiben**, bis ihre Prüflisten abgehakt sind. Umsetzung Opus auf
`claude/p5c-mockups-konzept-4yeomf`, **gemergt: PR #89, `29cf394`, 26.09.2026**; der Tag
durch die Betreiberin. **Mit Migrationen** (AP4, AP5, AP5b, AP7, AP8 — AP8
zerstörend mit Vorbedingung): nach dem Merge `update.php`, die Wartung
bleibt bis dahin an.

**Was sich geändert hat.** **AP1** (20.38.0) Staging sieht nicht mehr aus
wie Produktiv — Etikett aus `app.umgebung`, rote Kopfleiste, Streifen —,
dazu eine Ankündigung mit Rundmail. **AP2** (20.39.0) das Protokoll unter
Verwaltung → Protokoll mit Reitern, Suche, Kennungssuche und einem
versiegelten Archiv, das auf das Backup-Ziel geht; Komplett-Backup und
Backup-Ziele nur für die BetreiberIn (Nr. 286). **AP3** (20.40.0) der
Reiter System statt `error_log()` (75 → 2 Aufrufe, Nr. 248). **AP4**
(20.41.0) die vierte Rolle Support, Tor je Handlung, Berechtigungsmatrix als
Vorgabe der Rollenprobe. **AP5** (20.42.0) der Zweitfaktor (TOTP) — Pflicht
für Support, Admin und BetreiberIn, Angebot für alle — mit Code-Schritt vor
der Sitzung, zehn Wiederherstellungscodes, Codeblatt und Bus-Faktor im
Status (Nr. 141). **AP5b** (20.43.0–20.45.0) der Rückweg über den
Wiederherstellungsschlüssel, fälschungssicher über ein ECDSA-Paar je Konto
(F-P5c-106 geschlossen; Nr. 249 zum Teil). **AP6** (20.46.0) der
Health-Endpunkt. **AP7** (20.47.0) die Statistik mit drei Reitern nach R38,
Herkunft je Einsatz (R42, Nr. 80, 190–192). **AP8** (**21.0.0**,
Hauptstufe) der Rückbau von R39: jeder Stammdatensatz gehört einem Konto,
FTP als Zielart fällt, das Tagesrettungsmittel trägt die Rollen seiner Art
(Nr. 168, 169). **AP9** (21.1.0) die Ein-Satz-Regel für Verwaltung und
Betrieb, Karten „Was hier gilt" ins Handbuch, Leiste und Übersicht nach
M-P5c-01, Druckblätter, Rechtstexte als eigene Seite mit Vorschau
(Nr. 121, 244–246, 253, 269). **AP11** (21.1.1, 21.1.2) die Gegenlesung der
Phase — und ein Fehler, den erst der letzte Prüfstand zeigte.

**Nebenbei gefunden und behoben:** **Ein Datenbankfehler schaltete den
Zweitfaktor stumm** — `login.php` meldete dann ohne Code-Schritt an
(F-P5c-166, gefunden von der Gegenlesung, nicht von einem Test; die
Rückwegprobe hatte das Verhalten sogar festgeschrieben). **Ein
Komplett-Backup, über zwei Häppchen versiegelt, ließ sich nie mehr öffnen**
(Nr. 328, F-P5c-170, 21.1.2) — `ftell()` im Anhängemodus zählt ab null;
gefunden vom letzten Prüfstand des Abschlusses, dessen Dump zufällig über
zwei Häppchen lief. Ob ein vorhandener Stand auf Produktiv betroffen ist,
sagt erst P-P5c-45. `doku_lib.php` lud `db.php`, ohne es zu brauchen,
und die Ankerprüfung lief damit in Stufe 1 ohne `config.php` in den
Abbruch — im Prüfstand grün, im Tor rot (F-P5c-171); und das Tor übergab
`anker` nicht an die Gegenlesung (F-P5c-172). Die Lücke dahinter ist
Nr. 329. Die GPX-Probe
verglich auf frischer Anlage nichts (Nr. 325). Die Wartungsprobe verglich
einen Einzelwert im Millisekundenbereich (F-P5c-165). Die Plattformmatrix
der Hauptstufe fährt nur zur Hälfte (F-P5c-103, Nr. 300) — benannt, nicht
gebaut.

**Prüfzahlen des Abschlusses:** Gegenlesung der Phase mit zehn lesenden
Agenten — **222 Soll-Punkte, 112 Befunde**, alle behoben oder benannt;
Rollenmatrix **70 von 70** Zeilen gegen den Code. Rollenprobe **304 / 0**,
Zweitfaktorprobe **47 / 0**, Rückwegprobe **50 / 0** und **23 / 0**
(Chromium; Firefox und WebKit von Hand je 23 / 0), Wartungsprobe
**69 / 0**, Komplettprobe **69 / 0** (gegen die Bibliothek von 21.1.1
**2 offen**), Kreislauf `edbak-alt` **287 853 / 0 unerklärt**. Prüfstand
Stufe `haupt` auf frischer Anlage: AP11 Teil 1 **50 grün, 0 rot, 2 362 s**
(`f747bf7`), der Abschluss im Bericht seines Commits. **Offen**
(Abschnitt 6): die Prüflisten P-P5c-01 bis -45 und P-RW-01 bis -05,
`update.php`, `STAGING_TOTP`, `app.umgebung` auf Staging, der Health-Token,
`geplant.txt` leeren und die eigene Datenschutzerklärung (P-P5c-40).
...
16.09.2026, E-P5b-01 bis -25, AP1–AP10; **gelöscht am 24.09.2026** mit der
Freigabe des Abschlusses, K9, Historie `5e501ae`),
...
**Prüfdokument** ist abgearbeitet und am 24.09.2026 **gelöscht** (Historie `5e501ae`).
...
`docs/konzepte/Pruefdokument-P5a-Kette-und-Fundament.md` — abgearbeitet,
gelöscht am 24.09.2026 (Historie `5e501ae`). **Zehn davon (P1–P8, P12, P33) betreffen die Kette selbst und
...
- **Rahmenplan schreiben — an vier Anlässen, sonst nicht** (Konzept SD,
  E-SD-15): (1) ein Schritt beginnt oder endet, (2) eine
  Programmentscheidung fällt, (3) die Reihenfolge ändert sich, (4) eine
  Zuarbeit entsteht oder ist erledigt. Arbeitspakete, Befunde, Messungen
  und Abnahmen stehen im Statusblock des Konzepts und im Prüfdokument.
  **Eine Berichtigung ist eine Verlaufszeile, nie ein Absatz im Text.** Bis
  zum Schnitt ändert sich am Kopf nur die Fassungsnummer und der Absatz
  „Stand". Der volle Wortlaut steht in `CLAUDE.md` 2, Punkt 5.
...
| Fassung | Datum | Was |
|---|---|---|
| **124** | **26.09.2026** | **PR #90 ist gemergt** (`77f5ac8`, 26.09.2026) — Web 21.1.3, die Höhenschwelle der Sprungmarken (F-P5c-164). Abschnitt 6: Der Handgriff „`geplant.txt` leeren" **entfällt künftig** — der Stilvergleich zählt Zeilen, die wortgleich auf `main` stehen und nicht gemessen werden, nicht mehr mit (Nr. 330, auf Nachfrage der Betreiberin; nur Werkzeug). Die Zeile sagte bis hier „Nach dem Merge dieses Pull Requests gilt dasselbe wieder". |
| **123** | **26.09.2026** | **PR #89 ist gemergt** (`29cf394`, 26.09.2026, Kopf `6456d7f`) — Reihenfolge (Abschnitt 3), Fahrplanzeile 10c und Erledigt-Zeile P5c tragen den Merge statt „Pull Request offen"; der Tag steht aus. **F-P5c-164 entschieden** (Betreiberin, 26.09.2026): Die Sprungmarken der festen Leiste stehen erst ab 950 statt ab 800 px Fensterhöhe; gebaut als Web 21.1.3 in einem eigenen Pull Request. Abschnitt 6: die Zeile Prüfliste P5c/AP9 nennt die neuen Höhen; `geplant.txt` leeren ist erledigt (gegen das neue `main` neu geschrieben, 13 Signaturen der Höhenschwelle). |
| **122** | **25.09.2026** | **Schritt 10c (P5c) ist abgeschlossen** — Freigabe des Abschlusses am 25.09.2026. Erledigt-Zeile in Abschnitt 8; Fahrplanzeile 10c auf „erledigt, Pull Request offen", die Reihenfolge in Abschnitt 3 beginnt mit ihm als abgeschlossen; Konzept P5c, Konzept RW, beide Vorbereitungen und beide Mockup-Ordner **gelöscht** (letzter Stand `ae829e6`, Q-P5c-54). Abschnitt 5: **14 erledigte Zeilen ausgetragen** (121, 141, 168, 169, 190, 191, 192, 211, 244, 245, 246, 248, 253, 269), **neun offene aus P5c nachgetragen** (297, 299, 300, 301, 321, 322, 323, 324 und neu 327); die Zeilen 80, 202 und 249 nach dem gebauten Stand. **Weiter fehlen in Abschnitt 5 zwanzig offene Punkte anderer Schritte** (250–252, 259, 265, 266, 270–277, 280, 281, 283, 284, 294, 295) und Nr. 57 steht dort erledigt — gezählt in F-P5c-134, nicht Sache von 10c; SD schneidet die Tabelle ohnehin. Abschnitt 6: Prüfliste P5c/AP1 nennt vier Punkte statt drei, neu eine Zeile für AP3 und AP4. Register: R38 und R39 erledigt, R42 „Auswertung gebaut", R66 mit Q-P5c-53. **Berichtigt:** die Planungstabelle „Wo das alles liegt" (Abschnitt 3, Vorgabe aus S8) nannte für Audit, Fehlerprotokoll und Health „Betrieb → Status", für das Admin-TOTP eine Karte „Sicherheit" und für Rechtstexte und Ankündigung die Installation — gebaut ist es anders, die Zellen sagen es jetzt; die Prüfliste P5c/AP2 sagte „nach sieben Tagen das erste Archiv", es beginnt aber beim ältesten Eintrag; Zeile 80 widersprach sich selbst (Offen: Herkunft … mit Vorbedingung — gebaut und ohne, E-P5c-45). **Nachgetragen, noch vor dem Commit des Abschlusses:** Der letzte Prüfstand fand Nr. 328 (ein über zwei Häppchen versiegeltes Komplett-Backup ließ sich nicht öffnen, F-P5c-170); behoben mit Web 21.1.2 — die Erledigt-Zeile reicht deshalb bis 21.1.2, und Abschnitt 6 hat eine Zeile mehr (P-P5c-45: vorhandene Stände auf Produktiv öffnen, vor dem Merge). Die ersten zwei Läufe von Stufe 1 auf dem Pull Request fanden F-P5c-171 (`doku_lib.php` lud `db.php`) und F-P5c-172 (`anker` fehlte in der Übergabe an die Gegenlesung); dazu Nr. 329 in Abschnitt 5. |
| **121** | **25.09.2026** | Abschnitt 6: neu die Zuarbeit **Prüfliste P5c/AP9** (P-P5c-39 bis -44). Anlass: P5c/AP9 (Web 21.1.0, ohne Migration) — darin eine, die die laufende Anlage betrifft: Zwei Bausteine für die Datenschutzerklärung haben sich geändert (P-P5c-40). Abschnitt 5: 121, 244, 245, 246, 253, 269 „gebaut", wie 168 und 169. Die Verlaufszeilen 119 und 120 standen vertauscht (119 über 120) und sind neu geordnet. |
| **120** | **25.09.2026** | Abschnitt 6: neu die Zuarbeit **Prüfliste P5c/AP8** (P-P5c-35 bis -38). Anlass: P5c/AP8 (Web 21.0.0, Hauptstufe, zerstörende Migration mit Vorbedingung). **Berichtigt**, weil AP8 sie falsch gemacht hätte: Abschnitt 5 zu Nr. 168 und 169 („gebaut", wie bei Nr. 141), Abschnitt 6 die Entscheidung zu Nr. 169 (stand noch auf „vertagt, bis dahin gilt (c)" — seit E-P5c-47 am 23.09. falsch) und die Freigabe S9, Schritt 10 und R39 im Register: Sie zeigten auf die Bestandsaufnahme R39, die AP8 löscht. Den Status „erledigt" von R39 setzt AP11. |
...
| **115** | **24.09.2026** | Abschnitt 6: Die Zuarbeit „`pat_key_check IS NULL` zählen" ist erledigt (Staging 0 von 4, Produktiv nach dem Passwortwechsel der BetreiberIn 0 von 2). Neu die Zuarbeit **Einschubkonzept RW**: Der Rückweg beim Zweitfaktor über den Wiederherstellungsschlüssel, wie E-P5c-42 ihn vorsah, prüfte gegen einen Wert, den jeder Datenbankabzug enthält (F-P5c-106); die Betreiberin hat die fälschungssichere Fassung gewählt (Q-P5c-38), sie entsteht in einer eigenen Sitzung, und P5c/AP5 baut ohne sie (E-P5c-104). |
...
| **113** | **24.09.2026** | **P5c/AP5 ist gebaut (Web 20.42.0, mit Migration): der Zweitfaktor.** Abschnitt 6: **Die Zuarbeit `STAGING_TOTP` stand falsch — „vor dem Merge des 10c-PR" geht nicht.** Das Geheimnis entsteht erst, wenn Staging die Fassung mit dem Zweitfaktor fährt und das Prüfkonto dort das Einrichtungstor durchläuft; vorher gibt es nichts einzutragen. Die Zeile nennt jetzt die Reihenfolge nach dem Merge, und der erste Stufe-2-Lauf danach ist rot mit Ansage (E-P5c-105, Konzept P5c). Neu die **Prüfliste P5c/AP5** (echte App, Codeblatt aus zwei Browsern, Wiederherstellungscode, Zurücksetzen, Station D). Abschnitt 5: Nr. 141 gebaut, **Nr. 211 wandert von Schritt 17 nach 10c** und ist erledigt; Backlog Nr. 298 erledigt, Vermerk an Nr. 247. |
...
| **111** | **24.09.2026** | SD-00: Schreibregeln für den Rahmenplan in `CLAUDE.md` 2 und Abschnitt 9 (E-SD-15), Fahrplanzeile SD, Backlog Nr. 294 (293 hat Konzept BR); die Statuszelle von 10c nennt nur noch Zweig und Konzept, nicht mehr den Paketstand. Konzept SD liegt in `docs/konzepte/`. |
| **110** | **24.09.2026** | **Konzeptablage aufgeräumt: 36 Dokumente und drei Ordner gelöscht, zwei Erledigt-Zeilen nachgetragen.** Anlass: Durchsicht der Konzeptablage im Auftrag der Betreiberin, die dabei erklärt hat, dass **alle Prüflisten bis zur aktuellen Fassung abgearbeitet** sind, und die **Freigabe des Abschlusses** für S5, S9, Mockup-Runde 9c, Backlog-Runde 3, Demo-Ausbau 9d, P5b, R64, Schritt 16 und RP erteilt hat. Gelöscht nach K9/R62: **22 Prüfdokumente** (Backlog-Runde 2 und 3, Demo-Ausbau, Korrektur 148/149, Korrektur 288/289, Mockup-Runde, P5a, P5b, R64, RP, S10, S4, S5-Kopplung, S5-Paket-E, S7, S8, S9, Sitzungsablage, Sofortpaket Sicherheit, TB, Zentralisierung, uhr_gesperrt), **elf Konzepte** (drei zu S5, S9, Mockup-Runde, Backlog-Runde 3, Demo-Ausbau, P5b, R64, Sitzungsablage, RP), **drei Vorbereitungen und Protokolle** (Vorbereitung S5, Problemsammlung S9, Backlog-Durchsicht vom 12.09.2026) sowie die Ordner `vorbereitung-s9/`, `konzept-s8/ist/` und `konzept-mockup-runde/`. Letzter Stand aller gelöschten Dateien: `5e501ae`. **Es bleiben:** die laufenden Konzepte P5c, PK und Kette II mit Prüfdokumenten; die Quellen späterer Schritte (Planung v1.0 bis P8, V1-Ortsdaten für S11, Krypto-Review und Sicherheitspaket für P6, Plattformprofil, P5c-Protokollierung, Play-Console und Konzept S4 für Schritt 6 Teil C, Bestandsaufnahme R39 für Nr. 168); die Mockup-Ordner S8, S9 und P5b (`Design.md` und P5c nennen sie als Herkunft); `erledigt/` als Archiv nach R62. **Zwei Phasen hatten keine Erledigt-Zeile** — Schritt 16 (Sitzungsablage) und RP standen nur in Abschnitt 10; beide sind in Abschnitt 8 nachgetragen. Abschnitt 6: die abgearbeiteten Prüflisten und erteilten Freigaben durchgestrichen; Abschnitt 5: Nr. 238 (Prüfung erfolgt) herausgenommen und im Backlog nach *Erledigt* verschoben, Selbstprüfzahl **94** (nach dem Merge von P5c/AP2, das Nr. 286 herausnimmt). **Nicht angefasst, mit Absicht:** die Nennungen gelöschter Dateien in CHANGELOG, `version.php`, `wartung_lib.php`, im Archiv, in der Planung v1.0 und in den Erledigt-Zeilen dieses Dokuments — sie beschreiben, was damals war (Muster: Fassung 63). Die Verweise sind **von Hand** nachgezogen, nicht per Probe — Nr. 188 hat damit seinen zweiten Fall. Nur `docs/`, keine Versionsstufe. |
| **109** | **24.09.2026** | **P5c/AP2 ist gebaut (Web 20.39.0): Das Protokoll lässt sich lesen, und es hat ein versiegeltes Archiv.** Verwaltung → Protokoll mit sieben Reitern nach Rolle — die BetreiberIn alle und das Archiv, der Admin vier; vier Reiter lesen die Tabellen, die ihre Sache ohnehin führen, **je Quelle eine Abfrage und nie ein UNION** (Kollationen auf dem Hoster). Der Job `protokoll_archiv` legt alle 7 Tage einen Zeitraum versiegelt nach `sicherungen/protokoll/`, in Häppchen, **ohne IP-Adressen**; die Verwaltung geht mit Adressen hinein (**E-P5c-75**, entschieden am 24.09.2026), das erste Archiv beginnt beim ältesten Eintrag (**E-P5c-76**). **Nr. 286 erledigt:** Komplett-Backup und Backup-Ziele fragen `require_betreiberin()`; die neue **Rollenprobe** liest die Berechtigungsmatrix aus `Technik.md` 4.99p und fährt sie — die Tabelle ist damit Vorgabe, nicht Beschreibung. Das Komplett-Backup nimmt `sicherheit_ereignisse` und `rate_limits` ohne Zeilen auf. Neue Bausteine: Reiter (`Design.md` 9.37), aufklappbare Zeile, Listenkopf und -fuß; `zip_lib.php` als eine Stelle für ZIP. **Eine Gestaltungsentscheidung beim Bauen:** Der Strich des aktiven Reiters steht in `--orange-tief` statt im `--orange` des Mockups — auf Rauch hätte Orange 2,09 : 1 (entschieden 24.09.2026). Keine Migration. Abschnitt 5: 286 heraus. Abschnitt 6: Prüfliste AP2 neu; die Zeile V1–V9 ist bis auf die juristische Bestätigung der Frist erledigt. Prüfzahlen: Rollenprobe **87 / 0**, Protokollprobe **21 / 0**, Versandprobe **141 / 0** (neu Teil 13: Archive auf dem Ziel, keine Regel), Komplettprobe **67 / 0**, Wiederherstellung **111 / 0**, Bilderlauf **520 Bilder aus 65 Seiten, 0/0/0/0**, Bedienprobe **52 von 52**, Register **40 Zeilen, 0 über der Decke**, Schemaprobe **4 × 19 / 0**; der Prüfstand steht im Commit `P5c-AP2`. **Eine Lehre aus dem Vorlauf** (F-P5c-86): Die Schemaprobe tauscht für ihre Laufzeit `config.php` — wer sie neben dem Prüfstand startet, bringt den Torwächter dazu, die Anlage zu schließen. **Und ein Befund an der Prüfkette** (F-P5c-88): Die Schemaprobe war im Prüfstand seit PK-03 nie messbar — ihr Eintrag stand ohne Zugangsdaten; jetzt `plattform.sh schema` |
| **108** | **23.09.2026** | **10c läuft: P5c/AP1 ist gebaut (Web 20.38.0), und mit ihm die Buchführung aus den Einschüben 7 und 8 des Konzepts** (F-P5c-50). **Gebaut:** das Umgebungsetikett aus `config.php` (Titelvorsatz, rote Kopfleiste, Streifen; nie abgeleitet), die Zeile „Umgebung" auf der Statusseite in beiden Richtungen, die Ankündigung über jeder Seite — auch über der Anmeldung —, je Sitzung wegklickbar, und die Rundmail an die erreichbaren Konten, höchstens eine je Tag. `mail_einreihen()` kann nur einreihen (F-P5c-29). Keine Migration. **Steuerungsrelevant:** Der Fahrplan nennt jetzt „10c (läuft) → 17 → 18 → …" mit PK-06 bis -08 daneben; die Sätze „M1 ist blockiert" (M1 ist seit dem 21.09.2026 erreicht) und Schritt 15 „Merge offen" (PR #74) sind berichtigt und als überholt stehen gelassen. R38 um E-P5c-41, -42, -44, -18 ergänzt; **R74 (5) umgeschrieben** (höchstens ein Satz je Karte, „Was hier gilt" entfällt — E-P5c-06, -49); R78 (4): der QR-Code ist entschieden. Abschnitt 5: 80, 190, 191 → AP7; 168, 169 → AP8; 141 → AP5; 200 nicht umsetzen; 233 → Schritt 18; **neu eingetragen** 253, 258, 269, 286, 287 (fehlten); **243 erledigt** und herausgenommen. Abschnitt 6: `app.umgebung` auf Staging, `STAGING_TOTP` vor dem Merge des 10c-PR, `pat_key_check IS NULL` vor AP5, `update.php` nach dem Merge, **bis dahin kein Konto mit der Rolle admin** (E-P5c-31); `mail.postfach` entfällt. **Ein Fund beim Bauen, der die Prüfwerkzeuge betraf:** 24 Stellen in 20 Dateien meldeten sich an, indem sie „den ersten Absendeknopf der Seite" klickten — mit einer Ankündigung ist das ihr Kreuz. Auf Staging hätte eine gesetzte Ankündigung Stufe 2 rot gemacht; sie zielen jetzt auf `#loginform`. Prüfzahlen: Mailprobe **50 / 0** (neu: Rundmail N/N, zweite abgewiesen, ein Protokolleintrag), Bedienwege `betrieb_server` **2 von 2**, Kontraste **25 Paare, 0 verfehlt**, Register **38 Zeilen, 0 über der Decke**, Quelltext **8 von 8**. Backlog: 243 erledigt; 80, 141, 168, 169, 190, 192, 198, 200, 244, 247, 248, 253, 269 nach Einschub 8 berichtigt; nächste freie Nummer **293** |
...
| **105** | **23.09.2026** | **Korrekturstufe Web 20.37.3 — Backlog Nr. 288 und 289**, beide gefunden beim Bau der Mockup-Runde M-P5c-02 (Konzept P5c). **Nr. 288:** Von Web 20.30.0 bis 20.37.2 ließ sich keine neue Anlage einrichten — `konto_anlegen()` rief `db_transaktion()` aus `db.php`, das der Einrichter ohne `config.php` nicht laden kann; der Rahmen steht jetzt in `transaktion_lib.php`. **Nr. 289:** die Verweise der Anmeldeseite unter statt neben der Karte. Keine Migration. Neu im Backlog: **Nr. 290** (keine Stufe der Kette richtet eine Anlage ein) und **Nr. 291** (halbes Schema nach einem Fehlschlag). Prüfliste in Abschnitt 6. Auf dem Arbeitszweig des Konzepts P5c gebaut, weil beide dort gefunden wurden. |
| **104** | **23.09.2026** | **Konzept TB ist gebaut, gemergt (PR #77) und abgeschlossen.** Erledigt-Zeile in Abschnitt 8, Prüfliste TB (P-TB-06, P-TB-07) in Abschnitt 6, Konzept gelöscht (letzter Stand `a72c7df`), Prüfdokument bleibt. Rahmenplan 6b trägt seit TB-04 den richtigen Namen des Rulesets („Main Protect") und die Zeile „up to date". P-TB-05 an Lauf 35844072753 belegt; der Test-Tag `web-v20.37.1-test` (Lauf 35844281706) belegt P-TB-06 nicht, weil er an der Tag-Prüfung einen Schritt vor dem Tor endet. |
| **103** | **22.09.2026** | **Schritt 15 ist gebaut — zehn Arbeitspakete, elf Versionsstufen, keine Migration.** Erledigt-Zeile in Abschnitt 8, Fahrplanzeile 15 auf „erledigt“, **Merge nach `main` offen**. **Das Konzept ist gelöscht** (K9, `CLAUDE.md` 7); die Git-Historie behält es, das Prüfdokument bleibt, bis seine Prüfliste abgehakt ist. **Vorher herausgeholt, was andere noch brauchen:** Die Andockstellen für 10c stehen jetzt im P5c-Konzept selbst, Abschnitt „Andockstellen aus Schritt 15“, **gegen den gebauten Stand nachgezogen** — ein Konzept zu löschen, dessen Tabelle ein anderes Konzept als Quelle nennt, hätte 10c die Zusagen genommen, auf denen sein Zuschnitt beruht. **Was Schritt 15 gebracht hat, steht in Abschnitt 8**; hier nur die steuerungsrelevanten Punkte: **Drei Funktionsänderungen, jede einzeln freigegeben** (E-ZE-31 bis -35) — Winde und Bergwacht folgen in den Übersichten der Betriebsart UND der Fähigkeit, in der Einsatzbearbeitung der Fähigkeit allein, in der Suche der Fähigkeit über Luft und Boden. `cap_gate` stand seit Web 5.10.0 im Feldkatalog und erreichte die Tabelle nie: **alle 69 Diensttage des Referenzbestands trugen die Windenspalte**, auch ein NEF ohne Winde. Gefunden haben das vier lesende Agenten unabhängig voneinander, und es hat die Prämisse des geplanten Pakets widerlegt — der erste Prüffall konnte gar nicht fehlschlagen. **Backlog Nr. 198 ist damit anders entschieden als am 20.09.2026:** Der Artfilter in `api/range.php` war dort als Lücke gemeldet und ist jetzt die Regel; die vorgeschlagene Bedingung `d.kind = 'air' OR d.vehicle_typ = 'bergwacht'` wird **nicht** umgesetzt. Der Preis steht beim Eintrag: Die Haken bodengebundener Bergwacht-Diensttage erscheinen in keiner der beiden Übersichtstabellen; erfasst und in der Einsatzbearbeitung sichtbar bleiben sie. **Backlog Nr. 57 ist erledigt** und nach *Erledigt* verschoben. **Neu: Nr. 275** — der Referenzdatensatz kennt **keinen Dienst über Mitternacht** (0 von 20 Diensttagen), und genau daran hing ein jahrealter Sortierfehler, den kein Prüfmittel finden konnte, weil es nichts zu messen gab. Belegt wurde er mit einem **gebauten** Nachtdienst; ob die drei Endpunkte den neuen Schlüssel `start_sort` für einen **echten** rechnen, ist gelesen und nicht gefahren. Zehn Nachteinsätze im Demo-Konto schließen die Lücke. **Vier Fehler kamen beim Bauen ans Licht, drei davon Jahre alt** (Sortierung über die Zeichenkette, Sortierblatt ohne Neuzeichnen, rohe `&shy;`-Entität, `api.js` in der falschen Ladeliste). Der letzte ist von einem Gegenleser **mit Zeilennummern** widerlegt worden, bevor er auslieferungsreif war — er hätte die KDF-Anhebung auf zwei Seiten wortlos abgestellt. **Und eine eigene Zwischenfassung hat der Bildvergleich abgefangen:** „Datumsspalte nur bei mehreren Tagen“ nahm der Zeitraumübersicht die Spalte, sobald alle Treffer eines Monats auf einen Tag fielen — während sie weiter nach ihr sortierte. Die Lehre steht im Prüfdokument: Eine Seite, die eine Spalte nicht will, sagt es; das Modul rät es nicht. Prüfzahlen: Register **38 Zeilen / 0 über der Decke** (einmal absichtlich rot gesehen), `php -l` **137/0**, Wortliste **0/0/0**, Vollständigkeit **396**, CSP **0**, Kettenaufrufe **47/0/0**, Formvergleich der berührten Seiten **0 von 56** unerklärt. **Übergabezahl an 10c: `error_log(` = 75**, nicht 77 (E-ZE-05). **Nur `docs/`** — keine Versionsstufe |
| **102** | **21.09.2026** | **Kette II ist gemergt, AP5 bis AP7 sind gebaut — und dieser Rahmenplan hat es einen halben Tag lang nicht gewusst.** AP8a ist die Buchführung dazu. **Zwei Sätze waren falsch, und beide an tragender Stelle:** Der Kopf sagte „Solange Kette II nicht gemergt ist, liegen die Steuerungsdokumente auf dem Zweig" — der Merge lief am selben Morgen (PR #65, `fb614d1`); wer das las, holte Rahmenplan und Backlog vom falschen Ort. Und die Kette-II-Zeile in Abschnitt 3 endete auf „Offen: die Freigabe der Betreiberin, danach AP5 bis AP8" — AP5 und AP6 sind seither abgenommen, AP7 gebaut. **Das ist derselbe Fehler wie in den Fassungen 39, 41, 42 und 80**, und die Regel daraus steht jetzt beim berichtigten Absatz: Ein Satz über den Zustand eines Merges veraltet in dem Augenblick, in dem der Merge geschieht — wer ihn schreibt, trägt ihn in die Aufgabenliste des Pakets ein, das den Merge macht. **Eine Zahl in Abschnitt 6a war in zweifacher Hinsicht falsch:** `FTP_STATE_PFAD` stand auf „nicht gesetzt → Vorgabe". Die Vorgabe gibt es seit AP6 nicht mehr (E-KH-07, leer ist rot im ersten Schritt), und die Variable ist inzwischen gesetzt — belegt durch fünf Läufe, die durch genau diesen Schritt gekommen sind. **Neu im Register: R84** (kein Schritt der Kette geht ungeprobt auf Produktiv, E-KH-17 — samt der Kehrseite, dass ein Schritt, den es nur für die Prüfung gibt, derselbe Fehler von der anderen Seite ist) und **R85** (die Kette des Tags N spricht mit dem Server der Fassung N−1, E-KH-19 — nie eine erfundene Null). **R67 trägt den Kette-II-Zusatz, aber abgeschwächt:** „gehärtet" beschreibt, was gebaut und geprüft ist, **nicht, was gelaufen ist** — einen erfolgreichen Produktivlauf gibt es bis heute nicht. **Und das ist die steuerungsrelevante Nachricht dieser Fassung: M1 ist blockiert, und nicht an einem Arbeitspaket.** Stufe 2 kommt am Botschutz von lima-city nicht durch (HTTP 403 auf `login.php`), das Tor der grünen Läufe lässt deshalb keinen Tag durch — **und weil Schritt 15 „nach Kette II (bis M1)" als Voraussetzung trägt, hängt die ganze Reihe dahinter an einer Hoster-Frage.** Zwei Wege stehen im Fahrplan, beide gehören der Betreiberin. Umgangen wird der Botschutz nicht: Dann prüfte Stufe 2 gegen eine Anlage, die sich anders verhält als die, die Nutzerinnen sehen. **Backlog:** Nr. **262** (atomare Auslieferung), **263** (die Wache sieht keinen PHP-Quelltext — Grenze benannt, Abhilfe offen) und **264** (die Fremd-Aktion ablösen), dazu ein Nachtrag an **Nr. 234**: Die Grundsatzfrage „soll die Kette den Wartungsmodus erzwingen?" ist mit AP6 beantwortet — ja —, der Punkt selbst bleibt offen, weil weiterhin kein Prüfmittel den Weg einer frisch ausgelieferten Anlage fährt. **Kein Code** — nur `docs/`, keine Versionsstufe (E-KH-23). **Was diese Fassung NICHT tut:** die Erledigt-Zeile für Kette II schreiben. Die gehört nach M1, M2 und AP8b; ein Konzept, dessen Meilensteine offen sind, ist nicht abgeschlossen |
| **101** | **21.09.2026** | **AP4 ist abgenommen — zweimal grün, 0 geplante Löschungen, und beim zweiten Lauf fasst der Schritt die Zustandsdatei nicht an.** Kette II, Läufe 35547147256 und 35547171397 (Probelauf gegen Produktiv, wie die ersetzte Abnahme aus Fassung 96 es verlangt). **Lauf 1:** `Making changes to 688 files/folders`, **`Uploading: 9.74 MB -- Deleting: 0 B -- Replacing: 0 B`**, `🎉 Sync complete`; der Schritt legt die Zustandsdatei an (4 s). **Lauf 2:** dieselben Zahlen, und der Schritt meldet **„Vorhanden. Es wird nichts angelegt und nichts angefasst — sie trägt den Bestand des Servers"** (2 s). Der Job `zeiger` blieb beide Male übersprungen, der Zeiger steht unverändert. **Die zweite Zeile ist die wichtigere:** Dass der Schritt anlegt, wenn die Datei fehlt, stand in der Selbstprobe; dass er sie **in Ruhe lässt**, wenn sie da ist, konnte nur ein zweiter Lauf gegen den echten Server zeigen — und daran hängt alles, denn eine überschriebene Zustandsdatei hieße „der Server ist leer" und wäre bei der nächsten echten Auslieferung eine Voll-Übertragung statt der Änderungen. **`Deleting: 0 B`** ist die Bedingung, die E-KH-20 für jeden Transportwechsel verlangt; sie gilt hier unverändert, weil der Transport unverändert ist. **Die Zahl 688 ist kein Befund:** Die Datei sagt `data: []`, also kündigt die Aktion an, alles zu übertragen — für einen Erstlauf richtig und in E-KH-26 angekündigt; beim ersten echten Lauf acht Minuten statt Sekunden, danach schreibt sie den wirklichen Bestand fort. **E-KH-09 ist erfüllt, AP4 ist abgenommen.** Offen bleibt **allein die Freigabe der Betreiberin** vor dem ersten echten Auslieferungslauf; danach AP5 bis AP8, der Merge nach `main` und M1. Prüfmittel: Syntax 48/0, zustand 28, Zielprobe 93, Tor 19, Wache 38, Kettenaufrufe 36/0/0, Wortliste 0/0/0. **Nur `docs/`** — keine Versionsstufe (E-KH-23) |
| **100** | **20.09.2026** | **Der Probelauf schreibt jetzt eine Datei auf Produktiv — und die Zusage „er schreibt nichts" wird dafür präzisiert statt umgangen.** Kette II/AP4, **E-KH-26**, entschieden vom Auftraggeber nach Vorlage der Abwägung. Seit der Beleg gefahren ist (Fassung 99), läuft der Schritt „Zustandsdatei bereitstellen" vor **jedem** Abgleich, auch im Probelauf; dort legt er `../.deploy-state-produktion.json` an, eine Ebene über dem Webroot. **Warum er dort laufen muss:** Fehlt die Zustandsdatei, läuft auch der **Trockenlauf** in den toten Client — er merkt es nur nicht, weil danach kein Steuerbefehl mehr kommt. Die Zeile „0 geplante Löschungen", auf der die Abnahme von AP4 beruht, käme dann aus dem **Fehlerpfad** statt aus einem Vergleich mit dem Serverbestand. **Eine Abnahme, die ihre Zahl aus dem Fehlerpfad liest, prüft nichts.** **Die Alternative ist geprüft und verworfen:** im Probelauf nur melden (`--trocken`) hätte die Zusage wörtlich erhalten und die Abnahme entwertet — eine Zusage, die formal stimmt und die Messung wertlos macht, ist schlechter als eine präzisierte Zusage. **Was die Datei anrichtet, offen gesagt:** wenige hundert Byte, `data: []`, außerhalb des Webroots und nicht öffentlich abrufbar; die Aktion schreibt sie beim ersten echten Lauf ohnehin selbst fort. Der eine Nebeneffekt: Solange sie `data: []` sagt, hält die Aktion den Server für leer, und der erste echte Lauf überträgt alle 688 Dateien statt nur der Änderungen — für einen Erstlauf richtig, acht Minuten statt Sekunden, kein Schaden. **`docs/Technik.md` 6.5a ist nachgezogen** (Zusage und Probelauf-Tabelle), **und neu ist 6.5b**: Warum die Zustandsdatei da sein muss, mit dem FTP-Dialog im Wortlaut, der Erklärung, warum die Meldung drei Schritte hinter der Ursache steht, und was zu tun ist, wenn F3 wiederkommt. **Der Grund für 6.5b ist eine Regel, keine Laune:** Nach `CLAUDE.md` 7 wird das Konzept nach dem Abschluss **gelöscht** — was dauerhaft gelten soll, muss in `Technik.md` stehen, nicht nur dort. **Nachgeprüft und ohne Befund:** Die Zustandsdatei liegt **außerhalb** des Abgleichbereichs (der Abgleich kann sie nicht löschen), und lokal fängt `.gitignore` sie mit `.deploy-state-*.json` ab. Prüfmittel: Syntax 48/0, zustand 28, Zielprobe 93, Tor 19, Wache 38, Kettenaufrufe 36/0/0, Wortliste 0/0/0, YAML 3 von 3. **Nur `docs/` und `.github/`** — keine Versionsstufe (E-KH-23) |
| **99** | **20.09.2026** | **F3 ist behoben, und der Beleg ist gefahren — der erste vollständige FTPS-Abgleich gegen den Produktivserver, den es je gegeben hat.** Kette II/AP4, Lauf 35545737872: `🎉 Sync complete`, **688 Dateien, 62 Verzeichnisse, 9,7 MB, 7 Minuten 47, kein `ECONNRESET`** — gefahren gegen das Probeverzeichnis `.zielprobe-gespraech/`, also **ohne einen Finger an der laufenden Anlage**: kein Wartungsmodus, kein halber Stand, die Anwendung hat nichts gemerkt. Am Ende schreibt die Aktion ihre Zustandsdatei selbst fort — **der selbsterhaltende Zustand ist durchbrochen**. **Die Ursache, zur Erinnerung** (Fassung 95): Die Aktion sendet `RETR` auf ihre Zustandsdatei; fehlt die, steht der Datenkanal per `EPSV` schon, der Server schließt ihn, `basic-ftp` liest `ECONNRESET` auf dem Datensocket — und die Aktion deutet das als „first publish" und arbeitet mit einem **toten Client** weiter, bis das erste `MKD` es bemerkt. Drei Schritte hinter der Ursache, und genau deshalb stand `ensureDir` acht Trennversuche lang im Verdacht. **Die Abhilfe war der kleinste Eingriff, den es gibt:** eine Datei, die vorher fehlte. Kein `lftp`, keine neue Fassung der Aktion, kein zweites FTP-Konto, keine Bitte an den Hoster — Transport, Aktion und Löschverhalten unverändert. **Der Schritt ist seit dem Beleg scharf gestellt**, also vor jedem Abgleich statt nur im Gesprächslauf; er fasst eine **vorhandene** Zustandsdatei nie an und legt nur an, was fehlt. Dass beide Schritte auf dieselbe Stelle zeigen, ist über **drei Fälle nachgerechnet — 0 Abweichungen**; ein Pfad, der hier anders stünde als dort, legte die Datei dorthin, wo die Aktion sie nicht sucht, und meldete trotzdem Erfolg. **Zwei Fehlanläufe davor lagen am Werkzeug und nicht am Befund**, und beide sind seither durch eine Prüfung abgedeckt, die es vorher nicht gab: die **Punktdatei-Falle** (`NLST` zeigt Punktdateien nicht — das Werkzeug hätte auf Produktiv **immer** „fehlt" gemeldet und eine vorhandene Datei überschrieben; gefunden hat es die eigene Nachmessung) und ein **deutsches Anführungszeichen** in einer Python-Zeile, das die Datei unübersetzbar machte — dagegen übersetzt Stufe 1 seit heute **jedes** Python-Werkzeug (**48 Werkzeuge, 0 Syntaxfehler**). Der zweite Fehler ist ein Verstoß gegen `CLAUDE.md` 6 gewesen („Die Prüfmittel laufen zuletzt") und hat einen Lauf gekostet; der Riegel ersetzt jetzt die Disziplin. **E-KH-09 ist erfüllt** — Ursache benannt, belegt, behoben, Beleg gefahren. **Offen:** die Abnahme von AP4 (Probelauf **zweimal hintereinander**, **0 geplante Löschungen**, dann Freigabe der Betreiberin) und **Prüfpunkt 20** — das Probeverzeichnis trägt jetzt 9,7 MB und ist **rekursiv** zu entfernen. Prüfmittel: zustand **28 Lagen**, Zielprobe 93, Tor 19, Wache 38, Kettenaufrufe 36/0/0, Syntax 48/0, Wortliste 0/0/0. **Nur `tools/`, `docs/` und `.github/`** — keine Versionsstufe (E-KH-23) |
| **98** | **20.09.2026** | **Die Mockup-Runde M-P5c-01 ist gefahren und freigegeben — 10c hat in der Umsetzung keinen Fable-Schritt mehr.** Zweiter Einschub der Konzeptinstanz am selben Tag. **23 Mockups** nach `docs/konzepte/konzept-p5c/mockups/` (Protokoll, Statistik, Einstellungen-Übersicht, Rechtstext-Vorschau, Schlüssel- und Notfallblatt — je als HTML, PNG und bei den Druckseiten als PDF, jeweils breit und am Handy); das P5c-Konzept durch die Fassung aus der Anlage ersetzt, jetzt **E-P5c-01 bis -30**. **Vor dem Ersetzen geprüft, wie beauftragt:** Auf dem Zweig war an der Datei **genau eine** Änderung — der AP3-Korrektursatz aus dem Schritt-15-Auftrag —, und die neue Fassung trägt ihn im Wortlaut. Kein Anhalten nötig. Die Mockups sind gegengelesen: **keine fremde Quelle zur Laufzeit** (CLAUDE.md 4), der einzige äußere Verweis zeigt auf die eigene Anlage. **Vier Backlog-Zeilen berichtigt.** **Nr. 198 wird NICHT umgesetzt** (E-P5c-27) — der Punkt ist damit geschlossen und wandert trotzdem nicht nach *Erledigt*, weil nichts erledigt wurde; die Folge steht jetzt ausdrücklich dabei, im Backlog wie im Rahmenplan: **Die Winden-Cycles bodengebundener Bergwacht-Diensttage erscheinen in keiner Ansicht der Zeitraumübersicht.** Erfasst werden sie weiter — das Einsatzformular zeigt die Felder —, ausgewertet nicht. **Nr. 192** erledigt sich mit **10c AP7**: eine Zählung ab Beginn des Einsatzes (E-P5c-18), damit stehen nicht länger zwei Zählweisen nebeneinander. **Nr. 244** berichtigt — gemeint war vor allem das **linke Menü** (`ui_leiste_einstellungen()`) und nicht die Übersicht; entschieden sind Leiste mit Bereichsüberschriften **Option 1 „Linie"** und Übersicht mit **Bereichskarten** (E-P5c-29), der Fable-Schritt ist erledigt. **Nr. 246** berichtigt — oben steht **Bildmarke + Kurzname der Installation** (`instanz_kurz()`) statt eines festen „NAdoku", das auf einer umbenannten Installation falsch wäre, und die **Webversion in der Fußzeile** (E-P5c-08/-30, freigegeben am Bild M-P5c-01f). **Nr. 248 blieb unangetastet** — die ändert der Schritt-15-Auftrag (Fassung 97). Dazu der Satz beim **Demo-Ausbau** angeglichen, wo Nr. 198 als Rest geführt wurde. Prüfschritte: **Backlog „keine Nummer zweimal" 0 doppelte bei 249 Nummernzeilen**, Wortliste 0/0/0, Kettenaufrufe 36/0/0, 23 Mockups gezählt, **443 Tabellenzeilen auf gleiche Spaltenzahl geprüft — 0 Abweichungen**. **Beim Gegenlesen drei eigene Widersprüche gefunden und behoben**, alle in Zeilen, die dieselben zwei Einschübe angefasst hatten, und alle von derselben Art — **ein Zusatz ersetzt keine Angabe, er widerspricht ihr**: Abschnitt 5 führte Nr. 198 in der Spalte „gehört zu" weiter als **10c AP9**, während der Text daneben „wird nicht umgesetzt" sagte; die Fahrplanzeile 10c nannte das Aufräumen der Einstellungen weiter „eine Mockup-Runde als Fable-Schritt" und zählte **Nr. 198** dazu; und ihre Konzeptspalte trug noch „E-P5c-01 bis **-24** … ein Fable-Schritt M-P5c-01", während der Zusatz daneben das Gegenteil sagte. **Nur `docs/`** — keine Versionsstufe |
| **97** | **20.09.2026** | **Schritt 15 hat ein freigegebenes Konzept — und aus sechs Paketen sind zehn Arbeitspakete geworden.** Eingespielt im Auftrag der Konzeptinstanz: `docs/konzepte/Konzept-Zentralisierung.md` (Fable, 20.09.2026, E-ZE-01 bis -24, F-ZE-1 bis -6, AP1–AP10, **kein Fable-Schritt**), unverändert eingecheckt. **Fahrplanzeile 15** neu gefasst: Paket 1 aus Nr. 202 ist **durch** (AP1 fährt nur die Gegenprobe), Paket 6 bleibt **Beifang**, dazu **Nr. 57** und der Konfigurationsleser; **ohne** den Log-Helfer (77 Aufrufe in 32 Dateien → 10c AP3) und **ohne** Umbau gelaufener Migrationen. Voraussetzung ist jetzt „Kette II bis M1; **Schritt 16 gemergt — erfüllt** (PR #61/#62)". **Schritt-15-Block** in Abschnitt 3: Die Zahlen von 16.09.2026 gelten nicht mehr — maßgeblich ist Abschnitt 1 des Konzepts (nachgemessen an `862ca7f`); der alte Befund bleibt als Protokoll stehen, weil die **Sachen** dieselben sind und nur Zahlen und Zuschnitt es nicht sind. Dazu die AP-Folge samt Begründung (AP1 zuerst — ohne Zählmittel keine Abnahme in Zahlen; AP2 vor allem anderen in `server/`, weil Schritt 16 und 10c daran andocken; AP4 vor AP5/AP6, AP8 vor AP9, AP6 vor AP9; AP10 zuletzt). **Eine Ausnahme von „alles wird angegangen", als Satz im Block und NICHT als Programmentscheidung** (E-ZE-04): Die 57 Schemaabfragen gelaufener Migrationen werden nicht umgebaut — eine gelaufene Migration umzuschreiben hieße, eine Anlage anders zu behandeln als die, auf der sie schon lief; P8 löst es an der Wurzel (R66), bis dahin eine **Decke von 57** im Zählmittel. **R83 bleibt unverändert, kein neues R.** **Fahrplanzeile 10c** ergänzt: Andockstellen in `Konzept-Zentralisierung.md` Abschnitt 6, und **AP3 baut kein Zählmittel** (E-ZE-03). **Backlog:** Spanne **250–259 für Schritt 15** reserviert, mit Zuordnungstabelle wie bei 241–249 — vier vergeben (**250** Umleiten nach POST → Schritt 17, **251** `secure`-Attribut der Sitzung → Schritt 18, **252** Schemaabfragen gelaufener Migrationen → P8, **253** Datum-Zeit-Trenner → 10c AP9), **254–259 frei als Reserve für Funde der Umsetzung**. Keiner der vier gehört in Schritt 15 selbst, und das ist kein Versehen: Schritt 15 verschiebt Code an eine Stelle; was dabei auffällt, aber etwas **anderes** ändert, wird notiert und nicht mitgemacht. Nachträge an **Nr. 202** (Zahlen von 16.09. ausgetragen, Zuordnungstabelle je Paket), **Nr. 57** (Schritt 15 AP9, dazu E-ZE-01 Gleichstände und F-ZE-6 Spaltensatz je Seite), **Nr. 248** (das Zählmittel **besteht** seit Schritt 15 AP1, 10c AP3 setzt nur die Decke — zwei Pakete, die dasselbe Werkzeug bauen, hätten es zweimal gebaut) und **Nr. 210** (`db_transaktion()` aus AP5 fasst `ingest.php` nicht an). **Zwei Korrektursätze in Nachbarkonzepten:** im P5c-Konzept derselbe Zählmittel-Satz; im Konzept Sitzungsablage die Angabe „nur wenn ein Cookie da ist" — **falsch, und selbst nachgemessen** an `main` `fd99989`: Die Bedingung in `doku_seite.php`, `rechtstext_seite.php` und `notfallblatt.php` ist `session_status() === PHP_SESSION_NONE`, ein `$_COOKIE`-Test kommt in **keiner** der drei Dateien vor (0 Treffer). Die Cookie-Bedingung kommt erst mit Schritt 15 AP2 (F-ZE-2); bis dahin legt **jeder anonyme Abruf** von Handbuch, Rechtstext oder Notfallblatt eine Sitzungsdatei an — auch die Messschritte und der Bilderlauf von Stufe 2. Prüfschritte: **Backlog „keine Nummer zweimal" 0 doppelte bei 249 Nummernzeilen** (wortgleich der Schritt aus Stufe 1), Wortliste 0/0/0, Kettenaufrufe 36/0/0. **Nur `docs/`** — keine Versionsstufe |
| **96** | **20.09.2026** | **AP4 gebaut — die Abhilfe gegen F3 ist der kleinste Eingriff, den es gibt, und sie beweist sich gegen ein Probeverzeichnis, bevor sie Produktiv anfasst.** Kette II/AP4. **Der Befund aus Fassung 95 passt auf keine der vier Richtungen, die das Konzept vorsah:** (a) `lftp` zielte auf die geforderte Sitzungswiederverwendung — die ist ausgeschlossen; (b) entfällt; (c) verworfen; (d) Konto/Pfad trifft nicht zu. Gebaut ist deshalb **Richtung (e)**, die das Konzept nicht kannte: `tools/kette/zustand.py` prüft, ob die Zustandsdatei der Auslieferungsaktion auf dem Server liegt, und legt sie an, wenn sie fehlt. **Transport, Aktion und Löschverhalten bleiben unverändert** — nach der Wahlregel des Konzepts („kleinster Eingriff ist vorzuziehen") geht das vor. **Drei Vorsichten, jede mit Grund:** Eine **vorhandene** Datei wird nie angefasst (sie trägt den Bestand des Servers; sie zu überschreiben hieße, der Aktion zu sagen, er sei leer — beim nächsten Lauf wären das 688 Dateien). Geprüft wird durch **Auflisten**, nicht durch Abrufen: Ein `RETR` auf eine fehlende Datei ist genau die Operation, die den Fehler auslöst, und eine Prüfung, die ihn auslöst, um ihn zu vermeiden, wäre ein Witz. Und „nicht feststellbar" heißt nicht feststellbar — lässt sich das Verzeichnis nicht auflisten, wird nichts angelegt und der Lauf ist rot. Nach dem Hochladen wird **nachgemessen**: Ein `curl` mit Rückgabe 0 sagt, dass es gesendet hat, nicht dass die Datei liegt. **Der Schritt läuft vorerst NUR im Gesprächslauf**, gegen `.zielprobe-gespraech/` — die Abhilfe ist gefunden, aber nicht bewiesen, und der Beweis (**Prüfpunkt 21**) fällt ohne einen Finger an der laufenden Anlage. Erst wenn der Abgleich dort durchläuft, wird der Schritt für die echte Auslieferung scharf gestellt; vorher wäre es ein Eingriff auf Verdacht. **Die Abnahme des Konzepts wird ersetzt:** Die Köderprobe („7 von 7") prüft die Schutzliste von `lftp` und ist bei (e) gegenstandslos, weil der Transport unverändert bleibt; es bleiben der **zweimalige** Probelauf mit **0 geplanten Löschungen** und die Freigabe der Betreiberin vor dem ersten echten Lauf. **Preis von Prüfpunkt 21, und er ist diesmal nicht null:** Läuft der Abgleich durch, liegen rund 9,7 MB in 62 Verzeichnissen im Probeverzeichnis; Prüfpunkt 20 wird dadurch größer (rekursiv löschen statt ein leeres Verzeichnis entfernen). Prüfmittel: Wortliste 0/0/0, Kettenaufrufe **36**/0/0 (34 → 36, die neuen Aufrufe gegen die Schnittstelle gehalten), Selbstproben zustand **20**, Zielprobe 93, Tor 19, Wache 38, YAML 3 von 3, `bash -n` 19 Blöcke 0 Fehler. **Nur `tools/`, `docs/` und `.github/`** — keine Versionsstufe (E-KH-23) |
| **95** | **20.09.2026** | **F3 ist gefunden — und der Fehler liegt drei Schritte vor der Stelle, die er meldet.** Kette II/AP3, Prüfpunkt 18a, Lauf 35543081419: Der Gesprächslauf hat die Auslieferungsaktion echt schreiben lassen, aber in ein gesperrtes Probeverzeichnis, und dabei ihren FTP-Dialog mitgeschrieben. Er zeigt: `MKD`/`CWD` ins Zielverzeichnis gelingen (257, 250), `EPSV` gelingt (229), dann **`> RETR .deploy-state-….json` — und keine Serverantwort, direkt `> QUIT`.** Die Datenverbindung steht per `EPSV` schon, als der Server merkt, dass die Datei fehlt; er schließt sie, `basic-ftp` liest `ECONNRESET` auf dem **Datensocket** statt der `550` auf dem Steuerkanal. **Die Aktion fängt das ab und deutet es als „first publish"** — und arbeitet mit einem **toten Client** weiter. Erst beim ersten `MKD api` fällt es auf, und genau diese Zeile stand seit dem 19.09.2026 im Verdacht. **Die Aktion kennt das Problem in ihrem eigenen Quelltext:** `deploy.js` Z. 50–51 („basic-ftp doesn't seam to close the connection when using steams over some ftps connections. This appears to be dependent on the ftp server"), `utilities.js` Z. 67 („Connection closed. This library does not currently handle reconnects"). **Warum acht Trennversuche daran vorbeigelaufen sind, und das ist kein Pech:** `curl` hat in jedem einzelnen nur Dateien abgerufen, die es zuvor selbst hochgeladen hatte — Zielprobe, Mengenprobe und selbst die Sitzungsprobe, die den Abruf ausdrücklich messen sollte. **Keiner hat je eine FEHLENDE Datei abgerufen**, und genau das ist die Operation, an der es stirbt. **Warum jeder Probelauf grün war:** `getServerFiles` läuft auch im Trockenlauf, die Verbindung stirbt dort genauso — aber danach kommt kein Steuerbefehl mehr, nur noch „Sync complete", und der tote Client fällt nicht auf. Das ist Wort für Wort, was Fassung 91 aus dem Quelltext vorhergesagt hat. **Warum lima-city grün läuft:** Dort liegt eine Zustandsdatei, der Fall tritt nie ein — die Zeile „die Bibliothek als solche ausgeschlossen" war also die ganze Zeit die richtige Spur mit der falschen Begründung. **Und der Zustand ist selbsterhaltend:** Solange keine Zustandsdatei auf dem Server liegt, stirbt jeder Lauf daran, und weil er stirbt, wird nie eine geschrieben. Jeder Lauf ist der erste. **Abhilfe (AP4, vorgeschlagen, NICHT erprobt):** einmal von Hand eine gültige Zustandsdatei an die Stelle legen, auf die `state-name` zeigt; Format im Prüfdokument bei F-KH-U-25. **E-KH-09 zur Hälfte erfüllt:** Ursache benannt und belegt, Abhilfe offen. **Prüfpunkt 18 ist gegenstandslos** — der volle Auslieferungslauf mit Wartungsmodus wird nicht mehr gebraucht. Offen: **Prüfpunkt 20**, das **leere** `.zielprobe-gespraech/` auf Produktiv entfernen (der Lauf starb vor der ersten Datei; die Anwendung blieb unberührt, wie vorgesehen). Prüfmittel: Wortliste 0/0/0, Kettenaufrufe 34/0/0, Zielprobe 93 Lagen. **Nur `docs/`** — keine Versionsstufe (E-KH-23) |
| **94** | **20.09.2026** | **Der Gesprächslauf ist gebaut — die Auslieferungsaktion schreibt echt und redet dabei, aber in ein gesperrtes Probeverzeichnis und nicht in den Webroot.** Kette II/AP3, Prüfpunkt 18a, auf ausdrückliche Anweisung der Betreiberin. Neue Eingabe `probelauf_gespraech` am Arbeitslauf „Auslieferung": Sie schaltet den Trockenlauf **ab** — sonst erreicht die Aktion `ensureDir` nie (`syncProvider.js` beginnt `createFolder` mit `if (this.dryRun === true) return;`, und genau deshalb hat kein Probelauf F3 je ausgelöst) — und setzt `log-level: verbose`, womit `basic-ftp` seinen FTP-Dialog mitschreibt. **Drei Riegel halten den Preis klein.** (a) Ohne `probelauf` bricht ein eigener Schritt ab; er läuft **ohne `if`**, weil ein Riegel, der nur greift, wenn die Lage schon stimmt, keiner ist. (b) `server-dir` zeigt auf **`.zielprobe-gespraech/`** statt auf den Webroot — die Anwendung bleibt unberührt, kein Wartungsmodus, kein halber Stand; der **führende Punkt** ist Absicht, weil `.htaccess` jeden Pfad mit führendem Punkt mit 403 abweist (gemessen in F-KH-U-13, als die Zielprobe sich damit selbst ausgesperrt hat) und dort sonst eine zweite, öffentlich abrufbare Kopie der Anwendung läge. (c) `state-name` zeigt auf eine **eigene** Zustandsdatei *innerhalb* des Probeverzeichnisses; ohne das zeigte `../` von dort in den Webroot, und der Gesprächslauf legte eine Zustandsdatei mitten in die laufende Anlage. **Nachgerechnet statt im Kopf geprüft:** Die vier bedingten Ausdrücke (`dry-run`, `log-level`, `server-dir`, `state-name`) sind gegen **vier Fälle** ausgewertet worden — Tag-Lauf ohne `inputs`, Probelauf, Probelauf+Gespräch, Gespräch ohne Probelauf: **0 Abweichungen**. `dry-run` ist die gefährlichste Zeile der Datei; ein Fehler dort wäre eine Auslieferung ohne Tag. **Was der Lauf NICHT misst:** die **Tiefe** — das Probeverzeichnis liegt eine Ebene unter dem Webroot. Kommt er sauber durch, ist die Tiefe der nächste Verdacht. **Was danach von Hand zu tun ist:** `.zielprobe-gespraech/` entfernen und einmal `…/.zielprobe-gespraech/` im Browser aufrufen (erwartet: 403). Das Werkzeug räumt einzelne Probedateien weg, keine Bäume — ein Werkzeug, das Verzeichnisbäume auf dem Produktivserver löscht, soll es nicht geben. Prüfmittel: Wortliste 0/0/0, Kettenaufrufe 34/0/0, Zielprobe 93 Lagen, `bash -n` über alle **18** run-Blöcke 0 Fehler. **E-KH-09 steht.** **Nur `docs/` und `.github/`** — keine Versionsstufe (E-KH-23) |
| **93** | **20.09.2026** | **Acht Trennversuche, acht Messungen — und achtmal kann `curl`, woran die Auslieferungsaktion stirbt. Kein von außen sichtbares Serververhalten erklärt F3.** Kette II/AP3, Lauf 35541947020: Die Sitzungsprobe fragt, ob der Steuerkanal nach einem Abruf ansprechbar bleibt — **`PWD` NACH dem Abruf, dieselbe Sitzung: beantwortet (257)**, `EPSV` sauber, zehn Sekunden, die Probedatei weggeräumt. Damit ist auch die Lage erledigt, die aus dem Quelltextbefund der Fassung 91 folgte. **Die vollständige Liste:** Läuferabbild/Node, Zertifikat, die Bibliothek *als solche*, TLS-Sitzungswiederverwendung, `MKD`/`CWD` eines neuen Verzeichnisses, Weg zum Datenkanal, Menge und Sitzungslänge (80 von 80), Abruf plus Steuerbefehl. **Was daraus folgt:** Der Unterschied liegt nicht in etwas, das der Server *tut*, sondern in etwas, das die beiden Clients **verschieden** tun. Die Zeile „die Bibliothek als solche" trägt dabei weniger, als sie aussieht — dass `basic-ftp` gegen lima-city grün läuft, schließt nur aus, dass sie generell kaputt ist, nicht dass sie mit **diesem** Server nicht zurechtkommt. **Mit einem zweiten Client ist das nicht mehr auszuleuchten; acht Versuche haben es probiert.** Neu vorgelegt: **Prüfpunkt 18a** — die Aktion reden lassen (`log-level: verbose`), aber gegen ein **Probeverzeichnis** statt den Webroot. Derselbe Client, derselbe Server, echtes `ensureDir`, 688 Dateien in 62 Verzeichnissen — **ohne** Wartungsmodus, ohne halb ausgelieferten Stand und ohne den Rückweg, den Prüfpunkt 18 nötig macht. Nicht gemessen wird dabei die **Tiefe** (das Probeverzeichnis liegt eine Ebene unter dem Webroot). Gebaut ist sie nicht: Sie schreibt echt und fällt unter denselben Wächter wie Prüfpunkt 18. **Prüfpunkt 19 abgehakt. E-KH-09 steht.** **Nur `docs/`** — keine Versionsstufe (E-KH-23) |
| **92** | **20.09.2026** | **Die Sitzungsprobe ist über die Kette auslösbar — Prüfpunkt 19 ist fahrbar und geht Prüfpunkt 18 voraus.** Kette II/AP3. Neue Eingabe `probelauf_sitzungsprobe` am Arbeitslauf „Auslieferung": Sie tritt an die Stelle der beiden Rundläufe und misst die Reihenfolge, in der die Auslieferungsaktion stirbt — **Abruf über den Datenkanal, DANACH ein Steuerbefehl, in derselben Sitzung** (F-KH-U-23). Drei Riegel: ohne `probelauf` bricht der Schritt ab, zusammen mit `probelauf_mengenprobe` ebenfalls (beide träten an die Stelle der Rundläufe), und das Werkzeug selbst weist die Kombination auch bei einem Handaufruf ab — dieselbe Falle, die `--mengenprobe 0` schon einmal gestellt hat, diesmal vorher zugemacht. Geschrieben wird **eine** Probedatei, und die wird im selben Schritt gelöscht; Backup-Tor, Wartung und Zeiger bleiben aus, der Abgleich läuft als Trockenlauf. **Weg A (echter Lauf mit `log-level: verbose`, Prüfpunkt 18) bleibt gebaut-nicht:** Die dafür nötige Änderung — ein Weg, **ohne Tag** auf Produktiv zu schreiben — hat der Wächter der Arbeitsumgebung abgewiesen, und das ist sachlich richtig erkannt. Die Betreiberin hat entschieden, Prüfpunkt 19 zuerst zu fahren. Selbstprobe der Zielprobe **92 → 93 Lagen, 0 offen**; Kettenaufrufe 34/0/0, `bash -n` über alle 17 run-Blöcke 0 Fehler. **E-KH-09 steht.** **Nur `docs/`, `tools/` und `.github/`** — keine Versionsstufe (E-KH-23) |
| **91** | **20.09.2026** | **Ein Quelltextbefund kippt eine tragende Annahme: `_openDir` listet nicht — und damit war die Stelle, an der F3 seit dem 19.09.2026 verortet wird, in beiden Konzeptdokumenten falsch beschrieben.** Kette II/AP3. Nachgelesen in `basic-ftp` 6.2.1 (per `npm pack` geholt, Z. 686–689): `_openDir` sendet `MKD` und `CWD`, beides **Steuerkanal**, und listet nie. Der Stacktrace „Client **is closed** *because* read ECONNRESET (data socket)" ist deshalb eine **Zustandsmeldung und keine Ortsangabe**: Der Client war schon tot, als `MKD api` abgesetzt wurde; `sendIgnoringError` ist die Stelle, die es **bemerkt**. Der Reset kam auf der Datenverbindung **davor**. Beide Dokumente sind an der betroffenen Stelle **berichtigt und nicht stehengelassen**; der alte Wortlaut bleibt als Protokoll mit Berichtigungsvermerk. **Was daraus folgt und noch nie gemessen wurde:** Vor dem ersten `MKD` holt die Auslieferungsaktion ihre Zustandsdatei (`downloadFileList`) — eine Datenverbindung. Im Probelauf kommt danach **kein Steuerbefehl mehr**, nur noch „Sync complete"; ein Reset genau dort wäre im Trockenlauf **unsichtbar**. Das ist Zug um Zug die beobachtete Lage: Probelauf grün, echter Lauf rot. Die Zielprobe konnte es nie sehen, weil sie je Operation eine neue Verbindung öffnet. **Gebaut: `--sitzungsprobe`** — Abruf, dann `PWD`, in EINER Sitzung; dreiwertig (keine `257`-Antwort heißt NICHT FESTSTELLBAR), und scheitert schon das Hochladen, sagt sie, dass die Frage gar nicht gestellt wurde. Das ist **Prüfpunkt 19** und kostet einen **Probelauf**, keinen echten Lauf; er geht Prüfpunkt 18 voraus. **Weg A (echter Lauf mit `log-level: verbose`) ist beauftragt, aber nicht gebaut:** Der Wächter der Arbeitsumgebung hat die Änderung an `auslieferung.yml` abgewiesen („Production Deploy"), weil sie einen Weg schüfe, **ohne Tag** auf Produktiv zu schreiben. Das ist sachlich richtig erkannt und wird nicht umgangen. Belegt ist immerhin, was Weg A voraussetzt: `log-level: verbose` gibt es wirklich (`deploy.js` Z. 74, `client.ftp.verbose = …`), und das Passwort steht nicht im Protokoll (`FtpContext.js` Z. 191/192 ersetzt es durch `> PASS ###`) — nachgesehen statt geraten, die Lehre aus dem erfundenen `curl`-Schalter. Selbstprobe der Zielprobe **81 → 92 Lagen, 0 offen**; eine davon hat einen zu schwachen Prüfstand gemeldet, nicht einen Fehler im Werkzeug. **E-KH-09 steht.** **Nur `docs/` und `tools/`** — keine Versionsstufe (E-KH-23) |
