#!/usr/bin/env bash
# Quelltextprüfungen — ein Läufer für die zwölf Prüfungen, die nur Quelltext
...
NAMEN=(installweiche sitzungshaertung csp jobregister migrationsregister
       behandler linkprobe vollstaendigkeit textprobe bestand pysyntax handbuch)
# Die zehn mit eingebauter Selbstprobe (`behandler` seit P5c/AP3). `linkprobe`
...
SELBST=(installweiche sitzungshaertung csp jobregister migrationsregister behandler
        textprobe bestand pysyntax handbuch)
