...
| 8 | Der **Eingang** (`gpx_lesen()`): acht Umgehungsversuche der DOCTYPE-Sperre — UTF-16 in drei Spielarten, Kleinschreibung, Bytefolgemarke, Nullbyte, Latin-1 — und eine saubere Datei, die durchgehen muss |
