 ...
 * `tools/anteilprobe/endpunkt.py` baut die neue Hülle selbst und schickt sie
 ...
 *
 * Aufruf:
 *   node tools/anteilprobe/umstellungslauf.mjs
 *   node tools/anteilprobe/umstellungslauf.mjs --motor firefox
 *   node tools/anteilprobe/umstellungslauf.mjs --motor webkit
 *
...
/* ---- Voraussetzung herstellen: die Hülle zurück auf `edk1:` ------------- */
{
  const r = spawnSync('python3',
    ['tools/anteilprobe/huelle_stellen.py', KONTO, KONTO_PW, 'edk1'],
