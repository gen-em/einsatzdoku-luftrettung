 ...
 *
 * Aufruf:
 *   node tools/anteilprobe/betriebslauf.mjs
...
try {
  ...
  await p.screenshot({ path: WURZEL + '/tools/anteilprobe/ausgabe-blatt-druck.png',
                       fullPage: true });
  ...
  if (rcDa) {
    spawnSync('python3', [WURZEL + '/tools/anteilprobe/huelle_stellen.py',
