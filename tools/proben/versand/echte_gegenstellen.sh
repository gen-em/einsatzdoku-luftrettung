...
#     sh tools/proben/versand/echte_gegenstellen.sh /tmp/versandprobe-echt
#
# Danach:  php tools/proben/versand/probe.php /tmp/versandprobe-echt --echt
#
# Beenden: sh tools/proben/versand/echte_gegenstellen.sh --stop
set -e
